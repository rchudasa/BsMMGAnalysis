...
// Thu Mar 17 18:33:15 2022 by ROOT version 6.14/09
// from TTree mergedTree/bmm5 and bmmg merged tree
// found on file: /grid_mnt/t3storage3/athachay/bs2mumug/run2studies/ntuplizer/mc/CMSSW_10_6_19_patch2/src/BsMMGAnalysis/MergeWithBMMNtuples/MergeFiles/MergedNtules/MC/BsToMMG/bmmXMerged2018data_BsToMMG_83_0.root
//////////////////////////////////////////////////////////

#ifndef MergedBMMXMC_h
#define MergedBMMXMC_h
#define MergedBMMXMC_cxx
#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxbG_nscMinDrWithGsfElectornSC = 16;
   static constexpr Int_t kMaxbG_scMinDrWithGsfElectornSC = 1;
   static constexpr Int_t kMaxbG_nscFoundGsfMatch = 16;
   ...
   ULong64_t       b5_event;
   UInt_t          b5_nMuonId;
   Float_t         b5_MuonId_chi2LocalPosition[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_glbNormChi2[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_glbTrackProbability[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_hlt_dr[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_hlt_pt[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_l1_eta[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_l1_mpt[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_l1_phi[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_l1_pt[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match1_dX[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match1_dY[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match1_pullDxDz[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match1_pullDyDz[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match1_pullX[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match1_pullY[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match2_dX[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match2_dY[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match2_pullDxDz[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match2_pullDyDz[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match2_pullX[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_match2_pullY[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_newSoftMuonMva[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_simProdRho[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_simProdZ[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_trkKink[6];   //[b5_nMuonId]
   Float_t         b5_MuonId_trkValidFrac[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_Dimuon0_LowMass[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_Dimuon0_LowMass_L1_0er1p5[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_Dimuon6_Jpsi_NoVertexing[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_DoubleMu0[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_DoubleMu4_3_Bs[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_DoubleMu4_3_Jpsi[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_DoubleMu4_3_Jpsi_Displaced[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_DoubleMu4_Jpsi_Displaced[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_DoubleMu4_Jpsi_NoVertexing[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_IsoMu24[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_IsoMu27[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_Mu17[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_HLT_Mu8[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_highPurity[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_l1_quality[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_nLostHitsInner[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_nLostHitsOn[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_nLostHitsOuter[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_nPixels[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_nValidHits[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_simExtType[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_simMotherPdgId[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_simPdgId[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_simType[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_trkLayers[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_trkLostLayersInner[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_trkLostLayersOn[6];   //[b5_nMuonId]
   Int_t           b5_MuonId_trkLostLayersOuter[6];   //[b5_nMuonId]
   UInt_t          b5_nbkkmm;
   Float_t         b5_bkkmm_gen_kaon1_pt[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_kaon2_pt[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_l3d[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_lxy[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_mass[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_prod_x[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_prod_y[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_prod_z[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_pt[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_tau[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_alpha[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_alphaBS[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_alphaBSErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_alphaErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_eta[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon1eta[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon1phi[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon1pt[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon2eta[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon2phi[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon2pt[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kk_mass[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_l3d[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_lxy[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_mass[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_massErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_phi[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pt[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv2ip[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv2ipErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv2lip[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv2lipErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv2lipSig[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv_z[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv_zErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pvip[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pvipErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pvlip[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pvlipErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pvlipSig[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_sl3d[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_slxy[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_spv2ip[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_spvip[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_tau[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_taue[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_tauxy[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_tauxye[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_chi2dof[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_prob[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_x[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_xErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_y[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_yErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_z[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_zErr[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon1_dxy_bs[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon1_eta[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon1_phi[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon1_pt[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon1_sdxy_bs[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon2_dxy_bs[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon2_eta[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon2_phi[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon2_pt[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon2_sdxy_bs[12];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kk_mass[12];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_gen_kaon1_mpdgId[12];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_gen_kaon1_pdgId[12];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_gen_kaon2_mpdgId[12];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_gen_kaon2_pdgId[12];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_gen_pdgId[12];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_jpsikk_valid[12];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_kaon1_charge[12];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_kaon2_charge[12];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_mm_index[12];   //[b5_nbkkmm]
   UInt_t          b5_nbkmm;
   Float_t         b5_bkmm_bmm_bdt[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_docatrk[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_iso[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_m1iso[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_m2iso[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_mva[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_otherVtxMaxProb[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_otherVtxMaxProb1[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_otherVtxMaxProb2[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_kaon_pt[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_l3d[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_lxy[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_mass[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_prod_x[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_prod_y[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_prod_z[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_pt[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_tau[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_alpha[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_alphaBS[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_alphaBSErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_alphaErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_eta[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_kaon1eta[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_kaon1phi[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_kaon1pt[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_l3d[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_lxy[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_mass[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_massErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_phi[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pt[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv2ip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv2ipErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv2lip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv2lipErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv2lipSig[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv_z[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv_zErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pvip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pvipErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pvlip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pvlipErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pvlipSig[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_sl3d[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_slxy[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_spv2ip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_spvip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_tau[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_taue[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_tauxy[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_tauxye[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_chi2dof[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_prob[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_x[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_xErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_y[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_yErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_z[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_zErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_dxy_bs[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_eta[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_mu1_doca[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_mu2_doca[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_phi[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_pt[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_sdxy_bs[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_alpha[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_alphaBS[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_alphaBSErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_alphaErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_eta[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_kaon1eta[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_kaon1phi[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_kaon1pt[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_l3d[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_lxy[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_mass[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_massErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_phi[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pt[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv2ip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv2ipErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv2lip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv2lipErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv2lipSig[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv_z[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv_zErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pvip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pvipErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pvlip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pvlipErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pvlipSig[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_sl3d[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_slxy[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_spv2ip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_spvip[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_tau[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_taue[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_tauxy[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_tauxye[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_chi2dof[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_prob[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_x[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_xErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_y[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_yErr[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_z[12];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_zErr[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_closetrk[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_closetrks1[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_closetrks2[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_closetrks3[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_nBMTrks[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_nDisTrks[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_nTrks[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_gen_kaon_mpdgId[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_gen_kaon_pdgId[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_gen_pdgId[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_jpsimc_valid[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_kaon_charge[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_mm_index[12];   //[b5_nbkmm]
   Int_t           b5_bkmm_nomc_valid[12];   //[b5_nbkmm]
   UInt_t          b5_nmm;
   Float_t         b5_mm_bdt[53];   //[b5_nmm]
   Float_t         b5_mm_doca[53];   //[b5_nmm]
   Float_t         b5_mm_docatrk[53];   //[b5_nmm]
   Float_t         b5_mm_gen_alpha_ip[53];   //[b5_nmm]
   Float_t         b5_mm_gen_alpha_p_phi[53];   //[b5_nmm]
   Float_t         b5_mm_gen_alpha_p_theta[53];   //[b5_nmm]
   Float_t         b5_mm_gen_alpha_vtx[53];   //[b5_nmm]
   Float_t         b5_mm_gen_doca[53];   //[b5_nmm]
   Float_t         b5_mm_gen_l3d[53];   //[b5_nmm]
   Float_t         b5_mm_gen_lxy[53];   //[b5_nmm]
   Float_t         b5_mm_gen_mass[53];   //[b5_nmm]
   Float_t         b5_mm_gen_mu1_pt[53];   //[b5_nmm]
   Float_t         b5_mm_gen_mu2_pt[53];   //[b5_nmm]
   Float_t         b5_mm_gen_prod_z[53];   //[b5_nmm]
   Float_t         b5_mm_gen_pt[53];   //[b5_nmm]
   Float_t         b5_mm_gen_tau[53];   //[b5_nmm]
   Float_t         b5_mm_gen_vtx_x[53];   //[b5_nmm]
   Float_t         b5_mm_gen_vtx_y[53];   //[b5_nmm]
   Float_t         b5_mm_gen_vtx_z[53];   //[b5_nmm]
   Float_t         b5_mm_iso[53];   //[b5_nmm]
   Float_t         b5_mm_kal_lxy[53];   //[b5_nmm]
   Float_t         b5_mm_kal_mass[53];   //[b5_nmm]
   Float_t         b5_mm_kal_slxy[53];   //[b5_nmm]
   Float_t         b5_mm_kal_vtx_prob[53];   //[b5_nmm]
   Float_t         b5_mm_kin_alpha[53];   //[b5_nmm]
   Float_t         b5_mm_kin_alphaBS[53];   //[b5_nmm]
   Float_t         b5_mm_kin_alphaBSErr[53];   //[b5_nmm]
   Float_t         b5_mm_kin_alphaErr[53];   //[b5_nmm]
   Float_t         b5_mm_kin_eta[53];   //[b5_nmm]
   Float_t         b5_mm_kin_l3d[53];   //[b5_nmm]
   Float_t         b5_mm_kin_lxy[53];   //[b5_nmm]
   Float_t         b5_mm_kin_mass[53];   //[b5_nmm]
   Float_t         b5_mm_kin_massErr[53];   //[b5_nmm]
   Float_t         b5_mm_kin_mu1eta[53];   //[b5_nmm]
   Float_t         b5_mm_kin_mu1phi[53];   //[b5_nmm]
   Float_t         b5_mm_kin_mu1pt[53];   //[b5_nmm]
   Float_t         b5_mm_kin_mu2eta[53];   //[b5_nmm]
   Float_t         b5_mm_kin_mu2phi[53];   //[b5_nmm]
   Float_t         b5_mm_kin_mu2pt[53];   //[b5_nmm]
   Float_t         b5_mm_kin_phi[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pt[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pv2ip[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pv2ipErr[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pv2lip[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pv2lipErr[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pv2lipSig[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pv_z[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pv_zErr[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pvip[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pvipErr[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pvlip[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pvlipErr[53];   //[b5_nmm]
   Float_t         b5_mm_kin_pvlipSig[53];   //[b5_nmm]
   Float_t         b5_mm_kin_sl3d[53];   //[b5_nmm]
   Float_t         b5_mm_kin_slxy[53];   //[b5_nmm]
   Float_t         b5_mm_kin_spv2ip[53];   //[b5_nmm]
   Float_t         b5_mm_kin_spvip[53];   //[b5_nmm]
   Float_t         b5_mm_kin_tau[53];   //[b5_nmm]
   Float_t         b5_mm_kin_taue[53];   //[b5_nmm]
   Float_t         b5_mm_kin_tauxy[53];   //[b5_nmm]
   Float_t         b5_mm_kin_tauxye[53];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_chi2dof[53];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_prob[53];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_x[53];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_xErr[53];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_y[53];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_yErr[53];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_z[53];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_zErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_alpha[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_alphaBS[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_alphaBSErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_alphaErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_eta[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_l3d[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_lxy[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_mass[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_massErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_phi[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pt[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv2ip[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv2ipErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv2lip[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv2lipErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv2lipSig[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv_z[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv_zErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pvip[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pvipErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pvlip[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pvlipErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pvlipSig[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_sl3d[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_slxy[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_spv2ip[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_spvip[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_tau[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_taue[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_tauxy[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_tauxye[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_chi2dof[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_prob[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_x[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_xErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_y[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_yErr[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_z[53];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_zErr[53];   //[b5_nmm]
   Float_t         b5_mm_m1iso[53];   //[b5_nmm]
   Float_t         b5_mm_m2iso[53];   //[b5_nmm]
   Float_t         b5_mm_mass[53];   //[b5_nmm]
   Float_t         b5_mm_mu1_eta[53];   //[b5_nmm]
   Float_t         b5_mm_mu1_phi[53];   //[b5_nmm]
   Float_t         b5_mm_mu1_pt[53];   //[b5_nmm]
   Float_t         b5_mm_mu2_eta[53];   //[b5_nmm]
   Float_t         b5_mm_mu2_phi[53];   //[b5_nmm]
   Float_t         b5_mm_mu2_pt[53];   //[b5_nmm]
   Float_t         b5_mm_mva[53];   //[b5_nmm]
   Float_t         b5_mm_otherVtxMaxProb[53];   //[b5_nmm]
   Float_t         b5_mm_otherVtxMaxProb1[53];   //[b5_nmm]
   Float_t         b5_mm_otherVtxMaxProb2[53];   //[b5_nmm]
   Int_t           b5_mm_closetrk[53];   //[b5_nmm]
   Int_t           b5_mm_closetrks1[53];   //[b5_nmm]
   Int_t           b5_mm_closetrks2[53];   //[b5_nmm]
   Int_t           b5_mm_closetrks3[53];   //[b5_nmm]
   Int_t           b5_mm_gen_cpdgId[53];   //[b5_nmm]
   Int_t           b5_mm_gen_mpdgId[53];   //[b5_nmm]
   Int_t           b5_mm_gen_mu1_mpdgId[53];   //[b5_nmm]
   Int_t           b5_mm_gen_mu1_pdgId[53];   //[b5_nmm]
   Int_t           b5_mm_gen_mu2_mpdgId[53];   //[b5_nmm]
   Int_t           b5_mm_gen_mu2_pdgId[53];   //[b5_nmm]
   Int_t           b5_mm_gen_pdgId[53];   //[b5_nmm]
   Int_t           b5_mm_kal_valid[53];   //[b5_nmm]
   Int_t           b5_mm_kin_valid[53];   //[b5_nmm]
   Int_t           b5_mm_kinpc_valid[53];   //[b5_nmm]
   Int_t           b5_mm_mu1_index[53];   //[b5_nmm]
   Int_t           b5_mm_mu1_pdgId[53];   //[b5_nmm]
   Int_t           b5_mm_mu2_index[53];   //[b5_nmm]
   Int_t           b5_mm_mu2_pdgId[53];   //[b5_nmm]
   Int_t           b5_mm_nBMTrks[53];   //[b5_nmm]
   Int_t           b5_mm_nDisTrks[53];   //[b5_nmm]
   Int_t           b5_mm_nTrks[53];   //[b5_nmm]
   UInt_t          b5_ngensummary;
   Int_t           b5_gensummary_n_anti_b[1];   //[b5_ngensummary]
   Int_t           b5_gensummary_n_b[1];   //[b5_ngensummary]
   Int_t           b5_gensummary_process_type[1];   //[b5_ngensummary]
   UInt_t          b5_ngenbmm;
   Float_t         b5_genbmm_dau3_eta[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau3_phi[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau3_pt[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau3_reco_eta[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau3_reco_phi[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau3_reco_pt[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau4_eta[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau4_phi[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau4_pt[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau4_reco_eta[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau4_reco_phi[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dau4_reco_pt[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_dimuon_mass[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_eta[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_mass[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_mu1_eta[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_mu1_phi[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_mu1_pt[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_mu2_eta[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_mu2_phi[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_mu2_pt[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_phi[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_pt[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_rad_eta[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_rad_p[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_rad_phi[2];   //[b5_ngenbmm]
   Float_t         b5_genbmm_rad_pt[2];   //[b5_ngenbmm]
   Int_t           b5_genbmm_dau3_pdgId[2];   //[b5_ngenbmm]
   Int_t           b5_genbmm_dau4_pdgId[2];   //[b5_ngenbmm]
   Int_t           b5_genbmm_mu1_good[2];   //[b5_ngenbmm]
   Int_t           b5_genbmm_mu1_index[2];   //[b5_ngenbmm]
   Int_t           b5_genbmm_mu1_pdgId[2];   //[b5_ngenbmm]
   Int_t           b5_genbmm_mu2_good[2];   //[b5_ngenbmm]
   Int_t           b5_genbmm_mu2_index[2];   //[b5_ngenbmm]
   Int_t           b5_genbmm_mu2_pdgId[2];   //[b5_ngenbmm]
   Int_t           b5_genbmm_pdgId[2];   //[b5_ngenbmm]
   Int_t           b5_genbmm_signature[2];   //[b5_ngenbmm]
   UInt_t          b5_nd0;
   Float_t         b5_d0_doca[3];   //[b5_nd0]
   Float_t         b5_d0_gen_kaon_pt[3];   //[b5_nd0]
   Float_t         b5_d0_gen_mass[3];   //[b5_nd0]
   Float_t         b5_d0_gen_pion_pt[3];   //[b5_nd0]
   Float_t         b5_d0_gen_pt[3];   //[b5_nd0]
   Float_t         b5_d0_kaon_eta[3];   //[b5_nd0]
   Float_t         b5_d0_kaon_phi[3];   //[b5_nd0]
   Float_t         b5_d0_kaon_pt[3];   //[b5_nd0]
   Float_t         b5_d0_kaon_sip[3];   //[b5_nd0]
   Float_t         b5_d0_kin_cosAlphaXY[3];   //[b5_nd0]
   Float_t         b5_d0_kin_eta[3];   //[b5_nd0]
   Float_t         b5_d0_kin_lxy[3];   //[b5_nd0]
   Float_t         b5_d0_kin_mass[3];   //[b5_nd0]
   Float_t         b5_d0_kin_massErr[3];   //[b5_nd0]
   Float_t         b5_d0_kin_phi[3];   //[b5_nd0]
   Float_t         b5_d0_kin_pt[3];   //[b5_nd0]
   Float_t         b5_d0_kin_sipBS[3];   //[b5_nd0]
   Float_t         b5_d0_kin_sipPV[3];   //[b5_nd0]
   Float_t         b5_d0_kin_slxy[3];   //[b5_nd0]
   Float_t         b5_d0_kin_vtx_chi2dof[3];   //[b5_nd0]
   Float_t         b5_d0_kin_vtx_prob[3];   //[b5_nd0]
   Float_t         b5_d0_mass[3];   //[b5_nd0]
   Float_t         b5_d0_pion_eta[3];   //[b5_nd0]
   Float_t         b5_d0_pion_phi[3];   //[b5_nd0]
   Float_t         b5_d0_pion_pt[3];   //[b5_nd0]
   Float_t         b5_d0_pion_sip[3];   //[b5_nd0]
   Int_t           b5_d0_gen_kaon_mpdgId[3];   //[b5_nd0]
   Int_t           b5_d0_gen_kaon_pdgId[3];   //[b5_nd0]
   Int_t           b5_d0_gen_pdgId[3];   //[b5_nd0]
   Int_t           b5_d0_gen_pion_mpdgId[3];   //[b5_nd0]
   Int_t           b5_d0_gen_pion_pdgId[3];   //[b5_nd0]
   Int_t           b5_d0_kaon_mu_index[3];   //[b5_nd0]
   Int_t           b5_d0_kin_valid[3];   //[b5_nd0]
   Int_t           b5_d0_pion_mu_index[3];   //[b5_nd0]
   Float_t         b5_HTXS_Higgs_pt;
   Float_t         b5_HTXS_Higgs_y;
   Int_t           b5_HTXS_stage1_1_cat_pTjet25GeV;
   Int_t           b5_HTXS_stage1_1_cat_pTjet30GeV;
   Int_t           b5_HTXS_stage1_1_fine_cat_pTjet25GeV;
   Int_t           b5_HTXS_stage1_1_fine_cat_pTjet30GeV;
   Int_t           b5_HTXS_stage1_2_cat_pTjet25GeV;
   Int_t           b5_HTXS_stage1_2_cat_pTjet30GeV;
   Int_t           b5_HTXS_stage1_2_fine_cat_pTjet25GeV;
   Int_t           b5_HTXS_stage1_2_fine_cat_pTjet30GeV;
   Int_t           b5_HTXS_stage_0;
   Int_t           b5_HTXS_stage_1_pTjet25;
   Int_t           b5_HTXS_stage_1_pTjet30;
   UChar_t         b5_HTXS_njets25;
   UChar_t         b5_HTXS_njets30;
   UInt_t          b5_nks;
   Float_t         b5_ks_doca[3];   //[b5_nks]
   Float_t         b5_ks_gen_mass[3];   //[b5_nks]
   Float_t         b5_ks_gen_pt[3];   //[b5_nks]
   Float_t         b5_ks_gen_trk1_pt[3];   //[b5_nks]
   Float_t         b5_ks_gen_trk2_pt[3];   //[b5_nks]
   Float_t         b5_ks_kin_cosAlphaXY[3];   //[b5_nks]
   Float_t         b5_ks_kin_eta[3];   //[b5_nks]
   Float_t         b5_ks_kin_lxy[3];   //[b5_nks]
   Float_t         b5_ks_kin_mass[3];   //[b5_nks]
   Float_t         b5_ks_kin_massErr[3];   //[b5_nks]
   Float_t         b5_ks_kin_phi[3];   //[b5_nks]
   Float_t         b5_ks_kin_pt[3];   //[b5_nks]
   Float_t         b5_ks_kin_sipBS[3];   //[b5_nks]
   Float_t         b5_ks_kin_sipPV[3];   //[b5_nks]
   Float_t         b5_ks_kin_slxy[3];   //[b5_nks]
   Float_t         b5_ks_kin_vtx_chi2dof[3];   //[b5_nks]
   Float_t         b5_ks_kin_vtx_prob[3];   //[b5_nks]
   Float_t         b5_ks_mass[3];   //[b5_nks]
   Float_t         b5_ks_trk1_eta[3];   //[b5_nks]
   Float_t         b5_ks_trk1_phi[3];   //[b5_nks]
   Float_t         b5_ks_trk1_pt[3];   //[b5_nks]
   Float_t         b5_ks_trk1_sip[3];   //[b5_nks]
   Float_t         b5_ks_trk2_eta[3];   //[b5_nks]
   Float_t         b5_ks_trk2_phi[3];   //[b5_nks]
   Float_t         b5_ks_trk2_pt[3];   //[b5_nks]
   Float_t         b5_ks_trk2_sip[3];   //[b5_nks]
   Int_t           b5_ks_gen_pdgId[3];   //[b5_nks]
   Int_t           b5_ks_gen_trk1_mpdgId[3];   //[b5_nks]
   Int_t           b5_ks_gen_trk1_pdgId[3];   //[b5_nks]
   Int_t           b5_ks_gen_trk2_mpdgId[3];   //[b5_nks]
   Int_t           b5_ks_gen_trk2_pdgId[3];   //[b5_nks]
   Int_t           b5_ks_kin_valid[3];   //[b5_nks]
   Int_t           b5_ks_trk1_mu_index[3];   //[b5_nks]
   Int_t           b5_ks_trk2_mu_index[3];   //[b5_nks]
   UInt_t          b5_nlambda;
   Float_t         b5_lambda_doca[2];   //[b5_nlambda]
   Float_t         b5_lambda_gen_mass[2];   //[b5_nlambda]
   Float_t         b5_lambda_gen_pion_pt[2];   //[b5_nlambda]
   Float_t         b5_lambda_gen_proton_pt[2];   //[b5_nlambda]
   Float_t         b5_lambda_gen_pt[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_cosAlphaXY[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_eta[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_lxy[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_mass[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_massErr[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_phi[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_pt[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_sipBS[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_sipPV[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_slxy[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_vtx_chi2dof[2];   //[b5_nlambda]
   Float_t         b5_lambda_kin_vtx_prob[2];   //[b5_nlambda]
   Float_t         b5_lambda_mass[2];   //[b5_nlambda]
   Float_t         b5_lambda_pion_eta[2];   //[b5_nlambda]
   Float_t         b5_lambda_pion_phi[2];   //[b5_nlambda]
   Float_t         b5_lambda_pion_pt[2];   //[b5_nlambda]
   Float_t         b5_lambda_pion_sip[2];   //[b5_nlambda]
   Float_t         b5_lambda_proton_eta[2];   //[b5_nlambda]
   Float_t         b5_lambda_proton_phi[2];   //[b5_nlambda]
   Float_t         b5_lambda_proton_pt[2];   //[b5_nlambda]
   Float_t         b5_lambda_proton_sip[2];   //[b5_nlambda]
   Int_t           b5_lambda_gen_pdgId[2];   //[b5_nlambda]
   Int_t           b5_lambda_gen_pion_mpdgId[2];   //[b5_nlambda]
   Int_t           b5_lambda_gen_pion_pdgId[2];   //[b5_nlambda]
   Int_t           b5_lambda_gen_proton_mpdgId[2];   //[b5_nlambda]
   Int_t           b5_lambda_gen_proton_pdgId[2];   //[b5_nlambda]
   Int_t           b5_lambda_kin_valid[2];   //[b5_nlambda]
   Int_t           b5_lambda_pion_mu_index[2];   //[b5_nlambda]
   Int_t           b5_lambda_proton_mu_index[2];   //[b5_nlambda]
   UInt_t          b5_nphi;
   Float_t         b5_phi_doca[3];   //[b5_nphi]
   Float_t         b5_phi_ds_cosAlphaXY[3];   //[b5_nphi]
   Float_t         b5_phi_ds_eta[3];   //[b5_nphi]
   Float_t         b5_phi_ds_lxy[3];   //[b5_nphi]
   Float_t         b5_phi_ds_mass[3];   //[b5_nphi]
   Float_t         b5_phi_ds_massErr[3];   //[b5_nphi]
   Float_t         b5_phi_ds_phi[3];   //[b5_nphi]
   Float_t         b5_phi_ds_pion_eta[3];   //[b5_nphi]
   Float_t         b5_phi_ds_pion_mu_index[3];   //[b5_nphi]
   Float_t         b5_phi_ds_pion_phi[3];   //[b5_nphi]
   Float_t         b5_phi_ds_pion_pt[3];   //[b5_nphi]
   Float_t         b5_phi_ds_pt[3];   //[b5_nphi]
   Float_t         b5_phi_ds_sipBS[3];   //[b5_nphi]
   Float_t         b5_phi_ds_sipPV[3];   //[b5_nphi]
   Float_t         b5_phi_ds_slxy[3];   //[b5_nphi]
   Float_t         b5_phi_ds_vtx_chi2dof[3];   //[b5_nphi]
   Float_t         b5_phi_ds_vtx_prob[3];   //[b5_nphi]
   Float_t         b5_phi_gen_mass[3];   //[b5_nphi]
   Float_t         b5_phi_gen_pt[3];   //[b5_nphi]
   Float_t         b5_phi_gen_trk1_pt[3];   //[b5_nphi]
   Float_t         b5_phi_gen_trk2_pt[3];   //[b5_nphi]
   Float_t         b5_phi_kin_cosAlphaXY[3];   //[b5_nphi]
   Float_t         b5_phi_kin_eta[3];   //[b5_nphi]
   Float_t         b5_phi_kin_lxy[3];   //[b5_nphi]
   Float_t         b5_phi_kin_mass[3];   //[b5_nphi]
   Float_t         b5_phi_kin_massErr[3];   //[b5_nphi]
   Float_t         b5_phi_kin_phi[3];   //[b5_nphi]
   Float_t         b5_phi_kin_pt[3];   //[b5_nphi]
   Float_t         b5_phi_kin_sipBS[3];   //[b5_nphi]
   Float_t         b5_phi_kin_sipPV[3];   //[b5_nphi]
   Float_t         b5_phi_kin_slxy[3];   //[b5_nphi]
   Float_t         b5_phi_kin_vtx_chi2dof[3];   //[b5_nphi]
   Float_t         b5_phi_kin_vtx_prob[3];   //[b5_nphi]
   Float_t         b5_phi_mass[3];   //[b5_nphi]
   Float_t         b5_phi_trk1_eta[3];   //[b5_nphi]
   Float_t         b5_phi_trk1_phi[3];   //[b5_nphi]
   Float_t         b5_phi_trk1_pt[3];   //[b5_nphi]
   Float_t         b5_phi_trk1_sip[3];   //[b5_nphi]
   Float_t         b5_phi_trk2_eta[3];   //[b5_nphi]
   Float_t         b5_phi_trk2_phi[3];   //[b5_nphi]
   Float_t         b5_phi_trk2_pt[3];   //[b5_nphi]
   Float_t         b5_phi_trk2_sip[3];   //[b5_nphi]
   Int_t           b5_phi_gen_pdgId[3];   //[b5_nphi]
   Int_t           b5_phi_gen_trk1_mpdgId[3];   //[b5_nphi]
   Int_t           b5_phi_gen_trk1_pdgId[3];   //[b5_nphi]
   Int_t           b5_phi_gen_trk2_mpdgId[3];   //[b5_nphi]
   Int_t           b5_phi_gen_trk2_pdgId[3];   //[b5_nphi]
   Int_t           b5_phi_kin_valid[3];   //[b5_nphi]
   Int_t           b5_phi_trk1_mu_index[3];   //[b5_nphi]
   Int_t           b5_phi_trk2_mu_index[3];   //[b5_nphi]
   Float_t         b5_btagWeight_CSVV2;
   Float_t         b5_btagWeight_DeepCSVB;
   ...
   Float_t         b5_CorrT1METJet_area[21];   //[b5_nCorrT1METJet]
   Float_t         b5_CorrT1METJet_eta[21];   //[b5_nCorrT1METJet]
   Float_t         b5_CorrT1METJet_muonSubtrFactor[21];   //[b5_nCorrT1METJet]
   Float_t         b5_CorrT1METJet_phi[21];   //[b5_nCorrT1METJet]
   Float_t         b5_CorrT1METJet_rawPt[21];   //[b5_nCorrT1METJet]
   ...
   UInt_t          b5_nElectron;
   Float_t         b5_Electron_deltaEtaSC[5];   //[b5_nElectron]
   Float_t         b5_Electron_dr03EcalRecHitSumEt[5];   //[b5_nElectron]
   Float_t         b5_Electron_dr03HcalDepth1TowerSumEt[5];   //[b5_nElectron]
   Float_t         b5_Electron_dr03TkSumPt[5];   //[b5_nElectron]
   Float_t         b5_Electron_dr03TkSumPtHEEP[5];   //[b5_nElectron]
   Float_t         b5_Electron_dxy[5];   //[b5_nElectron]
   Float_t         b5_Electron_dxyErr[5];   //[b5_nElectron]
   Float_t         b5_Electron_dz[5];   //[b5_nElectron]
   Float_t         b5_Electron_dzErr[5];   //[b5_nElectron]
   Float_t         b5_Electron_eCorr[5];   //[b5_nElectron]
   Float_t         b5_Electron_eInvMinusPInv[5];   //[b5_nElectron]
   Float_t         b5_Electron_energyErr[5];   //[b5_nElectron]
   Float_t         b5_Electron_eta[5];   //[b5_nElectron]
   Float_t         b5_Electron_hoe[5];   //[b5_nElectron]
   Float_t         b5_Electron_ip3d[5];   //[b5_nElectron]
   Float_t         b5_Electron_jetPtRelv2[5];   //[b5_nElectron]
   Float_t         b5_Electron_jetRelIso[5];   //[b5_nElectron]
   Float_t         b5_Electron_mass[5];   //[b5_nElectron]
   Float_t         b5_Electron_miniPFRelIso_all[5];   //[b5_nElectron]
   Float_t         b5_Electron_miniPFRelIso_chg[5];   //[b5_nElectron]
   Float_t         b5_Electron_mvaFall17V1Iso[5];   //[b5_nElectron]
   Float_t         b5_Electron_mvaFall17V1noIso[5];   //[b5_nElectron]
   Float_t         b5_Electron_mvaFall17V2Iso[5];   //[b5_nElectron]
   Float_t         b5_Electron_mvaFall17V2noIso[5];   //[b5_nElectron]
   Float_t         b5_Electron_pfRelIso03_all[5];   //[b5_nElectron]
   Float_t         b5_Electron_pfRelIso03_chg[5];   //[b5_nElectron]
   Float_t         b5_Electron_phi[5];   //[b5_nElectron]
   Float_t         b5_Electron_pt[5];   //[b5_nElectron]
   Float_t         b5_Electron_r9[5];   //[b5_nElectron]
   Float_t         b5_Electron_scEtOverPt[5];   //[b5_nElectron]
   Float_t         b5_Electron_sieie[5];   //[b5_nElectron]
   Float_t         b5_Electron_sip3d[5];   //[b5_nElectron]
   Float_t         b5_Electron_mvaTTH[5];   //[b5_nElectron]
   Int_t           b5_Electron_charge[5];   //[b5_nElectron]
   Int_t           b5_Electron_cutBased[5];   //[b5_nElectron]
   Int_t           b5_Electron_cutBased_Fall17_V1[5];   //[b5_nElectron]
   Int_t           b5_Electron_jetIdx[5];   //[b5_nElectron]
   Int_t           b5_Electron_pdgId[5];   //[b5_nElectron]
   Int_t           b5_Electron_photonIdx[5];   //[b5_nElectron]
   Int_t           b5_Electron_tightCharge[5];   //[b5_nElectron]
   Int_t           b5_Electron_vidNestedWPBitmap[5];   //[b5_nElectron]
   Int_t           b5_Electron_vidNestedWPBitmapHEEP[5];   //[b5_nElectron]
   Bool_t          b5_Electron_convVeto[5];   //[b5_nElectron]
   Bool_t          b5_Electron_cutBased_HEEP[5];   //[b5_nElectron]
   Bool_t          b5_Electron_isPFcand[5];   //[b5_nElectron]
   UChar_t         b5_Electron_jetNDauCharged[5];   //[b5_nElectron]
   UChar_t         b5_Electron_lostHits[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V1Iso_WP80[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V1Iso_WP90[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V1Iso_WPL[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V1noIso_WP80[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V1noIso_WP90[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V1noIso_WPL[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V2Iso_WP80[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V2Iso_WP90[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V2Iso_WPL[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V2noIso_WP80[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V2noIso_WP90[5];   //[b5_nElectron]
   Bool_t          b5_Electron_mvaFall17V2noIso_WPL[5];   //[b5_nElectron]
   UChar_t         b5_Electron_seedGain[5];   //[b5_nElectron]
   UInt_t          b5_nFatJet;
   Float_t         b5_FatJet_area[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagCMVA[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagCSVV2[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagDDBvL[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagDDBvLV2[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagDDBvL_noMD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagDDCvB[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagDDCvBV2[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagDDCvB_noMD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagDDCvL[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagDDCvLV2[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagDDCvL_noMD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagDeepB[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_btagHbb[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTagMD_H4qvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTagMD_HbbvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTagMD_TvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTagMD_WvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTagMD_ZHbbvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTagMD_ZHccvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTagMD_ZbbvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTagMD_ZvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTagMD_bbvsLight[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTagMD_ccvsLight[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTag_H[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTag_QCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTag_QCDothers[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTag_TvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTag_WvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_deepTag_ZvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_eta[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_mass[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_msoftdrop[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_n2b1[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_n3b1[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNetMD_QCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNetMD_Xbb[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNetMD_Xcc[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNetMD_Xqq[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNet_H4qvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNet_HbbvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNet_HccvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNet_QCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNet_TvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNet_WvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_particleNet_ZvsQCD[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_phi[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_pt[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_rawFactor[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_tau1[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_tau2[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_tau3[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_tau4[2];   //[b5_nFatJet]
   Float_t         b5_FatJet_lsf3[2];   //[b5_nFatJet]
   Int_t           b5_FatJet_jetId[2];   //[b5_nFatJet]
   Int_t           b5_FatJet_subJetIdx1[2];   //[b5_nFatJet]
   Int_t           b5_FatJet_subJetIdx2[2];   //[b5_nFatJet]
   Int_t           b5_FatJet_electronIdx3SJ[2];   //[b5_nFatJet]
   Int_t           b5_FatJet_muonIdx3SJ[2];   //[b5_nFatJet]
   ...
   UInt_t          b5_nGenJetAK8;
   Float_t         b5_GenJetAK8_eta[2];   //[b5_nGenJetAK8]
   Float_t         b5_GenJetAK8_mass[2];   //[b5_nGenJetAK8]
   Float_t         b5_GenJetAK8_phi[2];   //[b5_nGenJetAK8]
   Float_t         b5_GenJetAK8_pt[2];   //[b5_nGenJetAK8]
   UInt_t          b5_nGenJet;
   Float_t         b5_GenJet_eta[17];   //[b5_nGenJet]
   Float_t         b5_GenJet_mass[17];   //[b5_nGenJet]
   Float_t         b5_GenJet_phi[17];   //[b5_nGenJet]
   Float_t         b5_GenJet_pt[17];   //[b5_nGenJet]
   UInt_t          b5_nGenPart;
   Float_t         b5_GenPart_eta[68];   //[b5_nGenPart]
   Float_t         b5_GenPart_mass[68];   //[b5_nGenPart]
   Float_t         b5_GenPart_phi[68];   //[b5_nGenPart]
   Float_t         b5_GenPart_pt[68];   //[b5_nGenPart]
   Int_t           b5_GenPart_genPartIdxMother[68];   //[b5_nGenPart]
   Int_t           b5_GenPart_pdgId[68];   //[b5_nGenPart]
   Int_t           b5_GenPart_status[68];   //[b5_nGenPart]
   Int_t           b5_GenPart_statusFlags[68];   //[b5_nGenPart]
   UInt_t          b5_nSubGenJetAK8;
   Float_t         b5_SubGenJetAK8_eta[4];   //[b5_nSubGenJetAK8]
   Float_t         b5_SubGenJetAK8_mass[4];   //[b5_nSubGenJetAK8]
   Float_t         b5_SubGenJetAK8_phi[4];   //[b5_nSubGenJetAK8]
   Float_t         b5_SubGenJetAK8_pt[4];   //[b5_nSubGenJetAK8]
   Float_t         b5_Generator_binvar;
   Float_t         b5_Generator_scalePDF;
   Float_t         b5_Generator_weight;
   Float_t         b5_Generator_x1;
   Float_t         b5_Generator_x2;
   Float_t         b5_Generator_xpdf1;
   Float_t         b5_Generator_xpdf2;
   Int_t           b5_Generator_id1;
   Int_t           b5_Generator_id2;
   Float_t         b5_GenVtx_x;
   Float_t         b5_GenVtx_y;
   Float_t         b5_GenVtx_z;
   UInt_t          b5_nGenVisTau;
   Float_t         b5_GenVisTau_eta[1];   //[b5_nGenVisTau]
   Float_t         b5_GenVisTau_mass[1];   //[b5_nGenVisTau]
   Float_t         b5_GenVisTau_phi[1];   //[b5_nGenVisTau]
   Float_t         b5_GenVisTau_pt[1];   //[b5_nGenVisTau]
   Int_t           b5_GenVisTau_charge[1];   //[b5_nGenVisTau]
   Int_t           b5_GenVisTau_genPartIdxMother[1];   //[b5_nGenVisTau]
   Int_t           b5_GenVisTau_status[1];   //[b5_nGenVisTau]
   Float_t         b5_genWeight;
   UInt_t          b5_nPSWeight;
   Float_t         b5_PSWeight[1];   //[b5_nPSWeight]
   UInt_t          b5_nIsoTrack;
   Float_t         b5_IsoTrack_dxy[2];   //[b5_nIsoTrack]
   Float_t         b5_IsoTrack_dz[2];   //[b5_nIsoTrack]
   Float_t         b5_IsoTrack_eta[2];   //[b5_nIsoTrack]
   Float_t         b5_IsoTrack_pfRelIso03_all[2];   //[b5_nIsoTrack]
   Float_t         b5_IsoTrack_pfRelIso03_chg[2];   //[b5_nIsoTrack]
   Float_t         b5_IsoTrack_phi[2];   //[b5_nIsoTrack]
   Float_t         b5_IsoTrack_pt[2];   //[b5_nIsoTrack]
   Float_t         b5_IsoTrack_miniPFRelIso_all[2];   //[b5_nIsoTrack]
   Float_t         b5_IsoTrack_miniPFRelIso_chg[2];   //[b5_nIsoTrack]
   Int_t           b5_IsoTrack_fromPV[2];   //[b5_nIsoTrack]
   Int_t           b5_IsoTrack_pdgId[2];   //[b5_nIsoTrack]
   Bool_t          b5_IsoTrack_isHighPurityTrack[2];   //[b5_nIsoTrack]
   Bool_t          b5_IsoTrack_isPFcand[2];   //[b5_nIsoTrack]
   Bool_t          b5_IsoTrack_isFromLostTrack[2];   //[b5_nIsoTrack]
   UInt_t          b5_nJet;
   Float_t         b5_Jet_area[16];   //[b5_nJet]
   Float_t         b5_Jet_btagCMVA[16];   //[b5_nJet]
   Float_t         b5_Jet_btagCSVV2[16];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepB[16];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepC[16];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepCvB[16];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepCvL[16];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepFlavB[16];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepFlavC[16];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepFlavCvB[16];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepFlavCvL[16];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepFlavQG[16];   //[b5_nJet]
   Float_t         b5_Jet_chEmEF[16];   //[b5_nJet]
   Float_t         b5_Jet_chFPV0EF[16];   //[b5_nJet]
   Float_t         b5_Jet_chFPV1EF[16];   //[b5_nJet]
   Float_t         b5_Jet_chFPV2EF[16];   //[b5_nJet]
   Float_t         b5_Jet_chFPV3EF[16];   //[b5_nJet]
   Float_t         b5_Jet_chHEF[16];   //[b5_nJet]
   Float_t         b5_Jet_eta[16];   //[b5_nJet]
   Float_t         b5_Jet_hfsigmaEtaEta[16];   //[b5_nJet]
   Float_t         b5_Jet_hfsigmaPhiPhi[16];   //[b5_nJet]
   Float_t         b5_Jet_mass[16];   //[b5_nJet]
   Float_t         b5_Jet_muEF[16];   //[b5_nJet]
   Float_t         b5_Jet_muonSubtrFactor[16];   //[b5_nJet]
   Float_t         b5_Jet_neEmEF[16];   //[b5_nJet]
   Float_t         b5_Jet_neHEF[16];   //[b5_nJet]
   Float_t         b5_Jet_phi[16];   //[b5_nJet]
   Float_t         b5_Jet_pt[16];   //[b5_nJet]
   Float_t         b5_Jet_puIdDisc[16];   //[b5_nJet]
   Float_t         b5_Jet_qgl[16];   //[b5_nJet]
   Float_t         b5_Jet_rawFactor[16];   //[b5_nJet]
   Float_t         b5_Jet_bRegCorr[16];   //[b5_nJet]
   Float_t         b5_Jet_bRegRes[16];   //[b5_nJet]
   Float_t         b5_Jet_cRegCorr[16];   //[b5_nJet]
   Float_t         b5_Jet_cRegRes[16];   //[b5_nJet]
   Int_t           b5_Jet_electronIdx1[16];   //[b5_nJet]
   Int_t           b5_Jet_electronIdx2[16];   //[b5_nJet]
   Int_t           b5_Jet_hfadjacentEtaStripsSize[16];   //[b5_nJet]
   Int_t           b5_Jet_hfcentralEtaStripSize[16];   //[b5_nJet]
   Int_t           b5_Jet_jetId[16];   //[b5_nJet]
   Int_t           b5_Jet_muonIdx1[16];   //[b5_nJet]
   Int_t           b5_Jet_muonIdx2[16];   //[b5_nJet]
   Int_t           b5_Jet_nConstituents[16];   //[b5_nJet]
   Int_t           b5_Jet_nElectrons[16];   //[b5_nJet]
   Int_t           b5_Jet_nMuons[16];   //[b5_nJet]
   Int_t           b5_Jet_puId[16];   //[b5_nJet]
   Float_t         b5_GenMET_phi;
   Float_t         b5_GenMET_pt;
   ...
   UInt_t          b5_nMuon;
   Float_t         b5_Muon_dxy[6];   //[b5_nMuon]
   Float_t         b5_Muon_dxyErr[6];   //[b5_nMuon]
   Float_t         b5_Muon_dxybs[6];   //[b5_nMuon]
   Float_t         b5_Muon_dz[6];   //[b5_nMuon]
   Float_t         b5_Muon_dzErr[6];   //[b5_nMuon]
   Float_t         b5_Muon_eta[6];   //[b5_nMuon]
   Float_t         b5_Muon_ip3d[6];   //[b5_nMuon]
   Float_t         b5_Muon_jetPtRelv2[6];   //[b5_nMuon]
   Float_t         b5_Muon_jetRelIso[6];   //[b5_nMuon]
   Float_t         b5_Muon_mass[6];   //[b5_nMuon]
   Float_t         b5_Muon_miniPFRelIso_all[6];   //[b5_nMuon]
   Float_t         b5_Muon_miniPFRelIso_chg[6];   //[b5_nMuon]
   Float_t         b5_Muon_pfRelIso03_all[6];   //[b5_nMuon]
   Float_t         b5_Muon_pfRelIso03_chg[6];   //[b5_nMuon]
   Float_t         b5_Muon_pfRelIso04_all[6];   //[b5_nMuon]
   Float_t         b5_Muon_phi[6];   //[b5_nMuon]
   Float_t         b5_Muon_pt[6];   //[b5_nMuon]
   Float_t         b5_Muon_ptErr[6];   //[b5_nMuon]
   Float_t         b5_Muon_segmentComp[6];   //[b5_nMuon]
   Float_t         b5_Muon_sip3d[6];   //[b5_nMuon]
   Float_t         b5_Muon_softMva[6];   //[b5_nMuon]
   Float_t         b5_Muon_tkRelIso[6];   //[b5_nMuon]
   Float_t         b5_Muon_tunepRelPt[6];   //[b5_nMuon]
   Float_t         b5_Muon_mvaLowPt[6];   //[b5_nMuon]
   Float_t         b5_Muon_mvaTTH[6];   //[b5_nMuon]
   Int_t           b5_Muon_charge[6];   //[b5_nMuon]
   Int_t           b5_Muon_jetIdx[6];   //[b5_nMuon]
   Int_t           b5_Muon_nStations[6];   //[b5_nMuon]
   Int_t           b5_Muon_nTrackerLayers[6];   //[b5_nMuon]
   Int_t           b5_Muon_pdgId[6];   //[b5_nMuon]
   Int_t           b5_Muon_tightCharge[6];   //[b5_nMuon]
   Int_t           b5_Muon_fsrPhotonIdx[6];   //[b5_nMuon]
   UChar_t         b5_Muon_highPtId[6];   //[b5_nMuon]
   Bool_t          b5_Muon_highPurity[6];   //[b5_nMuon]
   Bool_t          b5_Muon_inTimeMuon[6];   //[b5_nMuon]
   Bool_t          b5_Muon_isGlobal[6];   //[b5_nMuon]
   Bool_t          b5_Muon_isPFcand[6];   //[b5_nMuon]
   Bool_t          b5_Muon_isTracker[6];   //[b5_nMuon]
   UChar_t         b5_Muon_jetNDauCharged[6];   //[b5_nMuon]
   Bool_t          b5_Muon_looseId[6];   //[b5_nMuon]
   Bool_t          b5_Muon_mediumId[6];   //[b5_nMuon]
   Bool_t          b5_Muon_mediumPromptId[6];   //[b5_nMuon]
   UChar_t         b5_Muon_miniIsoId[6];   //[b5_nMuon]
   UChar_t         b5_Muon_multiIsoId[6];   //[b5_nMuon]
   UChar_t         b5_Muon_mvaId[6];   //[b5_nMuon]
   UChar_t         b5_Muon_mvaLowPtId[6];   //[b5_nMuon]
   UChar_t         b5_Muon_pfIsoId[6];   //[b5_nMuon]
   UChar_t         b5_Muon_puppiIsoId[6];   //[b5_nMuon]
   Bool_t          b5_Muon_softId[6];   //[b5_nMuon]
   Bool_t          b5_Muon_softMvaId[6];   //[b5_nMuon]
   Bool_t          b5_Muon_tightId[6];   //[b5_nMuon]
   UChar_t         b5_Muon_tkIsoId[6];   //[b5_nMuon]
   Bool_t          b5_Muon_triggerIdLoose[6];   //[b5_nMuon]
   UInt_t          b5_nPhoton;
   Float_t         b5_Photon_eCorr[4];   //[b5_nPhoton]
   Float_t         b5_Photon_energyErr[4];   //[b5_nPhoton]
   Float_t         b5_Photon_eta[4];   //[b5_nPhoton]
   Float_t         b5_Photon_hoe[4];   //[b5_nPhoton]
   Float_t         b5_Photon_mass[4];   //[b5_nPhoton]
   Float_t         b5_Photon_mvaID[4];   //[b5_nPhoton]
   Float_t         b5_Photon_mvaID_Fall17V1p1[4];   //[b5_nPhoton]
   Float_t         b5_Photon_pfRelIso03_all[4];   //[b5_nPhoton]
   Float_t         b5_Photon_pfRelIso03_chg[4];   //[b5_nPhoton]
   Float_t         b5_Photon_phi[4];   //[b5_nPhoton]
   Float_t         b5_Photon_pt[4];   //[b5_nPhoton]
   Float_t         b5_Photon_r9[4];   //[b5_nPhoton]
   Float_t         b5_Photon_sieie[4];   //[b5_nPhoton]
   Int_t           b5_Photon_charge[4];   //[b5_nPhoton]
   Int_t           b5_Photon_cutBased[4];   //[b5_nPhoton]
   Int_t           b5_Photon_cutBased_Fall17V1Bitmap[4];   //[b5_nPhoton]
   Int_t           b5_Photon_electronIdx[4];   //[b5_nPhoton]
   Int_t           b5_Photon_jetIdx[4];   //[b5_nPhoton]
   Int_t           b5_Photon_pdgId[4];   //[b5_nPhoton]
   Int_t           b5_Photon_vidNestedWPBitmap[4];   //[b5_nPhoton]
   Bool_t          b5_Photon_electronVeto[4];   //[b5_nPhoton]
   Bool_t          b5_Photon_isScEtaEB[4];   //[b5_nPhoton]
   Bool_t          b5_Photon_isScEtaEE[4];   //[b5_nPhoton]
   Bool_t          b5_Photon_mvaID_WP80[4];   //[b5_nPhoton]
   Bool_t          b5_Photon_mvaID_WP90[4];   //[b5_nPhoton]
   Bool_t          b5_Photon_pixelSeed[4];   //[b5_nPhoton]
   UChar_t         b5_Photon_seedGain[4];   //[b5_nPhoton]
   Int_t           b5_prescale_HLT_DoubleMu4_3_Bs;
   Int_t           b5_prescale_HLT_DoubleMu4_3_Jpsi;
   Int_t           b5_prescale_HLT_DoubleMu4_Jpsi_Displaced;
   Int_t           b5_prescale_HLT_DoubleMu4_Jpsi_NoVertexing;
   Int_t           b5_prescale_HLT_DoubleMu4_3_Jpsi_Displaced;
   Float_t         b5_Pileup_nTrueInt;
   Float_t         b5_Pileup_pudensity;
   Float_t         b5_Pileup_gpudensity;
   Int_t           b5_Pileup_nPU;
   Int_t           b5_Pileup_sumEOOT;
   Int_t           b5_Pileup_sumLOOT;
   ...
   UInt_t          b5_nGenDressedLepton;
   Float_t         b5_GenDressedLepton_eta[1];   //[b5_nGenDressedLepton]
   Float_t         b5_GenDressedLepton_mass[1];   //[b5_nGenDressedLepton]
   Float_t         b5_GenDressedLepton_phi[1];   //[b5_nGenDressedLepton]
   Float_t         b5_GenDressedLepton_pt[1];   //[b5_nGenDressedLepton]
   Int_t           b5_GenDressedLepton_pdgId[1];   //[b5_nGenDressedLepton]
   Bool_t          b5_GenDressedLepton_hasTauAnc[1];   //[b5_nGenDressedLepton]
   UInt_t          b5_nGenIsolatedPhoton;
   Float_t         b5_GenIsolatedPhoton_eta[1];   //[b5_nGenIsolatedPhoton]
   Float_t         b5_GenIsolatedPhoton_mass[1];   //[b5_nGenIsolatedPhoton]
   Float_t         b5_GenIsolatedPhoton_phi[1];   //[b5_nGenIsolatedPhoton]
   Float_t         b5_GenIsolatedPhoton_pt[1];   //[b5_nGenIsolatedPhoton]
   ...
   UInt_t          b5_nSubJet;
   Float_t         b5_SubJet_btagCMVA[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_btagCSVV2[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_btagDeepB[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_eta[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_mass[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_n2b1[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_n3b1[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_phi[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_pt[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_rawFactor[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_tau1[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_tau2[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_tau3[4];   //[b5_nSubJet]
   Float_t         b5_SubJet_tau4[4];   //[b5_nSubJet]
   UInt_t          b5_nTau;
   Float_t         b5_Tau_chargedIso[3];   //[b5_nTau]
   Float_t         b5_Tau_dxy[3];   //[b5_nTau]
   Float_t         b5_Tau_dz[3];   //[b5_nTau]
   Float_t         b5_Tau_eta[3];   //[b5_nTau]
   Float_t         b5_Tau_leadTkDeltaEta[3];   //[b5_nTau]
   Float_t         b5_Tau_leadTkDeltaPhi[3];   //[b5_nTau]
   Float_t         b5_Tau_leadTkPtOverTauPt[3];   //[b5_nTau]
   Float_t         b5_Tau_mass[3];   //[b5_nTau]
   Float_t         b5_Tau_neutralIso[3];   //[b5_nTau]
   Float_t         b5_Tau_phi[3];   //[b5_nTau]
   Float_t         b5_Tau_photonsOutsideSignalCone[3];   //[b5_nTau]
   Float_t         b5_Tau_pt[3];   //[b5_nTau]
   Float_t         b5_Tau_puCorr[3];   //[b5_nTau]
   Float_t         b5_Tau_rawAntiEle[3];   //[b5_nTau]
   Float_t         b5_Tau_rawAntiEle2018[3];   //[b5_nTau]
   Float_t         b5_Tau_rawDeepTau2017v2p1VSe[3];   //[b5_nTau]
   Float_t         b5_Tau_rawDeepTau2017v2p1VSjet[3];   //[b5_nTau]
   Float_t         b5_Tau_rawDeepTau2017v2p1VSmu[3];   //[b5_nTau]
   Float_t         b5_Tau_rawIso[3];   //[b5_nTau]
   Float_t         b5_Tau_rawIsodR03[3];   //[b5_nTau]
   Float_t         b5_Tau_rawMVAnewDM2017v2[3];   //[b5_nTau]
   Float_t         b5_Tau_rawMVAoldDM[3];   //[b5_nTau]
   Float_t         b5_Tau_rawMVAoldDM2017v1[3];   //[b5_nTau]
   Float_t         b5_Tau_rawMVAoldDM2017v2[3];   //[b5_nTau]
   Float_t         b5_Tau_rawMVAoldDMdR032017v2[3];   //[b5_nTau]
   Int_t           b5_Tau_charge[3];   //[b5_nTau]
   Int_t           b5_Tau_decayMode[3];   //[b5_nTau]
   Int_t           b5_Tau_jetIdx[3];   //[b5_nTau]
   Int_t           b5_Tau_rawAntiEleCat[3];   //[b5_nTau]
   Int_t           b5_Tau_rawAntiEleCat2018[3];   //[b5_nTau]
   UChar_t         b5_Tau_idAntiEle[3];   //[b5_nTau]
   UChar_t         b5_Tau_idAntiEle2018[3];   //[b5_nTau]
   Bool_t          b5_Tau_idAntiEleDeadECal[3];   //[b5_nTau]
   UChar_t         b5_Tau_idAntiMu[3];   //[b5_nTau]
   Bool_t          b5_Tau_idDecayMode[3];   //[b5_nTau]
   Bool_t          b5_Tau_idDecayModeNewDMs[3];   //[b5_nTau]
   UChar_t         b5_Tau_idDeepTau2017v2p1VSe[3];   //[b5_nTau]
   UChar_t         b5_Tau_idDeepTau2017v2p1VSjet[3];   //[b5_nTau]
   UChar_t         b5_Tau_idDeepTau2017v2p1VSmu[3];   //[b5_nTau]
   UChar_t         b5_Tau_idMVAnewDM2017v2[3];   //[b5_nTau]
   UChar_t         b5_Tau_idMVAoldDM[3];   //[b5_nTau]
   UChar_t         b5_Tau_idMVAoldDM2017v1[3];   //[b5_nTau]
   UChar_t         b5_Tau_idMVAoldDM2017v2[3];   //[b5_nTau]
   UChar_t         b5_Tau_idMVAoldDMdR032017v2[3];   //[b5_nTau]
   Float_t         b5_TkMET_phi;
   Float_t         b5_TkMET_pt;
   Float_t         b5_TkMET_sumEt;
   UInt_t          b5_nTrigObj;
   Float_t         b5_TrigObj_pt[8];   //[b5_nTrigObj]
   Float_t         b5_TrigObj_eta[8];   //[b5_nTrigObj]
   Float_t         b5_TrigObj_phi[8];   //[b5_nTrigObj]
   Float_t         b5_TrigObj_l1pt[8];   //[b5_nTrigObj]
   Float_t         b5_TrigObj_l1pt_2[8];   //[b5_nTrigObj]
   Float_t         b5_TrigObj_l2pt[8];   //[b5_nTrigObj]
   Int_t           b5_TrigObj_id[8];   //[b5_nTrigObj]
   Int_t           b5_TrigObj_l1iso[8];   //[b5_nTrigObj]
   Int_t           b5_TrigObj_l1charge[8];   //[b5_nTrigObj]
   Int_t           b5_TrigObj_filterBits[8];   //[b5_nTrigObj]
   Int_t           b5_genTtbarId;
   UInt_t          b5_nOtherPV;
   ...
   UInt_t          b5_nSV;
   Float_t         b5_SV_dlen[9];   //[b5_nSV]
   Float_t         b5_SV_dlenSig[9];   //[b5_nSV]
   Float_t         b5_SV_dxy[9];   //[b5_nSV]
   Float_t         b5_SV_dxySig[9];   //[b5_nSV]
   Float_t         b5_SV_pAngle[9];   //[b5_nSV]
   Int_t           b5_Electron_genPartIdx[5];   //[b5_nElectron]
   UChar_t         b5_Electron_genPartFlav[5];   //[b5_nElectron]
   Int_t           b5_FatJet_genJetAK8Idx[2];   //[b5_nFatJet]
   Int_t           b5_FatJet_hadronFlavour[2];   //[b5_nFatJet]
   UChar_t         b5_FatJet_nBHadrons[2];   //[b5_nFatJet]
   UChar_t         b5_FatJet_nCHadrons[2];   //[b5_nFatJet]
   Int_t           b5_GenJetAK8_partonFlavour[2];   //[b5_nGenJetAK8]
   UChar_t         b5_GenJetAK8_hadronFlavour[2];   //[b5_nGenJetAK8]
   Int_t           b5_GenJet_partonFlavour[17];   //[b5_nGenJet]
   UChar_t         b5_GenJet_hadronFlavour[17];   //[b5_nGenJet]
   Float_t         b5_GenVtx_t0;
   Int_t           b5_Jet_genJetIdx[16];   //[b5_nJet]
   Int_t           b5_Jet_hadronFlavour[16];   //[b5_nJet]
   Int_t           b5_Jet_partonFlavour[16];   //[b5_nJet]
   Int_t           b5_Muon_genPartIdx[6];   //[b5_nMuon]
   UChar_t         b5_Muon_genPartFlav[6];   //[b5_nMuon]
   Int_t           b5_Photon_genPartIdx[4];   //[b5_nPhoton]
   UChar_t         b5_Photon_genPartFlav[4];   //[b5_nPhoton]
   Float_t         b5_MET_fiducialGenPhi;
   Float_t         b5_MET_fiducialGenPt;
   UChar_t         b5_Electron_cleanmask[5];   //[b5_nElectron]
   UChar_t         b5_Jet_cleanmask[16];   //[b5_nJet]
   UChar_t         b5_Muon_cleanmask[6];   //[b5_nMuon]
   UChar_t         b5_Photon_cleanmask[4];   //[b5_nPhoton]
   UChar_t         b5_Tau_cleanmask[3];   //[b5_nTau]
   Int_t           b5_SubJet_hadronFlavour[4];   //[b5_nSubJet]
   UChar_t         b5_SubJet_nBHadrons[4];   //[b5_nSubJet]
   UChar_t         b5_SubJet_nCHadrons[4];   //[b5_nSubJet]
   Float_t         b5_SV_chi2[9];   //[b5_nSV]
   Float_t         b5_SV_eta[9];   //[b5_nSV]
   Float_t         b5_SV_mass[9];   //[b5_nSV]
   Float_t         b5_SV_ndof[9];   //[b5_nSV]
   Float_t         b5_SV_phi[9];   //[b5_nSV]
   Float_t         b5_SV_pt[9];   //[b5_nSV]
   Float_t         b5_SV_x[9];   //[b5_nSV]
   Float_t         b5_SV_y[9];   //[b5_nSV]
   Float_t         b5_SV_z[9];   //[b5_nSV]
   UChar_t         b5_SV_ntracks[9];   //[b5_nSV]
   Int_t           b5_Tau_genPartIdx[3];   //[b5_nTau]
   UChar_t         b5_Tau_genPartFlav[3];   //[b5_nTau]
   ...
   Bool_t          b5_HLT_Mu3_L1SingleMu5orSingleMu7;
   ...
   Bool_t          b5_HLT_Ele28_WPTight_Gsf;
   Bool_t          b5_HLT_Ele30_WPTight_Gsf;
   ...
   Bool_t          b5_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_CrossL1;
   Bool_t          b5_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_CrossL1;
   Bool_t          b5_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_CrossL1;
   Bool_t          b5_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1;
   Bool_t          b5_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1;
   Bool_t          b5_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1;
   ...
   Bool_t          b5_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_CrossL1;
   Bool_t          b5_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_CrossL1;
   Bool_t          b5_HLT_IsoMu20_eta2p1_LooseChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1;
   Bool_t          b5_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1;
   Bool_t          b5_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1;
   Bool_t          b5_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1;
   Bool_t          b5_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1;
   Bool_t          b5_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1;
   Bool_t          b5_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1;
   Bool_t          b5_HLT_IsoMu27_LooseChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1;
   Bool_t          b5_HLT_IsoMu27_MediumChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1;
   Bool_t          b5_HLT_IsoMu27_TightChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1;
   ...
   Bool_t          b5_HLT_DoubleL2Mu23NoVtx_2Cha_CosmicSeed_NoL2Matched;
   Bool_t          b5_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed;
   Bool_t          b5_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_NoL2Matched;
   Bool_t          b5_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_Eta2p4;
   Bool_t          b5_HLT_DoubleL2Mu23NoVtx_2Cha;
   Bool_t          b5_HLT_DoubleL2Mu23NoVtx_2Cha_NoL2Matched;
   Bool_t          b5_HLT_DoubleL2Mu25NoVtx_2Cha;
   Bool_t          b5_HLT_DoubleL2Mu25NoVtx_2Cha_NoL2Matched;
   ...
   Bool_t          b5_HLT_Mu30_TkMu0_Psi;
   Bool_t          b5_HLT_Mu30_TkMu0_Upsilon;
   ...
   Bool_t          b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30;
   Bool_t          b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30;
   Bool_t          b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30_PFBtagDeepCSV_1p5;
   Bool_t          b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30_CaloBtagDeepCSV_1p5;
   ...
   Bool_t          b5_HLT_BTagMu_AK4DiJet20_Mu5_noalgo;
   Bool_t          b5_HLT_BTagMu_AK4DiJet40_Mu5_noalgo;
   Bool_t          b5_HLT_BTagMu_AK4DiJet70_Mu5_noalgo;
   Bool_t          b5_HLT_BTagMu_AK4DiJet110_Mu5_noalgo;
   Bool_t          b5_HLT_BTagMu_AK4DiJet170_Mu5_noalgo;
   Bool_t          b5_HLT_BTagMu_AK4Jet300_Mu5_noalgo;
   Bool_t          b5_HLT_BTagMu_AK8DiJet170_Mu5_noalgo;
   Bool_t          b5_HLT_BTagMu_AK8Jet170_DoubleMu5_noalgo;
   Bool_t          b5_HLT_BTagMu_AK8Jet300_Mu5_noalgo;
   ...
   Bool_t          b5_HLT_Photon90_CaloIdL_PFHT700;
   ...
   Bool_t          b5_HLT_Photon35_TwoProngs35;
   Bool_t          b5_HLT_IsoMu24_TwoProngs35;
   ...
   Bool_t          b5_HLT_PFHT400_SixPFJet32_DoublePFBTagDeepCSV_2p94;
   Bool_t          b5_HLT_PFHT400_SixPFJet32;
   Bool_t          b5_HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59;
   Bool_t          b5_HLT_PFHT450_SixPFJet36;
   ...
   Bool_t          b5_HLT_ZeroBias_Alignment;
   ...
   Bool_t          b5_HLT_CDC_L2cosmic_5_er1p0;
   Bool_t          b5_HLT_CDC_L2cosmic_5p5_er1p0;
   ...
   Bool_t          b5_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg;
   Bool_t          b5_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg;
   Bool_t          b5_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_eta2p1_Reg;
   Bool_t          b5_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg;
   Bool_t          b5_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_eta2p1_Reg;
   Bool_t          b5_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_eta2p1_Reg;
   Bool_t          b5_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg;
   Bool_t          b5_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg;
   Bool_t          b5_HLT_VBF_DoubleLooseChargedIsoPFTauHPS20_Trk1_eta2p1;
   Bool_t          b5_HLT_VBF_DoubleMediumChargedIsoPFTauHPS20_Trk1_eta2p1;
   Bool_t          b5_HLT_VBF_DoubleTightChargedIsoPFTauHPS20_Trk1_eta2p1;
   ...
   Bool_t          b5_HLT_Mu12_IP6_part0;
   Bool_t          b5_HLT_Mu12_IP6_part1;
   Bool_t          b5_HLT_Mu12_IP6_part2;
   Bool_t          b5_HLT_Mu12_IP6_part3;
   Bool_t          b5_HLT_Mu12_IP6_part4;
   Bool_t          b5_HLT_Mu9_IP5_part0;
   Bool_t          b5_HLT_Mu9_IP5_part1;
   Bool_t          b5_HLT_Mu9_IP5_part2;
   Bool_t          b5_HLT_Mu9_IP5_part3;
   Bool_t          b5_HLT_Mu9_IP5_part4;
   Bool_t          b5_HLT_Mu7_IP4_part0;
   Bool_t          b5_HLT_Mu7_IP4_part1;
   Bool_t          b5_HLT_Mu7_IP4_part2;
   Bool_t          b5_HLT_Mu7_IP4_part3;
   Bool_t          b5_HLT_Mu7_IP4_part4;
   Bool_t          b5_HLT_Mu9_IP4_part0;
   Bool_t          b5_HLT_Mu9_IP4_part1;
   Bool_t          b5_HLT_Mu9_IP4_part2;
   Bool_t          b5_HLT_Mu9_IP4_part3;
   Bool_t          b5_HLT_Mu9_IP4_part4;
   Bool_t          b5_HLT_Mu8_IP5_part0;
   Bool_t          b5_HLT_Mu8_IP5_part1;
   Bool_t          b5_HLT_Mu8_IP5_part2;
   Bool_t          b5_HLT_Mu8_IP5_part3;
   Bool_t          b5_HLT_Mu8_IP5_part4;
   Bool_t          b5_HLT_Mu8_IP6_part0;
   Bool_t          b5_HLT_Mu8_IP6_part1;
   Bool_t          b5_HLT_Mu8_IP6_part2;
   Bool_t          b5_HLT_Mu8_IP6_part3;
   Bool_t          b5_HLT_Mu8_IP6_part4;
   ...
   Bool_t          b5_HLT_QuadPFJet105_88_76_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1;
   Bool_t          b5_HLT_TrkMu6NoFiltersNoVtx;
   Bool_t          b5_HLT_TrkMu16NoFiltersNoVtx;
   Bool_t          b5_HLT_DoubleTrkMu_16_6_NoFiltersNoVtx;
   Bool_t          b5_HLTriggerFinalPath;
   Bool_t          b5_L1simulation_step;
   UInt_t          bG_run;
   ULong64_t       bG_event;
   UInt_t          bG_lumis;
   Bool_t          bG_isData;
   Int_t           bG_gen_nBs;
   UInt_t          bG_ngen_Bs_pt;
   Double_t        bG_gen_Bs_pt[4];   //[bG_ngen_Bs_pt]
   UInt_t          bG_ngen_Bs_energy;
   Double_t        bG_gen_Bs_energy[4];   //[bG_ngen_Bs_energy]
   UInt_t          bG_ngen_Bs_eta;
   Double_t        bG_gen_Bs_eta[4];   //[bG_ngen_Bs_eta]
   UInt_t          bG_ngen_Bs_phi;
   Double_t        bG_gen_Bs_phi[4];   //[bG_ngen_Bs_phi]
   UInt_t          bG_ngen_Bs_pz;
   Double_t        bG_gen_Bs_pz[4];   //[bG_ngen_Bs_pz]
   UInt_t          bG_ngen_Bs_pdgId;
   Double_t        bG_gen_Bs_pdgId[4];   //[bG_ngen_Bs_pdgId]
   Int_t           bG_gen_nBsMuonM;
   UInt_t          bG_ngen_BsMuonM_pt;
   Double_t        bG_gen_BsMuonM_pt[2];   //[bG_ngen_BsMuonM_pt]
   UInt_t          bG_ngen_BsMuonM_eta;
   Double_t        bG_gen_BsMuonM_eta[2];   //[bG_ngen_BsMuonM_eta]
   UInt_t          bG_ngen_BsMuonM_phi;
   Double_t        bG_gen_BsMuonM_phi[2];   //[bG_ngen_BsMuonM_phi]
   Int_t           bG_gen_nBsMuonP;
   UInt_t          bG_ngen_BsMuonP_pt;
   Double_t        bG_gen_BsMuonP_pt[2];   //[bG_ngen_BsMuonP_pt]
   UInt_t          bG_ngen_BsMuonP_eta;
   Double_t        bG_gen_BsMuonP_eta[2];   //[bG_ngen_BsMuonP_eta]
   UInt_t          bG_ngen_BsMuonP_phi;
   Double_t        bG_gen_BsMuonP_phi[2];   //[bG_ngen_BsMuonP_phi]
   Int_t           bG_gen_nBsPhoton;
   UInt_t          bG_ngen_BsPhoton_pt;
   Double_t        bG_gen_BsPhoton_pt[3];   //[bG_ngen_BsPhoton_pt]
   UInt_t          bG_ngen_BsPhoton_energy;
   Double_t        bG_gen_BsPhoton_energy[3];   //[bG_ngen_BsPhoton_energy]
   UInt_t          bG_ngen_BsPhoton_eta;
   Double_t        bG_gen_BsPhoton_eta[3];   //[bG_ngen_BsPhoton_eta]
   UInt_t          bG_ngen_BsPhoton_phi;
   Double_t        bG_gen_BsPhoton_phi[3];   //[bG_ngen_BsPhoton_phi]
   Int_t           bG_nSC;
   UInt_t          bG_nscE;
   Float_t         bG_scE[16];   //[bG_nscE]
   UInt_t          bG_nscEt;
   Float_t         bG_scEt[16];   //[bG_nscEt]
   UInt_t          bG_nscRawE;
   Float_t         bG_scRawE[16];   //[bG_nscRawE]
   UInt_t          bG_nscEta;
   Float_t         bG_scEta[16];   //[bG_nscEta]
   UInt_t          bG_nscPhi;
   Float_t         bG_scPhi[16];   //[bG_nscPhi]
   UInt_t          bG_nscX;
   Float_t         bG_scX[16];   //[bG_nscX]
   UInt_t          bG_nscY;
   Float_t         bG_scY[16];   //[bG_nscY]
   UInt_t          bG_nscZ;
   Float_t         bG_scZ[16];   //[bG_nscZ]
   UInt_t          bG_nscEtaWidth;
   Float_t         bG_scEtaWidth[16];   //[bG_nscEtaWidth]
   UInt_t          bG_nscPhiWidth;
   Float_t         bG_scPhiWidth[16];   //[bG_nscPhiWidth]
   UInt_t          bG_nscRawEt;
   Float_t         bG_scRawEt[16];   //[bG_nscRawEt]
   ...
   UInt_t          bG_nscE5x5;
   Float_t         bG_scE5x5[16];   //[bG_nscE5x5]
   UInt_t          bG_nscE2x2Ratio;
   Float_t         bG_scE2x2Ratio[16];   //[bG_nscE2x2Ratio]
   UInt_t          bG_nscE3x3Ratio;
   Float_t         bG_scE3x3Ratio[16];   //[bG_nscE3x3Ratio]
   UInt_t          bG_nscEMaxRatio;
   Float_t         bG_scEMaxRatio[16];   //[bG_nscEMaxRatio]
   UInt_t          bG_nscE2ndRatio;
   Float_t         bG_scE2ndRatio[16];   //[bG_nscE2ndRatio]
   UInt_t          bG_nscETopRatio;
   Float_t         bG_scETopRatio[16];   //[bG_nscETopRatio]
   UInt_t          bG_nscERightRatio;
   Float_t         bG_scERightRatio[16];   //[bG_nscERightRatio]
   UInt_t          bG_nscEBottomRatio;
   Float_t         bG_scEBottomRatio[16];   //[bG_nscEBottomRatio]
   UInt_t          bG_nscELeftRatio;
   Float_t         bG_scELeftRatio[16];   //[bG_nscELeftRatio]
   UInt_t          bG_nscE2x5MaxRatio;
   Float_t         bG_scE2x5MaxRatio[16];   //[bG_nscE2x5MaxRatio]
   UInt_t          bG_nscE2x5TopRatio;
   Float_t         bG_scE2x5TopRatio[16];   //[bG_nscE2x5TopRatio]
   UInt_t          bG_nscE2x5RightRatio;
   Float_t         bG_scE2x5RightRatio[16];   //[bG_nscE2x5RightRatio]
   UInt_t          bG_nscE2x5BottomRatio;
   Float_t         bG_scE2x5BottomRatio[16];   //[bG_nscE2x5BottomRatio]
   UInt_t          bG_nscE2x5LeftRatio;
   Float_t         bG_scE2x5LeftRatio[16];   //[bG_nscE2x5LeftRatio]
   UInt_t          bG_nscSwissCross;
   Float_t         bG_scSwissCross[16];   //[bG_nscSwissCross]
   UInt_t          bG_nscR9;
   Float_t         bG_scR9[16];   //[bG_nscR9]
   UInt_t          bG_nscSigmaIetaIeta;
   Float_t         bG_scSigmaIetaIeta[16];   //[bG_nscSigmaIetaIeta]
   UInt_t          bG_nscSigmaIetaIphi;
   Float_t         bG_scSigmaIetaIphi[16];   //[bG_nscSigmaIetaIphi]
   UInt_t          bG_nscSigmaIphiIphi;
   Float_t         bG_scSigmaIphiIphi[16];   //[bG_nscSigmaIphiIphi]
   UInt_t          bG_nscFull5x5_e5x5;
   Float_t         bG_scFull5x5_e5x5[16];   //[bG_nscFull5x5_e5x5]
   UInt_t          bG_nscFull5x5_e2x2Ratio;
   Float_t         bG_scFull5x5_e2x2Ratio[16];   //[bG_nscFull5x5_e2x2Ratio]
   UInt_t          bG_nscFull5x5_e3x3Ratio;
   Float_t         bG_scFull5x5_e3x3Ratio[16];   //[bG_nscFull5x5_e3x3Ratio]
   UInt_t          bG_nscFull5x5_eMaxRatio;
   Float_t         bG_scFull5x5_eMaxRatio[16];   //[bG_nscFull5x5_eMaxRatio]
   UInt_t          bG_nscFull5x5_e2ndRatio;
   Float_t         bG_scFull5x5_e2ndRatio[16];   //[bG_nscFull5x5_e2ndRatio]
   UInt_t          bG_nscFull5x5_eTopRatio;
   Float_t         bG_scFull5x5_eTopRatio[16];   //[bG_nscFull5x5_eTopRatio]
   UInt_t          bG_nscFull5x5_eRightRatio;
   Float_t         bG_scFull5x5_eRightRatio[16];   //[bG_nscFull5x5_eRightRatio]
   UInt_t          bG_nscFull5x5_eBottomRatio;
   Float_t         bG_scFull5x5_eBottomRatio[16];   //[bG_nscFull5x5_eBottomRatio]
   UInt_t          bG_nscFull5x5_eLeftRatio;
   Float_t         bG_scFull5x5_eLeftRatio[16];   //[bG_nscFull5x5_eLeftRatio]
   UInt_t          bG_nscFull5x5_e2x5MaxRatio;
   Float_t         bG_scFull5x5_e2x5MaxRatio[16];   //[bG_nscFull5x5_e2x5MaxRatio]
   UInt_t          bG_nscFull5x5_e2x5TopRatio;
   Float_t         bG_scFull5x5_e2x5TopRatio[16];   //[bG_nscFull5x5_e2x5TopRatio]
   UInt_t          bG_nscFull5x5_e2x5RightRatio;
   Float_t         bG_scFull5x5_e2x5RightRatio[16];   //[bG_nscFull5x5_e2x5RightRatio]
   UInt_t          bG_nscFull5x5_e2x5BottomRatio;
   Float_t         bG_scFull5x5_e2x5BottomRatio[16];   //[bG_nscFull5x5_e2x5BottomRatio]
   UInt_t          bG_nscFull5x5_e2x5LeftRatio;
   Float_t         bG_scFull5x5_e2x5LeftRatio[16];   //[bG_nscFull5x5_e2x5LeftRatio]
   UInt_t          bG_nscFull5x5_swissCross;
   Float_t         bG_scFull5x5_swissCross[16];   //[bG_nscFull5x5_swissCross]
   UInt_t          bG_nscFull5x5_r9;
   Float_t         bG_scFull5x5_r9[16];   //[bG_nscFull5x5_r9]
   UInt_t          bG_nscFull5x5_sigmaIetaIeta;
   Float_t         bG_scFull5x5_sigmaIetaIeta[16];   //[bG_nscFull5x5_sigmaIetaIeta]
   UInt_t          bG_nscFull5x5_sigmaIetaIphi;
   Float_t         bG_scFull5x5_sigmaIetaIphi[16];   //[bG_nscFull5x5_sigmaIetaIphi]
   UInt_t          bG_nscFull5x5_sigmaIphiIphi;
   Float_t         bG_scFull5x5_sigmaIphiIphi[16];   //[bG_nscFull5x5_sigmaIphiIphi]
   UInt_t          bG_nscNHcalRecHitInDIEta5IPhi5;
   Float_t         bG_scNHcalRecHitInDIEta5IPhi5[16];   //[bG_nscNHcalRecHitInDIEta5IPhi5]
   UInt_t          bG_nscEFromHcalRecHitInDIEta5IPhi5;
   Float_t         bG_scEFromHcalRecHitInDIEta5IPhi5[16];   //[bG_nscEFromHcalRecHitInDIEta5IPhi5]
   UInt_t          bG_nscNHcalRecHitInDIEta2IPhi2;
   Float_t         bG_scNHcalRecHitInDIEta2IPhi2[16];   //[bG_nscNHcalRecHitInDIEta2IPhi2]
   UInt_t          bG_nscEFromHcalRecHitInDIEta2IPhi2;
   Float_t         bG_scEFromHcalRecHitInDIEta2IPhi2[16];   //[bG_nscEFromHcalRecHitInDIEta2IPhi2]
   UInt_t          bG_nscPFChIso1;
   Float_t         bG_scPFChIso1[16];   //[bG_nscPFChIso1]
   UInt_t          bG_nscPFChIso2;
   Float_t         bG_scPFChIso2[16];   //[bG_nscPFChIso2]
   UInt_t          bG_nscPFChIso3;
   Float_t         bG_scPFChIso3[16];   //[bG_nscPFChIso3]
   UInt_t          bG_nscPFChIso4;
   Float_t         bG_scPFChIso4[16];   //[bG_nscPFChIso4]
   UInt_t          bG_nscPFChIso5;
   Float_t         bG_scPFChIso5[16];   //[bG_nscPFChIso5]
   UInt_t          bG_nscPFPhoIso1;
   Float_t         bG_scPFPhoIso1[16];   //[bG_nscPFPhoIso1]
   UInt_t          bG_nscPFPhoIso2;
   Float_t         bG_scPFPhoIso2[16];   //[bG_nscPFPhoIso2]
   UInt_t          bG_nscPFPhoIso3;
   Float_t         bG_scPFPhoIso3[16];   //[bG_nscPFPhoIso3]
   UInt_t          bG_nscPFPhoIso4;
   Float_t         bG_scPFPhoIso4[16];   //[bG_nscPFPhoIso4]
   UInt_t          bG_nscPFPhoIso5;
   Float_t         bG_scPFPhoIso5[16];   //[bG_nscPFPhoIso5]
   UInt_t          bG_nscPFNeuIso1;
   Float_t         bG_scPFNeuIso1[16];   //[bG_nscPFNeuIso1]
   UInt_t          bG_nscPFNeuIso2;
   Float_t         bG_scPFNeuIso2[16];   //[bG_nscPFNeuIso2]
   UInt_t          bG_nscPFNeuIso3;
   Float_t         bG_scPFNeuIso3[16];   //[bG_nscPFNeuIso3]
   UInt_t          bG_nscPFNeuIso4;
   Float_t         bG_scPFNeuIso4[16];   //[bG_nscPFNeuIso4]
   UInt_t          bG_nscPFNeuIso5;
   Float_t         bG_scPFNeuIso5[16];   //[bG_nscPFNeuIso5]
   Int_t           bG_nPrimaryVertex;
   Float_t         bG_primaryVertex_isFake[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_x[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_y[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_z[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_t[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_covXX[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_covXY[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_covXZ[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_covYY[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_covYZ[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_covZZ[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_x_error[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_y_error[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_z_error[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_t_error[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_ntracks[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_ndof[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_chi2[71];   //[bG_nPrimaryVertex]
   Float_t         bG_primaryVertex_normalizedChi2[71];   //[bG_nPrimaryVertex]
   ...
   TBranch        *b_b5_MuonId_hlt_dr;   //!
   TBranch        *b_b5_MuonId_hlt_pt;   //!
   TBranch        *b_b5_MuonId_l1_eta;   //!
   TBranch        *b_b5_MuonId_l1_mpt;   //!
   TBranch        *b_b5_MuonId_l1_phi;   //!
   TBranch        *b_b5_MuonId_l1_pt;   //!
   ...
   TBranch        *b_b5_MuonId_simProdRho;   //!
   TBranch        *b_b5_MuonId_simProdZ;   //!
   TBranch        *b_b5_MuonId_trkKink;   //!
   TBranch        *b_b5_MuonId_trkValidFrac;   //!
   TBranch        *b_b5_MuonId_HLT_Dimuon0_LowMass;   //!
   TBranch        *b_b5_MuonId_HLT_Dimuon0_LowMass_L1_0er1p5;   //!
   TBranch        *b_b5_MuonId_HLT_Dimuon6_Jpsi_NoVertexing;   //!
   TBranch        *b_b5_MuonId_HLT_DoubleMu0;   //!
   TBranch        *b_b5_MuonId_HLT_DoubleMu4_3_Bs;   //!
   TBranch        *b_b5_MuonId_HLT_DoubleMu4_3_Jpsi;   //!
   TBranch        *b_b5_MuonId_HLT_DoubleMu4_3_Jpsi_Displaced;   //!
   TBranch        *b_b5_MuonId_HLT_DoubleMu4_Jpsi_Displaced;   //!
   TBranch        *b_b5_MuonId_HLT_DoubleMu4_Jpsi_NoVertexing;   //!
   TBranch        *b_b5_MuonId_HLT_IsoMu24;   //!
   TBranch        *b_b5_MuonId_HLT_IsoMu27;   //!
   TBranch        *b_b5_MuonId_HLT_Mu17;   //!
   TBranch        *b_b5_MuonId_HLT_Mu8;   //!
   TBranch        *b_b5_MuonId_highPurity;   //!
   TBranch        *b_b5_MuonId_l1_quality;   //!
   ...
   TBranch        *b_b5_MuonId_simExtType;   //!
   TBranch        *b_b5_MuonId_simMotherPdgId;   //!
   TBranch        *b_b5_MuonId_simPdgId;   //!
   TBranch        *b_b5_MuonId_simType;   //!
   ...
   TBranch        *b_b5_nbkkmm;   //!
   TBranch        *b_b5_bkkmm_gen_kaon1_pt;   //!
   TBranch        *b_b5_bkkmm_gen_kaon2_pt;   //!
   TBranch        *b_b5_bkkmm_gen_l3d;   //!
   TBranch        *b_b5_bkkmm_gen_lxy;   //!
   TBranch        *b_b5_bkkmm_gen_mass;   //!
   TBranch        *b_b5_bkkmm_gen_prod_x;   //!
   TBranch        *b_b5_bkkmm_gen_prod_y;   //!
   TBranch        *b_b5_bkkmm_gen_prod_z;   //!
   TBranch        *b_b5_bkkmm_gen_pt;   //!
   TBranch        *b_b5_bkkmm_gen_tau;   //!
   TBranch        *b_b5_bkkmm_jpsikk_alpha;   //!
   TBranch        *b_b5_bkkmm_jpsikk_alphaBS;   //!
   TBranch        *b_b5_bkkmm_jpsikk_alphaBSErr;   //!
   TBranch        *b_b5_bkkmm_jpsikk_alphaErr;   //!
   TBranch        *b_b5_bkkmm_jpsikk_eta;   //!
   TBranch        *b_b5_bkkmm_jpsikk_kaon1eta;   //!
   TBranch        *b_b5_bkkmm_jpsikk_kaon1phi;   //!
   TBranch        *b_b5_bkkmm_jpsikk_kaon1pt;   //!
   TBranch        *b_b5_bkkmm_jpsikk_kaon2eta;   //!
   TBranch        *b_b5_bkkmm_jpsikk_kaon2phi;   //!
   TBranch        *b_b5_bkkmm_jpsikk_kaon2pt;   //!
   TBranch        *b_b5_bkkmm_jpsikk_kk_mass;   //!
   TBranch        *b_b5_bkkmm_jpsikk_l3d;   //!
   TBranch        *b_b5_bkkmm_jpsikk_lxy;   //!
   TBranch        *b_b5_bkkmm_jpsikk_mass;   //!
   TBranch        *b_b5_bkkmm_jpsikk_massErr;   //!
   TBranch        *b_b5_bkkmm_jpsikk_phi;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pt;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pv2ip;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pv2ipErr;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pv2lip;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pv2lipErr;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pv2lipSig;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pv_z;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pv_zErr;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pvip;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pvipErr;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pvlip;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pvlipErr;   //!
   TBranch        *b_b5_bkkmm_jpsikk_pvlipSig;   //!
   TBranch        *b_b5_bkkmm_jpsikk_sl3d;   //!
   TBranch        *b_b5_bkkmm_jpsikk_slxy;   //!
   TBranch        *b_b5_bkkmm_jpsikk_spv2ip;   //!
   TBranch        *b_b5_bkkmm_jpsikk_spvip;   //!
   TBranch        *b_b5_bkkmm_jpsikk_tau;   //!
   TBranch        *b_b5_bkkmm_jpsikk_taue;   //!
   TBranch        *b_b5_bkkmm_jpsikk_tauxy;   //!
   TBranch        *b_b5_bkkmm_jpsikk_tauxye;   //!
   TBranch        *b_b5_bkkmm_jpsikk_vtx_chi2dof;   //!
   TBranch        *b_b5_bkkmm_jpsikk_vtx_prob;   //!
   TBranch        *b_b5_bkkmm_jpsikk_vtx_x;   //!
   TBranch        *b_b5_bkkmm_jpsikk_vtx_xErr;   //!
   TBranch        *b_b5_bkkmm_jpsikk_vtx_y;   //!
   TBranch        *b_b5_bkkmm_jpsikk_vtx_yErr;   //!
   TBranch        *b_b5_bkkmm_jpsikk_vtx_z;   //!
   TBranch        *b_b5_bkkmm_jpsikk_vtx_zErr;   //!
   TBranch        *b_b5_bkkmm_kaon1_dxy_bs;   //!
   TBranch        *b_b5_bkkmm_kaon1_eta;   //!
   TBranch        *b_b5_bkkmm_kaon1_phi;   //!
   TBranch        *b_b5_bkkmm_kaon1_pt;   //!
   TBranch        *b_b5_bkkmm_kaon1_sdxy_bs;   //!
   TBranch        *b_b5_bkkmm_kaon2_dxy_bs;   //!
   TBranch        *b_b5_bkkmm_kaon2_eta;   //!
   TBranch        *b_b5_bkkmm_kaon2_phi;   //!
   TBranch        *b_b5_bkkmm_kaon2_pt;   //!
   TBranch        *b_b5_bkkmm_kaon2_sdxy_bs;   //!
   TBranch        *b_b5_bkkmm_kk_mass;   //!
   TBranch        *b_b5_bkkmm_gen_kaon1_mpdgId;   //!
   TBranch        *b_b5_bkkmm_gen_kaon1_pdgId;   //!
   TBranch        *b_b5_bkkmm_gen_kaon2_mpdgId;   //!
   TBranch        *b_b5_bkkmm_gen_kaon2_pdgId;   //!
   TBranch        *b_b5_bkkmm_gen_pdgId;   //!
   TBranch        *b_b5_bkkmm_jpsikk_valid;   //!
   TBranch        *b_b5_bkkmm_kaon1_charge;   //!
   TBranch        *b_b5_bkkmm_kaon2_charge;   //!
   TBranch        *b_b5_bkkmm_mm_index;   //!
   TBranch        *b_b5_nbkmm;   //!
   TBranch        *b_b5_bkmm_bmm_bdt;   //!
   TBranch        *b_b5_bkmm_bmm_docatrk;   //!
   TBranch        *b_b5_bkmm_bmm_iso;   //!
   TBranch        *b_b5_bkmm_bmm_m1iso;   //!
   TBranch        *b_b5_bkmm_bmm_m2iso;   //!
   TBranch        *b_b5_bkmm_bmm_mva;   //!
   TBranch        *b_b5_bkmm_bmm_otherVtxMaxProb;   //!
   TBranch        *b_b5_bkmm_bmm_otherVtxMaxProb1;   //!
   TBranch        *b_b5_bkmm_bmm_otherVtxMaxProb2;   //!
   TBranch        *b_b5_bkmm_gen_kaon_pt;   //!
   TBranch        *b_b5_bkmm_gen_l3d;   //!
   TBranch        *b_b5_bkmm_gen_lxy;   //!
   TBranch        *b_b5_bkmm_gen_mass;   //!
   TBranch        *b_b5_bkmm_gen_prod_x;   //!
   TBranch        *b_b5_bkmm_gen_prod_y;   //!
   TBranch        *b_b5_bkmm_gen_prod_z;   //!
   TBranch        *b_b5_bkmm_gen_pt;   //!
   TBranch        *b_b5_bkmm_gen_tau;   //!
   TBranch        *b_b5_bkmm_jpsimc_alpha;   //!
   TBranch        *b_b5_bkmm_jpsimc_alphaBS;   //!
   TBranch        *b_b5_bkmm_jpsimc_alphaBSErr;   //!
   TBranch        *b_b5_bkmm_jpsimc_alphaErr;   //!
   TBranch        *b_b5_bkmm_jpsimc_eta;   //!
   TBranch        *b_b5_bkmm_jpsimc_kaon1eta;   //!
   TBranch        *b_b5_bkmm_jpsimc_kaon1phi;   //!
   TBranch        *b_b5_bkmm_jpsimc_kaon1pt;   //!
   TBranch        *b_b5_bkmm_jpsimc_l3d;   //!
   TBranch        *b_b5_bkmm_jpsimc_lxy;   //!
   TBranch        *b_b5_bkmm_jpsimc_mass;   //!
   TBranch        *b_b5_bkmm_jpsimc_massErr;   //!
   TBranch        *b_b5_bkmm_jpsimc_phi;   //!
   TBranch        *b_b5_bkmm_jpsimc_pt;   //!
   TBranch        *b_b5_bkmm_jpsimc_pv2ip;   //!
   TBranch        *b_b5_bkmm_jpsimc_pv2ipErr;   //!
   TBranch        *b_b5_bkmm_jpsimc_pv2lip;   //!
   TBranch        *b_b5_bkmm_jpsimc_pv2lipErr;   //!
   TBranch        *b_b5_bkmm_jpsimc_pv2lipSig;   //!
   TBranch        *b_b5_bkmm_jpsimc_pv_z;   //!
   TBranch        *b_b5_bkmm_jpsimc_pv_zErr;   //!
   TBranch        *b_b5_bkmm_jpsimc_pvip;   //!
   TBranch        *b_b5_bkmm_jpsimc_pvipErr;   //!
   TBranch        *b_b5_bkmm_jpsimc_pvlip;   //!
   TBranch        *b_b5_bkmm_jpsimc_pvlipErr;   //!
   TBranch        *b_b5_bkmm_jpsimc_pvlipSig;   //!
   TBranch        *b_b5_bkmm_jpsimc_sl3d;   //!
   TBranch        *b_b5_bkmm_jpsimc_slxy;   //!
   TBranch        *b_b5_bkmm_jpsimc_spv2ip;   //!
   TBranch        *b_b5_bkmm_jpsimc_spvip;   //!
   TBranch        *b_b5_bkmm_jpsimc_tau;   //!
   TBranch        *b_b5_bkmm_jpsimc_taue;   //!
   TBranch        *b_b5_bkmm_jpsimc_tauxy;   //!
   TBranch        *b_b5_bkmm_jpsimc_tauxye;   //!
   TBranch        *b_b5_bkmm_jpsimc_vtx_chi2dof;   //!
   TBranch        *b_b5_bkmm_jpsimc_vtx_prob;   //!
   TBranch        *b_b5_bkmm_jpsimc_vtx_x;   //!
   TBranch        *b_b5_bkmm_jpsimc_vtx_xErr;   //!
   TBranch        *b_b5_bkmm_jpsimc_vtx_y;   //!
   TBranch        *b_b5_bkmm_jpsimc_vtx_yErr;   //!
   TBranch        *b_b5_bkmm_jpsimc_vtx_z;   //!
   TBranch        *b_b5_bkmm_jpsimc_vtx_zErr;   //!
   TBranch        *b_b5_bkmm_kaon_dxy_bs;   //!
   TBranch        *b_b5_bkmm_kaon_eta;   //!
   TBranch        *b_b5_bkmm_kaon_mu1_doca;   //!
   TBranch        *b_b5_bkmm_kaon_mu2_doca;   //!
   TBranch        *b_b5_bkmm_kaon_phi;   //!
   TBranch        *b_b5_bkmm_kaon_pt;   //!
   TBranch        *b_b5_bkmm_kaon_sdxy_bs;   //!
   TBranch        *b_b5_bkmm_nomc_alpha;   //!
   TBranch        *b_b5_bkmm_nomc_alphaBS;   //!
   TBranch        *b_b5_bkmm_nomc_alphaBSErr;   //!
   TBranch        *b_b5_bkmm_nomc_alphaErr;   //!
   TBranch        *b_b5_bkmm_nomc_eta;   //!
   TBranch        *b_b5_bkmm_nomc_kaon1eta;   //!
   TBranch        *b_b5_bkmm_nomc_kaon1phi;   //!
   TBranch        *b_b5_bkmm_nomc_kaon1pt;   //!
   TBranch        *b_b5_bkmm_nomc_l3d;   //!
   TBranch        *b_b5_bkmm_nomc_lxy;   //!
   TBranch        *b_b5_bkmm_nomc_mass;   //!
   TBranch        *b_b5_bkmm_nomc_massErr;   //!
   TBranch        *b_b5_bkmm_nomc_phi;   //!
   TBranch        *b_b5_bkmm_nomc_pt;   //!
   TBranch        *b_b5_bkmm_nomc_pv2ip;   //!
   TBranch        *b_b5_bkmm_nomc_pv2ipErr;   //!
   TBranch        *b_b5_bkmm_nomc_pv2lip;   //!
   TBranch        *b_b5_bkmm_nomc_pv2lipErr;   //!
   TBranch        *b_b5_bkmm_nomc_pv2lipSig;   //!
   TBranch        *b_b5_bkmm_nomc_pv_z;   //!
   TBranch        *b_b5_bkmm_nomc_pv_zErr;   //!
   TBranch        *b_b5_bkmm_nomc_pvip;   //!
   TBranch        *b_b5_bkmm_nomc_pvipErr;   //!
   TBranch        *b_b5_bkmm_nomc_pvlip;   //!
   TBranch        *b_b5_bkmm_nomc_pvlipErr;   //!
   TBranch        *b_b5_bkmm_nomc_pvlipSig;   //!
   TBranch        *b_b5_bkmm_nomc_sl3d;   //!
   TBranch        *b_b5_bkmm_nomc_slxy;   //!
   TBranch        *b_b5_bkmm_nomc_spv2ip;   //!
   TBranch        *b_b5_bkmm_nomc_spvip;   //!
   TBranch        *b_b5_bkmm_nomc_tau;   //!
   TBranch        *b_b5_bkmm_nomc_taue;   //!
   TBranch        *b_b5_bkmm_nomc_tauxy;   //!
   TBranch        *b_b5_bkmm_nomc_tauxye;   //!
   TBranch        *b_b5_bkmm_nomc_vtx_chi2dof;   //!
   TBranch        *b_b5_bkmm_nomc_vtx_prob;   //!
   TBranch        *b_b5_bkmm_nomc_vtx_x;   //!
   TBranch        *b_b5_bkmm_nomc_vtx_xErr;   //!
   TBranch        *b_b5_bkmm_nomc_vtx_y;   //!
   TBranch        *b_b5_bkmm_nomc_vtx_yErr;   //!
   TBranch        *b_b5_bkmm_nomc_vtx_z;   //!
   TBranch        *b_b5_bkmm_nomc_vtx_zErr;   //!
   TBranch        *b_b5_bkmm_bmm_closetrk;   //!
   TBranch        *b_b5_bkmm_bmm_closetrks1;   //!
   TBranch        *b_b5_bkmm_bmm_closetrks2;   //!
   TBranch        *b_b5_bkmm_bmm_closetrks3;   //!
   TBranch        *b_b5_bkmm_bmm_nBMTrks;   //!
   TBranch        *b_b5_bkmm_bmm_nDisTrks;   //!
   TBranch        *b_b5_bkmm_bmm_nTrks;   //!
   TBranch        *b_b5_bkmm_gen_kaon_mpdgId;   //!
   TBranch        *b_b5_bkmm_gen_kaon_pdgId;   //!
   TBranch        *b_b5_bkmm_gen_pdgId;   //!
   TBranch        *b_b5_bkmm_jpsimc_valid;   //!
   TBranch        *b_b5_bkmm_kaon_charge;   //!
   TBranch        *b_b5_bkmm_mm_index;   //!
   TBranch        *b_b5_bkmm_nomc_valid;   //!
   TBranch        *b_b5_nmm;   //!
   TBranch        *b_b5_mm_bdt;   //!
   TBranch        *b_b5_mm_doca;   //!
   TBranch        *b_b5_mm_docatrk;   //!
   TBranch        *b_b5_mm_gen_alpha_ip;   //!
   TBranch        *b_b5_mm_gen_alpha_p_phi;   //!
   TBranch        *b_b5_mm_gen_alpha_p_theta;   //!
   TBranch        *b_b5_mm_gen_alpha_vtx;   //!
   TBranch        *b_b5_mm_gen_doca;   //!
   TBranch        *b_b5_mm_gen_l3d;   //!
   TBranch        *b_b5_mm_gen_lxy;   //!
   TBranch        *b_b5_mm_gen_mass;   //!
   TBranch        *b_b5_mm_gen_mu1_pt;   //!
   TBranch        *b_b5_mm_gen_mu2_pt;   //!
   TBranch        *b_b5_mm_gen_prod_z;   //!
   TBranch        *b_b5_mm_gen_pt;   //!
   TBranch        *b_b5_mm_gen_tau;   //!
   TBranch        *b_b5_mm_gen_vtx_x;   //!
   TBranch        *b_b5_mm_gen_vtx_y;   //!
   TBranch        *b_b5_mm_gen_vtx_z;   //!
   TBranch        *b_b5_mm_iso;   //!
   ...
   TBranch        *b_b5_mm_gen_cpdgId;   //!
   TBranch        *b_b5_mm_gen_mpdgId;   //!
   TBranch        *b_b5_mm_gen_mu1_mpdgId;   //!
   TBranch        *b_b5_mm_gen_mu1_pdgId;   //!
   TBranch        *b_b5_mm_gen_mu2_mpdgId;   //!
   TBranch        *b_b5_mm_gen_mu2_pdgId;   //!
   TBranch        *b_b5_mm_gen_pdgId;   //!
   ...
   TBranch        *b_b5_ngensummary;   //!
   TBranch        *b_b5_gensummary_n_anti_b;   //!
   TBranch        *b_b5_gensummary_n_b;   //!
   TBranch        *b_b5_gensummary_process_type;   //!
   TBranch        *b_b5_ngenbmm;   //!
   TBranch        *b_b5_genbmm_dau3_eta;   //!
   TBranch        *b_b5_genbmm_dau3_phi;   //!
   TBranch        *b_b5_genbmm_dau3_pt;   //!
   TBranch        *b_b5_genbmm_dau3_reco_eta;   //!
   TBranch        *b_b5_genbmm_dau3_reco_phi;   //!
   TBranch        *b_b5_genbmm_dau3_reco_pt;   //!
   TBranch        *b_b5_genbmm_dau4_eta;   //!
   TBranch        *b_b5_genbmm_dau4_phi;   //!
   TBranch        *b_b5_genbmm_dau4_pt;   //!
   TBranch        *b_b5_genbmm_dau4_reco_eta;   //!
   TBranch        *b_b5_genbmm_dau4_reco_phi;   //!
   TBranch        *b_b5_genbmm_dau4_reco_pt;   //!
   TBranch        *b_b5_genbmm_dimuon_mass;   //!
   TBranch        *b_b5_genbmm_eta;   //!
   TBranch        *b_b5_genbmm_mass;   //!
   TBranch        *b_b5_genbmm_mu1_eta;   //!
   TBranch        *b_b5_genbmm_mu1_phi;   //!
   TBranch        *b_b5_genbmm_mu1_pt;   //!
   TBranch        *b_b5_genbmm_mu2_eta;   //!
   TBranch        *b_b5_genbmm_mu2_phi;   //!
   TBranch        *b_b5_genbmm_mu2_pt;   //!
   TBranch        *b_b5_genbmm_phi;   //!
   TBranch        *b_b5_genbmm_pt;   //!
   TBranch        *b_b5_genbmm_rad_eta;   //!
   TBranch        *b_b5_genbmm_rad_p;   //!
   TBranch        *b_b5_genbmm_rad_phi;   //!
   TBranch        *b_b5_genbmm_rad_pt;   //!
   TBranch        *b_b5_genbmm_dau3_pdgId;   //!
   TBranch        *b_b5_genbmm_dau4_pdgId;   //!
   TBranch        *b_b5_genbmm_mu1_good;   //!
   TBranch        *b_b5_genbmm_mu1_index;   //!
   TBranch        *b_b5_genbmm_mu1_pdgId;   //!
   TBranch        *b_b5_genbmm_mu2_good;   //!
   TBranch        *b_b5_genbmm_mu2_index;   //!
   TBranch        *b_b5_genbmm_mu2_pdgId;   //!
   TBranch        *b_b5_genbmm_pdgId;   //!
   TBranch        *b_b5_genbmm_signature;   //!
   TBranch        *b_b5_nd0;   //!
   TBranch        *b_b5_d0_doca;   //!
   TBranch        *b_b5_d0_gen_kaon_pt;   //!
   TBranch        *b_b5_d0_gen_mass;   //!
   TBranch        *b_b5_d0_gen_pion_pt;   //!
   TBranch        *b_b5_d0_gen_pt;   //!
   ...
   TBranch        *b_b5_d0_gen_kaon_mpdgId;   //!
   TBranch        *b_b5_d0_gen_kaon_pdgId;   //!
   TBranch        *b_b5_d0_gen_pdgId;   //!
   TBranch        *b_b5_d0_gen_pion_mpdgId;   //!
   TBranch        *b_b5_d0_gen_pion_pdgId;   //!
   TBranch        *b_b5_d0_kaon_mu_index;   //!
   TBranch        *b_b5_d0_kin_valid;   //!
   TBranch        *b_b5_d0_pion_mu_index;   //!
   TBranch        *b_b5_HTXS_Higgs_pt;   //!
   TBranch        *b_b5_HTXS_Higgs_y;   //!
   TBranch        *b_b5_HTXS_stage1_1_cat_pTjet25GeV;   //!
   TBranch        *b_b5_HTXS_stage1_1_cat_pTjet30GeV;   //!
   TBranch        *b_b5_HTXS_stage1_1_fine_cat_pTjet25GeV;   //!
   TBranch        *b_b5_HTXS_stage1_1_fine_cat_pTjet30GeV;   //!
   TBranch        *b_b5_HTXS_stage1_2_cat_pTjet25GeV;   //!
   TBranch        *b_b5_HTXS_stage1_2_cat_pTjet30GeV;   //!
   TBranch        *b_b5_HTXS_stage1_2_fine_cat_pTjet25GeV;   //!
   TBranch        *b_b5_HTXS_stage1_2_fine_cat_pTjet30GeV;   //!
   TBranch        *b_b5_HTXS_stage_0;   //!
   TBranch        *b_b5_HTXS_stage_1_pTjet25;   //!
   TBranch        *b_b5_HTXS_stage_1_pTjet30;   //!
   TBranch        *b_b5_HTXS_njets25;   //!
   TBranch        *b_b5_HTXS_njets30;   //!
   TBranch        *b_b5_nks;   //!
   TBranch        *b_b5_ks_doca;   //!
   TBranch        *b_b5_ks_gen_mass;   //!
   TBranch        *b_b5_ks_gen_pt;   //!
   TBranch        *b_b5_ks_gen_trk1_pt;   //!
   TBranch        *b_b5_ks_gen_trk2_pt;   //!
   ...
   TBranch        *b_b5_ks_gen_pdgId;   //!
   TBranch        *b_b5_ks_gen_trk1_mpdgId;   //!
   TBranch        *b_b5_ks_gen_trk1_pdgId;   //!
   TBranch        *b_b5_ks_gen_trk2_mpdgId;   //!
   TBranch        *b_b5_ks_gen_trk2_pdgId;   //!
   ...
   TBranch        *b_b5_lambda_gen_mass;   //!
   TBranch        *b_b5_lambda_gen_pion_pt;   //!
   TBranch        *b_b5_lambda_gen_proton_pt;   //!
   TBranch        *b_b5_lambda_gen_pt;   //!
   ...
   TBranch        *b_b5_lambda_gen_pdgId;   //!
   TBranch        *b_b5_lambda_gen_pion_mpdgId;   //!
   TBranch        *b_b5_lambda_gen_pion_pdgId;   //!
   TBranch        *b_b5_lambda_gen_proton_mpdgId;   //!
   TBranch        *b_b5_lambda_gen_proton_pdgId;   //!
   ...
   TBranch        *b_b5_phi_gen_mass;   //!
   TBranch        *b_b5_phi_gen_pt;   //!
   TBranch        *b_b5_phi_gen_trk1_pt;   //!
   TBranch        *b_b5_phi_gen_trk2_pt;   //!
   ...
   TBranch        *b_b5_phi_gen_pdgId;   //!
   TBranch        *b_b5_phi_gen_trk1_mpdgId;   //!
   TBranch        *b_b5_phi_gen_trk1_pdgId;   //!
   TBranch        *b_b5_phi_gen_trk2_mpdgId;   //!
   TBranch        *b_b5_phi_gen_trk2_pdgId;   //!
   TBranch        *b_b5_phi_kin_valid;   //!
   TBranch        *b_b5_phi_trk1_mu_index;   //!
   TBranch        *b_b5_phi_trk2_mu_index;   //!
   TBranch        *b_b5_btagWeight_CSVV2;   //!
   TBranch        *b_b5_btagWeight_DeepCSVB;   //!
   ...
   TBranch        *b_b5_nGenJetAK8;   //!
   TBranch        *b_b5_GenJetAK8_eta;   //!
   TBranch        *b_b5_GenJetAK8_mass;   //!
   TBranch        *b_b5_GenJetAK8_phi;   //!
   TBranch        *b_b5_GenJetAK8_pt;   //!
   TBranch        *b_b5_nGenJet;   //!
   TBranch        *b_b5_GenJet_eta;   //!
   TBranch        *b_b5_GenJet_mass;   //!
   TBranch        *b_b5_GenJet_phi;   //!
   TBranch        *b_b5_GenJet_pt;   //!
   TBranch        *b_b5_nGenPart;   //!
   TBranch        *b_b5_GenPart_eta;   //!
   TBranch        *b_b5_GenPart_mass;   //!
   TBranch        *b_b5_GenPart_phi;   //!
   TBranch        *b_b5_GenPart_pt;   //!
   TBranch        *b_b5_GenPart_genPartIdxMother;   //!
   TBranch        *b_b5_GenPart_pdgId;   //!
   TBranch        *b_b5_GenPart_status;   //!
   TBranch        *b_b5_GenPart_statusFlags;   //!
   TBranch        *b_b5_nSubGenJetAK8;   //!
   TBranch        *b_b5_SubGenJetAK8_eta;   //!
   TBranch        *b_b5_SubGenJetAK8_mass;   //!
   TBranch        *b_b5_SubGenJetAK8_phi;   //!
   TBranch        *b_b5_SubGenJetAK8_pt;   //!
   TBranch        *b_b5_Generator_binvar;   //!
   TBranch        *b_b5_Generator_scalePDF;   //!
   TBranch        *b_b5_Generator_weight;   //!
   TBranch        *b_b5_Generator_x1;   //!
   TBranch        *b_b5_Generator_x2;   //!
   TBranch        *b_b5_Generator_xpdf1;   //!
   TBranch        *b_b5_Generator_xpdf2;   //!
   TBranch        *b_b5_Generator_id1;   //!
   TBranch        *b_b5_Generator_id2;   //!
   TBranch        *b_b5_GenVtx_x;   //!
   TBranch        *b_b5_GenVtx_y;   //!
   TBranch        *b_b5_GenVtx_z;   //!
   TBranch        *b_b5_nGenVisTau;   //!
   TBranch        *b_b5_GenVisTau_eta;   //!
   TBranch        *b_b5_GenVisTau_mass;   //!
   TBranch        *b_b5_GenVisTau_phi;   //!
   TBranch        *b_b5_GenVisTau_pt;   //!
   TBranch        *b_b5_GenVisTau_charge;   //!
   TBranch        *b_b5_GenVisTau_genPartIdxMother;   //!
   TBranch        *b_b5_GenVisTau_status;   //!
   TBranch        *b_b5_genWeight;   //!
   TBranch        *b_b5_nPSWeight;   //!
   TBranch        *b_b5_PSWeight;   //!
   ...
   TBranch        *b_b5_GenMET_phi;   //!
   TBranch        *b_b5_GenMET_pt;   //!
   ...
   TBranch        *b_b5_prescale_HLT_DoubleMu4_3_Bs;   //!
   TBranch        *b_b5_prescale_HLT_DoubleMu4_3_Jpsi;   //!
   TBranch        *b_b5_prescale_HLT_DoubleMu4_Jpsi_Displaced;   //!
   TBranch        *b_b5_prescale_HLT_DoubleMu4_Jpsi_NoVertexing;   //!
   TBranch        *b_b5_prescale_HLT_DoubleMu4_3_Jpsi_Displaced;   //!
   TBranch        *b_b5_Pileup_nTrueInt;   //!
   TBranch        *b_b5_Pileup_pudensity;   //!
   TBranch        *b_b5_Pileup_gpudensity;   //!
   TBranch        *b_b5_Pileup_nPU;   //!
   TBranch        *b_b5_Pileup_sumEOOT;   //!
   TBranch        *b_b5_Pileup_sumLOOT;   //!
   ...
   TBranch        *b_b5_nGenDressedLepton;   //!
   TBranch        *b_b5_GenDressedLepton_eta;   //!
   TBranch        *b_b5_GenDressedLepton_mass;   //!
   TBranch        *b_b5_GenDressedLepton_phi;   //!
   TBranch        *b_b5_GenDressedLepton_pt;   //!
   TBranch        *b_b5_GenDressedLepton_pdgId;   //!
   TBranch        *b_b5_GenDressedLepton_hasTauAnc;   //!
   TBranch        *b_b5_nGenIsolatedPhoton;   //!
   TBranch        *b_b5_GenIsolatedPhoton_eta;   //!
   TBranch        *b_b5_GenIsolatedPhoton_mass;   //!
   TBranch        *b_b5_GenIsolatedPhoton_phi;   //!
   TBranch        *b_b5_GenIsolatedPhoton_pt;   //!
   ...
   TBranch        *b_b5_Electron_genPartIdx;   //!
   TBranch        *b_b5_Electron_genPartFlav;   //!
   TBranch        *b_b5_FatJet_genJetAK8Idx;   //!
   TBranch        *b_b5_FatJet_hadronFlavour;   //!
   TBranch        *b_b5_FatJet_nBHadrons;   //!
   TBranch        *b_b5_FatJet_nCHadrons;   //!
   TBranch        *b_b5_GenJetAK8_partonFlavour;   //!
   TBranch        *b_b5_GenJetAK8_hadronFlavour;   //!
   TBranch        *b_b5_GenJet_partonFlavour;   //!
   TBranch        *b_b5_GenJet_hadronFlavour;   //!
   TBranch        *b_b5_GenVtx_t0;   //!
   TBranch        *b_b5_Jet_genJetIdx;   //!
   TBranch        *b_b5_Jet_hadronFlavour;   //!
   TBranch        *b_b5_Jet_partonFlavour;   //!
   TBranch        *b_b5_Muon_genPartIdx;   //!
   TBranch        *b_b5_Muon_genPartFlav;   //!
   TBranch        *b_b5_Photon_genPartIdx;   //!
   TBranch        *b_b5_Photon_genPartFlav;   //!
   TBranch        *b_b5_MET_fiducialGenPhi;   //!
   TBranch        *b_b5_MET_fiducialGenPt;   //!
   ...
   TBranch        *b_b5_SubJet_hadronFlavour;   //!
   TBranch        *b_b5_SubJet_nBHadrons;   //!
   TBranch        *b_b5_SubJet_nCHadrons;   //!
   ...
   TBranch        *b_b5_Tau_genPartIdx;   //!
   TBranch        *b_b5_Tau_genPartFlav;   //!
   ...
   TBranch        *b_b5_HLT_Mu3_L1SingleMu5orSingleMu7;   //!
   ...
   TBranch        *b_b5_HLT_Ele28_WPTight_Gsf;   //!
   TBranch        *b_b5_HLT_Ele30_WPTight_Gsf;   //!
   ...
   TBranch        *b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_CrossL1;   //!
   TBranch        *b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_CrossL1;   //!
   TBranch        *b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_CrossL1;   //!
   TBranch        *b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1;   //!
   TBranch        *b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1;   //!
   TBranch        *b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1;   //!
   ...
   TBranch        *b_b5_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_CrossL1;   //!
   TBranch        *b_b5_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_CrossL1;   //!
   TBranch        *b_b5_HLT_IsoMu20_eta2p1_LooseChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1;   //!
   TBranch        *b_b5_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1;   //!
   TBranch        *b_b5_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1;   //!
   TBranch        *b_b5_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1;   //!
   TBranch        *b_b5_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1;   //!
   TBranch        *b_b5_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1;   //!
   TBranch        *b_b5_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1;   //!
   TBranch        *b_b5_HLT_IsoMu27_LooseChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1;   //!
   TBranch        *b_b5_HLT_IsoMu27_MediumChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1;   //!
   TBranch        *b_b5_HLT_IsoMu27_TightChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1;   //!
   ...
   TBranch        *b_b5_HLT_DoubleL2Mu23NoVtx_2Cha_CosmicSeed_NoL2Matched;   //!
   TBranch        *b_b5_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed;   //!
   TBranch        *b_b5_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_NoL2Matched;   //!
   TBranch        *b_b5_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_Eta2p4;   //!
   TBranch        *b_b5_HLT_DoubleL2Mu23NoVtx_2Cha;   //!
   TBranch        *b_b5_HLT_DoubleL2Mu23NoVtx_2Cha_NoL2Matched;   //!
   TBranch        *b_b5_HLT_DoubleL2Mu25NoVtx_2Cha;   //!
   TBranch        *b_b5_HLT_DoubleL2Mu25NoVtx_2Cha_NoL2Matched;   //!
   ...
   TBranch        *b_b5_HLT_Mu30_TkMu0_Psi;   //!
   TBranch        *b_b5_HLT_Mu30_TkMu0_Upsilon;   //!
   ...
   TBranch        *b_b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30;   //!
   TBranch        *b_b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30;   //!
   TBranch        *b_b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30_PFBtagDeepCSV_1p5;   //!
   TBranch        *b_b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30_CaloBtagDeepCSV_1p5;   //!
   ...
   TBranch        *b_b5_HLT_BTagMu_AK4DiJet20_Mu5_noalgo;   //!
   TBranch        *b_b5_HLT_BTagMu_AK4DiJet40_Mu5_noalgo;   //!
   TBranch        *b_b5_HLT_BTagMu_AK4DiJet70_Mu5_noalgo;   //!
   TBranch        *b_b5_HLT_BTagMu_AK4DiJet110_Mu5_noalgo;   //!
   TBranch        *b_b5_HLT_BTagMu_AK4DiJet170_Mu5_noalgo;   //!
   TBranch        *b_b5_HLT_BTagMu_AK4Jet300_Mu5_noalgo;   //!
   TBranch        *b_b5_HLT_BTagMu_AK8DiJet170_Mu5_noalgo;   //!
   TBranch        *b_b5_HLT_BTagMu_AK8Jet170_DoubleMu5_noalgo;   //!
   TBranch        *b_b5_HLT_BTagMu_AK8Jet300_Mu5_noalgo;   //!
   ...
   TBranch        *b_b5_HLT_Photon90_CaloIdL_PFHT700;   //!
   ...
   TBranch        *b_b5_HLT_Photon35_TwoProngs35;   //!
   TBranch        *b_b5_HLT_IsoMu24_TwoProngs35;   //!
   ...
   TBranch        *b_b5_HLT_PFHT400_SixPFJet32_DoublePFBTagDeepCSV_2p94;   //!
   TBranch        *b_b5_HLT_PFHT400_SixPFJet32;   //!
   TBranch        *b_b5_HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59;   //!
   TBranch        *b_b5_HLT_PFHT450_SixPFJet36;   //!
   ...
   TBranch        *b_b5_HLT_ZeroBias_Alignment;   //!
   ...
   TBranch        *b_b5_HLT_CDC_L2cosmic_5_er1p0;   //!
   TBranch        *b_b5_HLT_CDC_L2cosmic_5p5_er1p0;   //!
   ...
   TBranch        *b_b5_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg;   //!
   TBranch        *b_b5_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg;   //!
   TBranch        *b_b5_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_eta2p1_Reg;   //!
   TBranch        *b_b5_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg;   //!
   TBranch        *b_b5_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_eta2p1_Reg;   //!
   TBranch        *b_b5_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_eta2p1_Reg;   //!
   TBranch        *b_b5_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg;   //!
   TBranch        *b_b5_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg;   //!
   TBranch        *b_b5_HLT_VBF_DoubleLooseChargedIsoPFTauHPS20_Trk1_eta2p1;   //!
   TBranch        *b_b5_HLT_VBF_DoubleMediumChargedIsoPFTauHPS20_Trk1_eta2p1;   //!
   TBranch        *b_b5_HLT_VBF_DoubleTightChargedIsoPFTauHPS20_Trk1_eta2p1;   //!
   ...
   TBranch        *b_b5_HLT_Mu12_IP6_part0;   //!
   TBranch        *b_b5_HLT_Mu12_IP6_part1;   //!
   TBranch        *b_b5_HLT_Mu12_IP6_part2;   //!
   TBranch        *b_b5_HLT_Mu12_IP6_part3;   //!
   TBranch        *b_b5_HLT_Mu12_IP6_part4;   //!
   TBranch        *b_b5_HLT_Mu9_IP5_part0;   //!
   TBranch        *b_b5_HLT_Mu9_IP5_part1;   //!
   TBranch        *b_b5_HLT_Mu9_IP5_part2;   //!
   TBranch        *b_b5_HLT_Mu9_IP5_part3;   //!
   TBranch        *b_b5_HLT_Mu9_IP5_part4;   //!
   TBranch        *b_b5_HLT_Mu7_IP4_part0;   //!
   TBranch        *b_b5_HLT_Mu7_IP4_part1;   //!
   TBranch        *b_b5_HLT_Mu7_IP4_part2;   //!
   TBranch        *b_b5_HLT_Mu7_IP4_part3;   //!
   TBranch        *b_b5_HLT_Mu7_IP4_part4;   //!
   TBranch        *b_b5_HLT_Mu9_IP4_part0;   //!
   TBranch        *b_b5_HLT_Mu9_IP4_part1;   //!
   TBranch        *b_b5_HLT_Mu9_IP4_part2;   //!
   TBranch        *b_b5_HLT_Mu9_IP4_part3;   //!
   TBranch        *b_b5_HLT_Mu9_IP4_part4;   //!
   TBranch        *b_b5_HLT_Mu8_IP5_part0;   //!
   TBranch        *b_b5_HLT_Mu8_IP5_part1;   //!
   TBranch        *b_b5_HLT_Mu8_IP5_part2;   //!
   TBranch        *b_b5_HLT_Mu8_IP5_part3;   //!
   TBranch        *b_b5_HLT_Mu8_IP5_part4;   //!
   TBranch        *b_b5_HLT_Mu8_IP6_part0;   //!
   TBranch        *b_b5_HLT_Mu8_IP6_part1;   //!
   TBranch        *b_b5_HLT_Mu8_IP6_part2;   //!
   TBranch        *b_b5_HLT_Mu8_IP6_part3;   //!
   TBranch        *b_b5_HLT_Mu8_IP6_part4;   //!
   ...
   TBranch        *b_b5_HLT_QuadPFJet105_88_76_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1;   //!
   TBranch        *b_b5_HLT_TrkMu6NoFiltersNoVtx;   //!
   TBranch        *b_b5_HLT_TrkMu16NoFiltersNoVtx;   //!
   TBranch        *b_b5_HLT_DoubleTrkMu_16_6_NoFiltersNoVtx;   //!
   TBranch        *b_b5_HLTriggerFinalPath;   //!
   TBranch        *b_b5_L1simulation_step;   //!
   TBranch        *b_bG_run;   //!
   TBranch        *b_bG_event;   //!
   TBranch        *b_bG_lumis;   //!
   TBranch        *b_bG_isData;   //!
   TBranch        *b_bG_gen_nBs;   //!
   TBranch        *b_bG_ngen_Bs_pt;   //!
   TBranch        *b_bG_gen_Bs_pt;   //!
   TBranch        *b_bG_ngen_Bs_energy;   //!
   TBranch        *b_bG_gen_Bs_energy;   //!
   TBranch        *b_bG_ngen_Bs_eta;   //!
   TBranch        *b_bG_gen_Bs_eta;   //!
   TBranch        *b_bG_ngen_Bs_phi;   //!
   TBranch        *b_bG_gen_Bs_phi;   //!
   TBranch        *b_bG_ngen_Bs_pz;   //!
   TBranch        *b_bG_gen_Bs_pz;   //!
   TBranch        *b_bG_ngen_Bs_pdgId;   //!
   TBranch        *b_bG_gen_Bs_pdgId;   //!
   TBranch        *b_bG_gen_nBsMuonM;   //!
   TBranch        *b_bG_ngen_BsMuonM_pt;   //!
   TBranch        *b_bG_gen_BsMuonM_pt;   //!
   TBranch        *b_bG_ngen_BsMuonM_eta;   //!
   TBranch        *b_bG_gen_BsMuonM_eta;   //!
   TBranch        *b_bG_ngen_BsMuonM_phi;   //!
   TBranch        *b_bG_gen_BsMuonM_phi;   //!
   TBranch        *b_bG_gen_nBsMuonP;   //!
   TBranch        *b_bG_ngen_BsMuonP_pt;   //!
   TBranch        *b_bG_gen_BsMuonP_pt;   //!
   TBranch        *b_bG_ngen_BsMuonP_eta;   //!
   TBranch        *b_bG_gen_BsMuonP_eta;   //!
   TBranch        *b_bG_ngen_BsMuonP_phi;   //!
   TBranch        *b_bG_gen_BsMuonP_phi;   //!
   TBranch        *b_bG_gen_nBsPhoton;   //!
   TBranch        *b_bG_ngen_BsPhoton_pt;   //!
   TBranch        *b_bG_gen_BsPhoton_pt;   //!
   TBranch        *b_bG_ngen_BsPhoton_energy;   //!
   TBranch        *b_bG_gen_BsPhoton_energy;   //!
   TBranch        *b_bG_ngen_BsPhoton_eta;   //!
   TBranch        *b_bG_gen_BsPhoton_eta;   //!
   TBranch        *b_bG_ngen_BsPhoton_phi;   //!
   TBranch        *b_bG_gen_BsPhoton_phi;   //!
   TBranch        *b_bG_nSC;   //!
   TBranch        *b_bG_nscE;   //!
   TBranch        *b_bG_scE;   //!
   TBranch        *b_bG_nscEt;   //!
   ...
   MergedBMMXMC(TTree *tree=0);
   virtual ~MergedBMMXMC();
...
#ifdef MergedBMMXMC_cxx
MergedBMMXMC::MergedBMMXMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
        std::cout<<"Constructing with null tree !\n";
   }
 else{
   Init(tree);
   }
...
MergedBMMXMC::~MergedBMMXMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MergedBMMXMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MergedBMMXMC::LoadTree(Long64_t entry)
{
...
void MergedBMMXMC::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("b5_MuonId_hlt_dr", b5_MuonId_hlt_dr, &b_b5_MuonId_hlt_dr);
   fChain->SetBranchAddress("b5_MuonId_hlt_pt", b5_MuonId_hlt_pt, &b_b5_MuonId_hlt_pt);
   fChain->SetBranchAddress("b5_MuonId_l1_eta", b5_MuonId_l1_eta, &b_b5_MuonId_l1_eta);
   fChain->SetBranchAddress("b5_MuonId_l1_mpt", b5_MuonId_l1_mpt, &b_b5_MuonId_l1_mpt);
   fChain->SetBranchAddress("b5_MuonId_l1_phi", b5_MuonId_l1_phi, &b_b5_MuonId_l1_phi);
   fChain->SetBranchAddress("b5_MuonId_l1_pt", b5_MuonId_l1_pt, &b_b5_MuonId_l1_pt);
   ...
   fChain->SetBranchAddress("b5_MuonId_simProdRho", b5_MuonId_simProdRho, &b_b5_MuonId_simProdRho);
   fChain->SetBranchAddress("b5_MuonId_simProdZ", b5_MuonId_simProdZ, &b_b5_MuonId_simProdZ);
   ...
   fChain->SetBranchAddress("b5_MuonId_HLT_Dimuon0_LowMass", b5_MuonId_HLT_Dimuon0_LowMass, &b_b5_MuonId_HLT_Dimuon0_LowMass);
   fChain->SetBranchAddress("b5_MuonId_HLT_Dimuon0_LowMass_L1_0er1p5", b5_MuonId_HLT_Dimuon0_LowMass_L1_0er1p5, &b_b5_MuonId_HLT_Dimuon0_LowMass_L1_0er1p5);
   fChain->SetBranchAddress("b5_MuonId_HLT_Dimuon6_Jpsi_NoVertexing", b5_MuonId_HLT_Dimuon6_Jpsi_NoVertexing, &b_b5_MuonId_HLT_Dimuon6_Jpsi_NoVertexing);
   fChain->SetBranchAddress("b5_MuonId_HLT_DoubleMu0", b5_MuonId_HLT_DoubleMu0, &b_b5_MuonId_HLT_DoubleMu0);
   fChain->SetBranchAddress("b5_MuonId_HLT_DoubleMu4_3_Bs", b5_MuonId_HLT_DoubleMu4_3_Bs, &b_b5_MuonId_HLT_DoubleMu4_3_Bs);
   fChain->SetBranchAddress("b5_MuonId_HLT_DoubleMu4_3_Jpsi", b5_MuonId_HLT_DoubleMu4_3_Jpsi, &b_b5_MuonId_HLT_DoubleMu4_3_Jpsi);
   fChain->SetBranchAddress("b5_MuonId_HLT_DoubleMu4_3_Jpsi_Displaced", b5_MuonId_HLT_DoubleMu4_3_Jpsi_Displaced, &b_b5_MuonId_HLT_DoubleMu4_3_Jpsi_Displaced);
   fChain->SetBranchAddress("b5_MuonId_HLT_DoubleMu4_Jpsi_Displaced", b5_MuonId_HLT_DoubleMu4_Jpsi_Displaced, &b_b5_MuonId_HLT_DoubleMu4_Jpsi_Displaced);
   fChain->SetBranchAddress("b5_MuonId_HLT_DoubleMu4_Jpsi_NoVertexing", b5_MuonId_HLT_DoubleMu4_Jpsi_NoVertexing, &b_b5_MuonId_HLT_DoubleMu4_Jpsi_NoVertexing);
   fChain->SetBranchAddress("b5_MuonId_HLT_IsoMu24", b5_MuonId_HLT_IsoMu24, &b_b5_MuonId_HLT_IsoMu24);
   fChain->SetBranchAddress("b5_MuonId_HLT_IsoMu27", b5_MuonId_HLT_IsoMu27, &b_b5_MuonId_HLT_IsoMu27);
   fChain->SetBranchAddress("b5_MuonId_HLT_Mu17", b5_MuonId_HLT_Mu17, &b_b5_MuonId_HLT_Mu17);
   fChain->SetBranchAddress("b5_MuonId_HLT_Mu8", b5_MuonId_HLT_Mu8, &b_b5_MuonId_HLT_Mu8);
   fChain->SetBranchAddress("b5_MuonId_highPurity", b5_MuonId_highPurity, &b_b5_MuonId_highPurity);
   fChain->SetBranchAddress("b5_MuonId_l1_quality", b5_MuonId_l1_quality, &b_b5_MuonId_l1_quality);
   ...
   fChain->SetBranchAddress("b5_MuonId_simExtType", b5_MuonId_simExtType, &b_b5_MuonId_simExtType);
   fChain->SetBranchAddress("b5_MuonId_simMotherPdgId", b5_MuonId_simMotherPdgId, &b_b5_MuonId_simMotherPdgId);
   fChain->SetBranchAddress("b5_MuonId_simPdgId", b5_MuonId_simPdgId, &b_b5_MuonId_simPdgId);
   fChain->SetBranchAddress("b5_MuonId_simType", b5_MuonId_simType, &b_b5_MuonId_simType);
   ...
   fChain->SetBranchAddress("b5_nbkkmm", &b5_nbkkmm, &b_b5_nbkkmm);
   fChain->SetBranchAddress("b5_bkkmm_gen_kaon1_pt", b5_bkkmm_gen_kaon1_pt, &b_b5_bkkmm_gen_kaon1_pt);
   fChain->SetBranchAddress("b5_bkkmm_gen_kaon2_pt", b5_bkkmm_gen_kaon2_pt, &b_b5_bkkmm_gen_kaon2_pt);
   fChain->SetBranchAddress("b5_bkkmm_gen_l3d", b5_bkkmm_gen_l3d, &b_b5_bkkmm_gen_l3d);
   fChain->SetBranchAddress("b5_bkkmm_gen_lxy", b5_bkkmm_gen_lxy, &b_b5_bkkmm_gen_lxy);
   fChain->SetBranchAddress("b5_bkkmm_gen_mass", b5_bkkmm_gen_mass, &b_b5_bkkmm_gen_mass);
   fChain->SetBranchAddress("b5_bkkmm_gen_prod_x", b5_bkkmm_gen_prod_x, &b_b5_bkkmm_gen_prod_x);
   fChain->SetBranchAddress("b5_bkkmm_gen_prod_y", b5_bkkmm_gen_prod_y, &b_b5_bkkmm_gen_prod_y);
   fChain->SetBranchAddress("b5_bkkmm_gen_prod_z", b5_bkkmm_gen_prod_z, &b_b5_bkkmm_gen_prod_z);
   fChain->SetBranchAddress("b5_bkkmm_gen_pt", b5_bkkmm_gen_pt, &b_b5_bkkmm_gen_pt);
   fChain->SetBranchAddress("b5_bkkmm_gen_tau", b5_bkkmm_gen_tau, &b_b5_bkkmm_gen_tau);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_alpha", b5_bkkmm_jpsikk_alpha, &b_b5_bkkmm_jpsikk_alpha);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_alphaBS", b5_bkkmm_jpsikk_alphaBS, &b_b5_bkkmm_jpsikk_alphaBS);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_alphaBSErr", b5_bkkmm_jpsikk_alphaBSErr, &b_b5_bkkmm_jpsikk_alphaBSErr);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_alphaErr", b5_bkkmm_jpsikk_alphaErr, &b_b5_bkkmm_jpsikk_alphaErr);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_eta", b5_bkkmm_jpsikk_eta, &b_b5_bkkmm_jpsikk_eta);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_kaon1eta", b5_bkkmm_jpsikk_kaon1eta, &b_b5_bkkmm_jpsikk_kaon1eta);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_kaon1phi", b5_bkkmm_jpsikk_kaon1phi, &b_b5_bkkmm_jpsikk_kaon1phi);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_kaon1pt", b5_bkkmm_jpsikk_kaon1pt, &b_b5_bkkmm_jpsikk_kaon1pt);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_kaon2eta", b5_bkkmm_jpsikk_kaon2eta, &b_b5_bkkmm_jpsikk_kaon2eta);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_kaon2phi", b5_bkkmm_jpsikk_kaon2phi, &b_b5_bkkmm_jpsikk_kaon2phi);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_kaon2pt", b5_bkkmm_jpsikk_kaon2pt, &b_b5_bkkmm_jpsikk_kaon2pt);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_kk_mass", b5_bkkmm_jpsikk_kk_mass, &b_b5_bkkmm_jpsikk_kk_mass);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_l3d", b5_bkkmm_jpsikk_l3d, &b_b5_bkkmm_jpsikk_l3d);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_lxy", b5_bkkmm_jpsikk_lxy, &b_b5_bkkmm_jpsikk_lxy);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_mass", b5_bkkmm_jpsikk_mass, &b_b5_bkkmm_jpsikk_mass);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_massErr", b5_bkkmm_jpsikk_massErr, &b_b5_bkkmm_jpsikk_massErr);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_phi", b5_bkkmm_jpsikk_phi, &b_b5_bkkmm_jpsikk_phi);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pt", b5_bkkmm_jpsikk_pt, &b_b5_bkkmm_jpsikk_pt);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pv2ip", b5_bkkmm_jpsikk_pv2ip, &b_b5_bkkmm_jpsikk_pv2ip);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pv2ipErr", b5_bkkmm_jpsikk_pv2ipErr, &b_b5_bkkmm_jpsikk_pv2ipErr);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pv2lip", b5_bkkmm_jpsikk_pv2lip, &b_b5_bkkmm_jpsikk_pv2lip);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pv2lipErr", b5_bkkmm_jpsikk_pv2lipErr, &b_b5_bkkmm_jpsikk_pv2lipErr);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pv2lipSig", b5_bkkmm_jpsikk_pv2lipSig, &b_b5_bkkmm_jpsikk_pv2lipSig);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pv_z", b5_bkkmm_jpsikk_pv_z, &b_b5_bkkmm_jpsikk_pv_z);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pv_zErr", b5_bkkmm_jpsikk_pv_zErr, &b_b5_bkkmm_jpsikk_pv_zErr);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pvip", b5_bkkmm_jpsikk_pvip, &b_b5_bkkmm_jpsikk_pvip);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pvipErr", b5_bkkmm_jpsikk_pvipErr, &b_b5_bkkmm_jpsikk_pvipErr);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pvlip", b5_bkkmm_jpsikk_pvlip, &b_b5_bkkmm_jpsikk_pvlip);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pvlipErr", b5_bkkmm_jpsikk_pvlipErr, &b_b5_bkkmm_jpsikk_pvlipErr);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_pvlipSig", b5_bkkmm_jpsikk_pvlipSig, &b_b5_bkkmm_jpsikk_pvlipSig);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_sl3d", b5_bkkmm_jpsikk_sl3d, &b_b5_bkkmm_jpsikk_sl3d);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_slxy", b5_bkkmm_jpsikk_slxy, &b_b5_bkkmm_jpsikk_slxy);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_spv2ip", b5_bkkmm_jpsikk_spv2ip, &b_b5_bkkmm_jpsikk_spv2ip);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_spvip", b5_bkkmm_jpsikk_spvip, &b_b5_bkkmm_jpsikk_spvip);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_tau", b5_bkkmm_jpsikk_tau, &b_b5_bkkmm_jpsikk_tau);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_taue", b5_bkkmm_jpsikk_taue, &b_b5_bkkmm_jpsikk_taue);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_tauxy", b5_bkkmm_jpsikk_tauxy, &b_b5_bkkmm_jpsikk_tauxy);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_tauxye", b5_bkkmm_jpsikk_tauxye, &b_b5_bkkmm_jpsikk_tauxye);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_vtx_chi2dof", b5_bkkmm_jpsikk_vtx_chi2dof, &b_b5_bkkmm_jpsikk_vtx_chi2dof);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_vtx_prob", b5_bkkmm_jpsikk_vtx_prob, &b_b5_bkkmm_jpsikk_vtx_prob);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_vtx_x", b5_bkkmm_jpsikk_vtx_x, &b_b5_bkkmm_jpsikk_vtx_x);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_vtx_xErr", b5_bkkmm_jpsikk_vtx_xErr, &b_b5_bkkmm_jpsikk_vtx_xErr);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_vtx_y", b5_bkkmm_jpsikk_vtx_y, &b_b5_bkkmm_jpsikk_vtx_y);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_vtx_yErr", b5_bkkmm_jpsikk_vtx_yErr, &b_b5_bkkmm_jpsikk_vtx_yErr);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_vtx_z", b5_bkkmm_jpsikk_vtx_z, &b_b5_bkkmm_jpsikk_vtx_z);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_vtx_zErr", b5_bkkmm_jpsikk_vtx_zErr, &b_b5_bkkmm_jpsikk_vtx_zErr);
   fChain->SetBranchAddress("b5_bkkmm_kaon1_dxy_bs", b5_bkkmm_kaon1_dxy_bs, &b_b5_bkkmm_kaon1_dxy_bs);
   fChain->SetBranchAddress("b5_bkkmm_kaon1_eta", b5_bkkmm_kaon1_eta, &b_b5_bkkmm_kaon1_eta);
   fChain->SetBranchAddress("b5_bkkmm_kaon1_phi", b5_bkkmm_kaon1_phi, &b_b5_bkkmm_kaon1_phi);
   fChain->SetBranchAddress("b5_bkkmm_kaon1_pt", b5_bkkmm_kaon1_pt, &b_b5_bkkmm_kaon1_pt);
   fChain->SetBranchAddress("b5_bkkmm_kaon1_sdxy_bs", b5_bkkmm_kaon1_sdxy_bs, &b_b5_bkkmm_kaon1_sdxy_bs);
   fChain->SetBranchAddress("b5_bkkmm_kaon2_dxy_bs", b5_bkkmm_kaon2_dxy_bs, &b_b5_bkkmm_kaon2_dxy_bs);
   fChain->SetBranchAddress("b5_bkkmm_kaon2_eta", b5_bkkmm_kaon2_eta, &b_b5_bkkmm_kaon2_eta);
   fChain->SetBranchAddress("b5_bkkmm_kaon2_phi", b5_bkkmm_kaon2_phi, &b_b5_bkkmm_kaon2_phi);
   fChain->SetBranchAddress("b5_bkkmm_kaon2_pt", b5_bkkmm_kaon2_pt, &b_b5_bkkmm_kaon2_pt);
   fChain->SetBranchAddress("b5_bkkmm_kaon2_sdxy_bs", b5_bkkmm_kaon2_sdxy_bs, &b_b5_bkkmm_kaon2_sdxy_bs);
   fChain->SetBranchAddress("b5_bkkmm_kk_mass", b5_bkkmm_kk_mass, &b_b5_bkkmm_kk_mass);
   fChain->SetBranchAddress("b5_bkkmm_gen_kaon1_mpdgId", b5_bkkmm_gen_kaon1_mpdgId, &b_b5_bkkmm_gen_kaon1_mpdgId);
   fChain->SetBranchAddress("b5_bkkmm_gen_kaon1_pdgId", b5_bkkmm_gen_kaon1_pdgId, &b_b5_bkkmm_gen_kaon1_pdgId);
   fChain->SetBranchAddress("b5_bkkmm_gen_kaon2_mpdgId", b5_bkkmm_gen_kaon2_mpdgId, &b_b5_bkkmm_gen_kaon2_mpdgId);
   fChain->SetBranchAddress("b5_bkkmm_gen_kaon2_pdgId", b5_bkkmm_gen_kaon2_pdgId, &b_b5_bkkmm_gen_kaon2_pdgId);
   fChain->SetBranchAddress("b5_bkkmm_gen_pdgId", b5_bkkmm_gen_pdgId, &b_b5_bkkmm_gen_pdgId);
   fChain->SetBranchAddress("b5_bkkmm_jpsikk_valid", b5_bkkmm_jpsikk_valid, &b_b5_bkkmm_jpsikk_valid);
   fChain->SetBranchAddress("b5_bkkmm_kaon1_charge", b5_bkkmm_kaon1_charge, &b_b5_bkkmm_kaon1_charge);
   fChain->SetBranchAddress("b5_bkkmm_kaon2_charge", b5_bkkmm_kaon2_charge, &b_b5_bkkmm_kaon2_charge);
   fChain->SetBranchAddress("b5_bkkmm_mm_index", b5_bkkmm_mm_index, &b_b5_bkkmm_mm_index);
   fChain->SetBranchAddress("b5_nbkmm", &b5_nbkmm, &b_b5_nbkmm);
   fChain->SetBranchAddress("b5_bkmm_bmm_bdt", b5_bkmm_bmm_bdt, &b_b5_bkmm_bmm_bdt);
   fChain->SetBranchAddress("b5_bkmm_bmm_docatrk", b5_bkmm_bmm_docatrk, &b_b5_bkmm_bmm_docatrk);
   fChain->SetBranchAddress("b5_bkmm_bmm_iso", b5_bkmm_bmm_iso, &b_b5_bkmm_bmm_iso);
   fChain->SetBranchAddress("b5_bkmm_bmm_m1iso", b5_bkmm_bmm_m1iso, &b_b5_bkmm_bmm_m1iso);
   fChain->SetBranchAddress("b5_bkmm_bmm_m2iso", b5_bkmm_bmm_m2iso, &b_b5_bkmm_bmm_m2iso);
   fChain->SetBranchAddress("b5_bkmm_bmm_mva", b5_bkmm_bmm_mva, &b_b5_bkmm_bmm_mva);
   fChain->SetBranchAddress("b5_bkmm_bmm_otherVtxMaxProb", b5_bkmm_bmm_otherVtxMaxProb, &b_b5_bkmm_bmm_otherVtxMaxProb);
   fChain->SetBranchAddress("b5_bkmm_bmm_otherVtxMaxProb1", b5_bkmm_bmm_otherVtxMaxProb1, &b_b5_bkmm_bmm_otherVtxMaxProb1);
   fChain->SetBranchAddress("b5_bkmm_bmm_otherVtxMaxProb2", b5_bkmm_bmm_otherVtxMaxProb2, &b_b5_bkmm_bmm_otherVtxMaxProb2);
   fChain->SetBranchAddress("b5_bkmm_gen_kaon_pt", b5_bkmm_gen_kaon_pt, &b_b5_bkmm_gen_kaon_pt);
   fChain->SetBranchAddress("b5_bkmm_gen_l3d", b5_bkmm_gen_l3d, &b_b5_bkmm_gen_l3d);
   fChain->SetBranchAddress("b5_bkmm_gen_lxy", b5_bkmm_gen_lxy, &b_b5_bkmm_gen_lxy);
   fChain->SetBranchAddress("b5_bkmm_gen_mass", b5_bkmm_gen_mass, &b_b5_bkmm_gen_mass);
   fChain->SetBranchAddress("b5_bkmm_gen_prod_x", b5_bkmm_gen_prod_x, &b_b5_bkmm_gen_prod_x);
   fChain->SetBranchAddress("b5_bkmm_gen_prod_y", b5_bkmm_gen_prod_y, &b_b5_bkmm_gen_prod_y);
   fChain->SetBranchAddress("b5_bkmm_gen_prod_z", b5_bkmm_gen_prod_z, &b_b5_bkmm_gen_prod_z);
   fChain->SetBranchAddress("b5_bkmm_gen_pt", b5_bkmm_gen_pt, &b_b5_bkmm_gen_pt);
   fChain->SetBranchAddress("b5_bkmm_gen_tau", b5_bkmm_gen_tau, &b_b5_bkmm_gen_tau);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_alpha", b5_bkmm_jpsimc_alpha, &b_b5_bkmm_jpsimc_alpha);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_alphaBS", b5_bkmm_jpsimc_alphaBS, &b_b5_bkmm_jpsimc_alphaBS);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_alphaBSErr", b5_bkmm_jpsimc_alphaBSErr, &b_b5_bkmm_jpsimc_alphaBSErr);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_alphaErr", b5_bkmm_jpsimc_alphaErr, &b_b5_bkmm_jpsimc_alphaErr);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_eta", b5_bkmm_jpsimc_eta, &b_b5_bkmm_jpsimc_eta);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_kaon1eta", b5_bkmm_jpsimc_kaon1eta, &b_b5_bkmm_jpsimc_kaon1eta);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_kaon1phi", b5_bkmm_jpsimc_kaon1phi, &b_b5_bkmm_jpsimc_kaon1phi);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_kaon1pt", b5_bkmm_jpsimc_kaon1pt, &b_b5_bkmm_jpsimc_kaon1pt);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_l3d", b5_bkmm_jpsimc_l3d, &b_b5_bkmm_jpsimc_l3d);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_lxy", b5_bkmm_jpsimc_lxy, &b_b5_bkmm_jpsimc_lxy);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_mass", b5_bkmm_jpsimc_mass, &b_b5_bkmm_jpsimc_mass);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_massErr", b5_bkmm_jpsimc_massErr, &b_b5_bkmm_jpsimc_massErr);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_phi", b5_bkmm_jpsimc_phi, &b_b5_bkmm_jpsimc_phi);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pt", b5_bkmm_jpsimc_pt, &b_b5_bkmm_jpsimc_pt);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pv2ip", b5_bkmm_jpsimc_pv2ip, &b_b5_bkmm_jpsimc_pv2ip);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pv2ipErr", b5_bkmm_jpsimc_pv2ipErr, &b_b5_bkmm_jpsimc_pv2ipErr);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pv2lip", b5_bkmm_jpsimc_pv2lip, &b_b5_bkmm_jpsimc_pv2lip);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pv2lipErr", b5_bkmm_jpsimc_pv2lipErr, &b_b5_bkmm_jpsimc_pv2lipErr);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pv2lipSig", b5_bkmm_jpsimc_pv2lipSig, &b_b5_bkmm_jpsimc_pv2lipSig);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pv_z", b5_bkmm_jpsimc_pv_z, &b_b5_bkmm_jpsimc_pv_z);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pv_zErr", b5_bkmm_jpsimc_pv_zErr, &b_b5_bkmm_jpsimc_pv_zErr);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pvip", b5_bkmm_jpsimc_pvip, &b_b5_bkmm_jpsimc_pvip);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pvipErr", b5_bkmm_jpsimc_pvipErr, &b_b5_bkmm_jpsimc_pvipErr);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pvlip", b5_bkmm_jpsimc_pvlip, &b_b5_bkmm_jpsimc_pvlip);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pvlipErr", b5_bkmm_jpsimc_pvlipErr, &b_b5_bkmm_jpsimc_pvlipErr);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_pvlipSig", b5_bkmm_jpsimc_pvlipSig, &b_b5_bkmm_jpsimc_pvlipSig);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_sl3d", b5_bkmm_jpsimc_sl3d, &b_b5_bkmm_jpsimc_sl3d);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_slxy", b5_bkmm_jpsimc_slxy, &b_b5_bkmm_jpsimc_slxy);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_spv2ip", b5_bkmm_jpsimc_spv2ip, &b_b5_bkmm_jpsimc_spv2ip);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_spvip", b5_bkmm_jpsimc_spvip, &b_b5_bkmm_jpsimc_spvip);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_tau", b5_bkmm_jpsimc_tau, &b_b5_bkmm_jpsimc_tau);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_taue", b5_bkmm_jpsimc_taue, &b_b5_bkmm_jpsimc_taue);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_tauxy", b5_bkmm_jpsimc_tauxy, &b_b5_bkmm_jpsimc_tauxy);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_tauxye", b5_bkmm_jpsimc_tauxye, &b_b5_bkmm_jpsimc_tauxye);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_vtx_chi2dof", b5_bkmm_jpsimc_vtx_chi2dof, &b_b5_bkmm_jpsimc_vtx_chi2dof);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_vtx_prob", b5_bkmm_jpsimc_vtx_prob, &b_b5_bkmm_jpsimc_vtx_prob);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_vtx_x", b5_bkmm_jpsimc_vtx_x, &b_b5_bkmm_jpsimc_vtx_x);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_vtx_xErr", b5_bkmm_jpsimc_vtx_xErr, &b_b5_bkmm_jpsimc_vtx_xErr);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_vtx_y", b5_bkmm_jpsimc_vtx_y, &b_b5_bkmm_jpsimc_vtx_y);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_vtx_yErr", b5_bkmm_jpsimc_vtx_yErr, &b_b5_bkmm_jpsimc_vtx_yErr);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_vtx_z", b5_bkmm_jpsimc_vtx_z, &b_b5_bkmm_jpsimc_vtx_z);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_vtx_zErr", b5_bkmm_jpsimc_vtx_zErr, &b_b5_bkmm_jpsimc_vtx_zErr);
   fChain->SetBranchAddress("b5_bkmm_kaon_dxy_bs", b5_bkmm_kaon_dxy_bs, &b_b5_bkmm_kaon_dxy_bs);
   fChain->SetBranchAddress("b5_bkmm_kaon_eta", b5_bkmm_kaon_eta, &b_b5_bkmm_kaon_eta);
   fChain->SetBranchAddress("b5_bkmm_kaon_mu1_doca", b5_bkmm_kaon_mu1_doca, &b_b5_bkmm_kaon_mu1_doca);
   fChain->SetBranchAddress("b5_bkmm_kaon_mu2_doca", b5_bkmm_kaon_mu2_doca, &b_b5_bkmm_kaon_mu2_doca);
   fChain->SetBranchAddress("b5_bkmm_kaon_phi", b5_bkmm_kaon_phi, &b_b5_bkmm_kaon_phi);
   fChain->SetBranchAddress("b5_bkmm_kaon_pt", b5_bkmm_kaon_pt, &b_b5_bkmm_kaon_pt);
   fChain->SetBranchAddress("b5_bkmm_kaon_sdxy_bs", b5_bkmm_kaon_sdxy_bs, &b_b5_bkmm_kaon_sdxy_bs);
   fChain->SetBranchAddress("b5_bkmm_nomc_alpha", b5_bkmm_nomc_alpha, &b_b5_bkmm_nomc_alpha);
   fChain->SetBranchAddress("b5_bkmm_nomc_alphaBS", b5_bkmm_nomc_alphaBS, &b_b5_bkmm_nomc_alphaBS);
   fChain->SetBranchAddress("b5_bkmm_nomc_alphaBSErr", b5_bkmm_nomc_alphaBSErr, &b_b5_bkmm_nomc_alphaBSErr);
   fChain->SetBranchAddress("b5_bkmm_nomc_alphaErr", b5_bkmm_nomc_alphaErr, &b_b5_bkmm_nomc_alphaErr);
   fChain->SetBranchAddress("b5_bkmm_nomc_eta", b5_bkmm_nomc_eta, &b_b5_bkmm_nomc_eta);
   fChain->SetBranchAddress("b5_bkmm_nomc_kaon1eta", b5_bkmm_nomc_kaon1eta, &b_b5_bkmm_nomc_kaon1eta);
   fChain->SetBranchAddress("b5_bkmm_nomc_kaon1phi", b5_bkmm_nomc_kaon1phi, &b_b5_bkmm_nomc_kaon1phi);
   fChain->SetBranchAddress("b5_bkmm_nomc_kaon1pt", b5_bkmm_nomc_kaon1pt, &b_b5_bkmm_nomc_kaon1pt);
   fChain->SetBranchAddress("b5_bkmm_nomc_l3d", b5_bkmm_nomc_l3d, &b_b5_bkmm_nomc_l3d);
   fChain->SetBranchAddress("b5_bkmm_nomc_lxy", b5_bkmm_nomc_lxy, &b_b5_bkmm_nomc_lxy);
   fChain->SetBranchAddress("b5_bkmm_nomc_mass", b5_bkmm_nomc_mass, &b_b5_bkmm_nomc_mass);
   fChain->SetBranchAddress("b5_bkmm_nomc_massErr", b5_bkmm_nomc_massErr, &b_b5_bkmm_nomc_massErr);
   fChain->SetBranchAddress("b5_bkmm_nomc_phi", b5_bkmm_nomc_phi, &b_b5_bkmm_nomc_phi);
   fChain->SetBranchAddress("b5_bkmm_nomc_pt", b5_bkmm_nomc_pt, &b_b5_bkmm_nomc_pt);
   fChain->SetBranchAddress("b5_bkmm_nomc_pv2ip", b5_bkmm_nomc_pv2ip, &b_b5_bkmm_nomc_pv2ip);
   fChain->SetBranchAddress("b5_bkmm_nomc_pv2ipErr", b5_bkmm_nomc_pv2ipErr, &b_b5_bkmm_nomc_pv2ipErr);
   fChain->SetBranchAddress("b5_bkmm_nomc_pv2lip", b5_bkmm_nomc_pv2lip, &b_b5_bkmm_nomc_pv2lip);
   fChain->SetBranchAddress("b5_bkmm_nomc_pv2lipErr", b5_bkmm_nomc_pv2lipErr, &b_b5_bkmm_nomc_pv2lipErr);
   fChain->SetBranchAddress("b5_bkmm_nomc_pv2lipSig", b5_bkmm_nomc_pv2lipSig, &b_b5_bkmm_nomc_pv2lipSig);
   fChain->SetBranchAddress("b5_bkmm_nomc_pv_z", b5_bkmm_nomc_pv_z, &b_b5_bkmm_nomc_pv_z);
   fChain->SetBranchAddress("b5_bkmm_nomc_pv_zErr", b5_bkmm_nomc_pv_zErr, &b_b5_bkmm_nomc_pv_zErr);
   fChain->SetBranchAddress("b5_bkmm_nomc_pvip", b5_bkmm_nomc_pvip, &b_b5_bkmm_nomc_pvip);
   fChain->SetBranchAddress("b5_bkmm_nomc_pvipErr", b5_bkmm_nomc_pvipErr, &b_b5_bkmm_nomc_pvipErr);
   fChain->SetBranchAddress("b5_bkmm_nomc_pvlip", b5_bkmm_nomc_pvlip, &b_b5_bkmm_nomc_pvlip);
   fChain->SetBranchAddress("b5_bkmm_nomc_pvlipErr", b5_bkmm_nomc_pvlipErr, &b_b5_bkmm_nomc_pvlipErr);
   fChain->SetBranchAddress("b5_bkmm_nomc_pvlipSig", b5_bkmm_nomc_pvlipSig, &b_b5_bkmm_nomc_pvlipSig);
   fChain->SetBranchAddress("b5_bkmm_nomc_sl3d", b5_bkmm_nomc_sl3d, &b_b5_bkmm_nomc_sl3d);
   fChain->SetBranchAddress("b5_bkmm_nomc_slxy", b5_bkmm_nomc_slxy, &b_b5_bkmm_nomc_slxy);
   fChain->SetBranchAddress("b5_bkmm_nomc_spv2ip", b5_bkmm_nomc_spv2ip, &b_b5_bkmm_nomc_spv2ip);
   fChain->SetBranchAddress("b5_bkmm_nomc_spvip", b5_bkmm_nomc_spvip, &b_b5_bkmm_nomc_spvip);
   fChain->SetBranchAddress("b5_bkmm_nomc_tau", b5_bkmm_nomc_tau, &b_b5_bkmm_nomc_tau);
   fChain->SetBranchAddress("b5_bkmm_nomc_taue", b5_bkmm_nomc_taue, &b_b5_bkmm_nomc_taue);
   fChain->SetBranchAddress("b5_bkmm_nomc_tauxy", b5_bkmm_nomc_tauxy, &b_b5_bkmm_nomc_tauxy);
   fChain->SetBranchAddress("b5_bkmm_nomc_tauxye", b5_bkmm_nomc_tauxye, &b_b5_bkmm_nomc_tauxye);
   fChain->SetBranchAddress("b5_bkmm_nomc_vtx_chi2dof", b5_bkmm_nomc_vtx_chi2dof, &b_b5_bkmm_nomc_vtx_chi2dof);
   fChain->SetBranchAddress("b5_bkmm_nomc_vtx_prob", b5_bkmm_nomc_vtx_prob, &b_b5_bkmm_nomc_vtx_prob);
   fChain->SetBranchAddress("b5_bkmm_nomc_vtx_x", b5_bkmm_nomc_vtx_x, &b_b5_bkmm_nomc_vtx_x);
   fChain->SetBranchAddress("b5_bkmm_nomc_vtx_xErr", b5_bkmm_nomc_vtx_xErr, &b_b5_bkmm_nomc_vtx_xErr);
   fChain->SetBranchAddress("b5_bkmm_nomc_vtx_y", b5_bkmm_nomc_vtx_y, &b_b5_bkmm_nomc_vtx_y);
   fChain->SetBranchAddress("b5_bkmm_nomc_vtx_yErr", b5_bkmm_nomc_vtx_yErr, &b_b5_bkmm_nomc_vtx_yErr);
   fChain->SetBranchAddress("b5_bkmm_nomc_vtx_z", b5_bkmm_nomc_vtx_z, &b_b5_bkmm_nomc_vtx_z);
   fChain->SetBranchAddress("b5_bkmm_nomc_vtx_zErr", b5_bkmm_nomc_vtx_zErr, &b_b5_bkmm_nomc_vtx_zErr);
   fChain->SetBranchAddress("b5_bkmm_bmm_closetrk", b5_bkmm_bmm_closetrk, &b_b5_bkmm_bmm_closetrk);
   fChain->SetBranchAddress("b5_bkmm_bmm_closetrks1", b5_bkmm_bmm_closetrks1, &b_b5_bkmm_bmm_closetrks1);
   fChain->SetBranchAddress("b5_bkmm_bmm_closetrks2", b5_bkmm_bmm_closetrks2, &b_b5_bkmm_bmm_closetrks2);
   fChain->SetBranchAddress("b5_bkmm_bmm_closetrks3", b5_bkmm_bmm_closetrks3, &b_b5_bkmm_bmm_closetrks3);
   fChain->SetBranchAddress("b5_bkmm_bmm_nBMTrks", b5_bkmm_bmm_nBMTrks, &b_b5_bkmm_bmm_nBMTrks);
   fChain->SetBranchAddress("b5_bkmm_bmm_nDisTrks", b5_bkmm_bmm_nDisTrks, &b_b5_bkmm_bmm_nDisTrks);
   fChain->SetBranchAddress("b5_bkmm_bmm_nTrks", b5_bkmm_bmm_nTrks, &b_b5_bkmm_bmm_nTrks);
   fChain->SetBranchAddress("b5_bkmm_gen_kaon_mpdgId", b5_bkmm_gen_kaon_mpdgId, &b_b5_bkmm_gen_kaon_mpdgId);
   fChain->SetBranchAddress("b5_bkmm_gen_kaon_pdgId", b5_bkmm_gen_kaon_pdgId, &b_b5_bkmm_gen_kaon_pdgId);
   fChain->SetBranchAddress("b5_bkmm_gen_pdgId", b5_bkmm_gen_pdgId, &b_b5_bkmm_gen_pdgId);
   fChain->SetBranchAddress("b5_bkmm_jpsimc_valid", b5_bkmm_jpsimc_valid, &b_b5_bkmm_jpsimc_valid);
   fChain->SetBranchAddress("b5_bkmm_kaon_charge", b5_bkmm_kaon_charge, &b_b5_bkmm_kaon_charge);
   fChain->SetBranchAddress("b5_bkmm_mm_index", b5_bkmm_mm_index, &b_b5_bkmm_mm_index);
   fChain->SetBranchAddress("b5_bkmm_nomc_valid", b5_bkmm_nomc_valid, &b_b5_bkmm_nomc_valid);
   ...
   fChain->SetBranchAddress("b5_mm_gen_alpha_ip", b5_mm_gen_alpha_ip, &b_b5_mm_gen_alpha_ip);
   fChain->SetBranchAddress("b5_mm_gen_alpha_p_phi", b5_mm_gen_alpha_p_phi, &b_b5_mm_gen_alpha_p_phi);
   fChain->SetBranchAddress("b5_mm_gen_alpha_p_theta", b5_mm_gen_alpha_p_theta, &b_b5_mm_gen_alpha_p_theta);
   fChain->SetBranchAddress("b5_mm_gen_alpha_vtx", b5_mm_gen_alpha_vtx, &b_b5_mm_gen_alpha_vtx);
   fChain->SetBranchAddress("b5_mm_gen_doca", b5_mm_gen_doca, &b_b5_mm_gen_doca);
   fChain->SetBranchAddress("b5_mm_gen_l3d", b5_mm_gen_l3d, &b_b5_mm_gen_l3d);
   fChain->SetBranchAddress("b5_mm_gen_lxy", b5_mm_gen_lxy, &b_b5_mm_gen_lxy);
   fChain->SetBranchAddress("b5_mm_gen_mass", b5_mm_gen_mass, &b_b5_mm_gen_mass);
   fChain->SetBranchAddress("b5_mm_gen_mu1_pt", b5_mm_gen_mu1_pt, &b_b5_mm_gen_mu1_pt);
   fChain->SetBranchAddress("b5_mm_gen_mu2_pt", b5_mm_gen_mu2_pt, &b_b5_mm_gen_mu2_pt);
   fChain->SetBranchAddress("b5_mm_gen_prod_z", b5_mm_gen_prod_z, &b_b5_mm_gen_prod_z);
   fChain->SetBranchAddress("b5_mm_gen_pt", b5_mm_gen_pt, &b_b5_mm_gen_pt);
   fChain->SetBranchAddress("b5_mm_gen_tau", b5_mm_gen_tau, &b_b5_mm_gen_tau);
   fChain->SetBranchAddress("b5_mm_gen_vtx_x", b5_mm_gen_vtx_x, &b_b5_mm_gen_vtx_x);
   fChain->SetBranchAddress("b5_mm_gen_vtx_y", b5_mm_gen_vtx_y, &b_b5_mm_gen_vtx_y);
   fChain->SetBranchAddress("b5_mm_gen_vtx_z", b5_mm_gen_vtx_z, &b_b5_mm_gen_vtx_z);
   ...
   fChain->SetBranchAddress("b5_mm_gen_cpdgId", b5_mm_gen_cpdgId, &b_b5_mm_gen_cpdgId);
   fChain->SetBranchAddress("b5_mm_gen_mpdgId", b5_mm_gen_mpdgId, &b_b5_mm_gen_mpdgId);
   fChain->SetBranchAddress("b5_mm_gen_mu1_mpdgId", b5_mm_gen_mu1_mpdgId, &b_b5_mm_gen_mu1_mpdgId);
   fChain->SetBranchAddress("b5_mm_gen_mu1_pdgId", b5_mm_gen_mu1_pdgId, &b_b5_mm_gen_mu1_pdgId);
   fChain->SetBranchAddress("b5_mm_gen_mu2_mpdgId", b5_mm_gen_mu2_mpdgId, &b_b5_mm_gen_mu2_mpdgId);
   fChain->SetBranchAddress("b5_mm_gen_mu2_pdgId", b5_mm_gen_mu2_pdgId, &b_b5_mm_gen_mu2_pdgId);
   fChain->SetBranchAddress("b5_mm_gen_pdgId", b5_mm_gen_pdgId, &b_b5_mm_gen_pdgId);
   ...
   fChain->SetBranchAddress("b5_ngensummary", &b5_ngensummary, &b_b5_ngensummary);
   fChain->SetBranchAddress("b5_gensummary_n_anti_b", b5_gensummary_n_anti_b, &b_b5_gensummary_n_anti_b);
   fChain->SetBranchAddress("b5_gensummary_n_b", b5_gensummary_n_b, &b_b5_gensummary_n_b);
   fChain->SetBranchAddress("b5_gensummary_process_type", b5_gensummary_process_type, &b_b5_gensummary_process_type);
   fChain->SetBranchAddress("b5_ngenbmm", &b5_ngenbmm, &b_b5_ngenbmm);
   fChain->SetBranchAddress("b5_genbmm_dau3_eta", b5_genbmm_dau3_eta, &b_b5_genbmm_dau3_eta);
   fChain->SetBranchAddress("b5_genbmm_dau3_phi", b5_genbmm_dau3_phi, &b_b5_genbmm_dau3_phi);
   fChain->SetBranchAddress("b5_genbmm_dau3_pt", b5_genbmm_dau3_pt, &b_b5_genbmm_dau3_pt);
   fChain->SetBranchAddress("b5_genbmm_dau3_reco_eta", b5_genbmm_dau3_reco_eta, &b_b5_genbmm_dau3_reco_eta);
   fChain->SetBranchAddress("b5_genbmm_dau3_reco_phi", b5_genbmm_dau3_reco_phi, &b_b5_genbmm_dau3_reco_phi);
   fChain->SetBranchAddress("b5_genbmm_dau3_reco_pt", b5_genbmm_dau3_reco_pt, &b_b5_genbmm_dau3_reco_pt);
   fChain->SetBranchAddress("b5_genbmm_dau4_eta", b5_genbmm_dau4_eta, &b_b5_genbmm_dau4_eta);
   fChain->SetBranchAddress("b5_genbmm_dau4_phi", b5_genbmm_dau4_phi, &b_b5_genbmm_dau4_phi);
   fChain->SetBranchAddress("b5_genbmm_dau4_pt", b5_genbmm_dau4_pt, &b_b5_genbmm_dau4_pt);
   fChain->SetBranchAddress("b5_genbmm_dau4_reco_eta", b5_genbmm_dau4_reco_eta, &b_b5_genbmm_dau4_reco_eta);
   fChain->SetBranchAddress("b5_genbmm_dau4_reco_phi", b5_genbmm_dau4_reco_phi, &b_b5_genbmm_dau4_reco_phi);
   fChain->SetBranchAddress("b5_genbmm_dau4_reco_pt", b5_genbmm_dau4_reco_pt, &b_b5_genbmm_dau4_reco_pt);
   fChain->SetBranchAddress("b5_genbmm_dimuon_mass", b5_genbmm_dimuon_mass, &b_b5_genbmm_dimuon_mass);
   fChain->SetBranchAddress("b5_genbmm_eta", b5_genbmm_eta, &b_b5_genbmm_eta);
   fChain->SetBranchAddress("b5_genbmm_mass", b5_genbmm_mass, &b_b5_genbmm_mass);
   fChain->SetBranchAddress("b5_genbmm_mu1_eta", b5_genbmm_mu1_eta, &b_b5_genbmm_mu1_eta);
   fChain->SetBranchAddress("b5_genbmm_mu1_phi", b5_genbmm_mu1_phi, &b_b5_genbmm_mu1_phi);
   fChain->SetBranchAddress("b5_genbmm_mu1_pt", b5_genbmm_mu1_pt, &b_b5_genbmm_mu1_pt);
   fChain->SetBranchAddress("b5_genbmm_mu2_eta", b5_genbmm_mu2_eta, &b_b5_genbmm_mu2_eta);
   fChain->SetBranchAddress("b5_genbmm_mu2_phi", b5_genbmm_mu2_phi, &b_b5_genbmm_mu2_phi);
   fChain->SetBranchAddress("b5_genbmm_mu2_pt", b5_genbmm_mu2_pt, &b_b5_genbmm_mu2_pt);
   fChain->SetBranchAddress("b5_genbmm_phi", b5_genbmm_phi, &b_b5_genbmm_phi);
   fChain->SetBranchAddress("b5_genbmm_pt", b5_genbmm_pt, &b_b5_genbmm_pt);
   fChain->SetBranchAddress("b5_genbmm_rad_eta", b5_genbmm_rad_eta, &b_b5_genbmm_rad_eta);
   fChain->SetBranchAddress("b5_genbmm_rad_p", b5_genbmm_rad_p, &b_b5_genbmm_rad_p);
   fChain->SetBranchAddress("b5_genbmm_rad_phi", b5_genbmm_rad_phi, &b_b5_genbmm_rad_phi);
   fChain->SetBranchAddress("b5_genbmm_rad_pt", b5_genbmm_rad_pt, &b_b5_genbmm_rad_pt);
   fChain->SetBranchAddress("b5_genbmm_dau3_pdgId", b5_genbmm_dau3_pdgId, &b_b5_genbmm_dau3_pdgId);
   fChain->SetBranchAddress("b5_genbmm_dau4_pdgId", b5_genbmm_dau4_pdgId, &b_b5_genbmm_dau4_pdgId);
   fChain->SetBranchAddress("b5_genbmm_mu1_good", b5_genbmm_mu1_good, &b_b5_genbmm_mu1_good);
   fChain->SetBranchAddress("b5_genbmm_mu1_index", b5_genbmm_mu1_index, &b_b5_genbmm_mu1_index);
   fChain->SetBranchAddress("b5_genbmm_mu1_pdgId", b5_genbmm_mu1_pdgId, &b_b5_genbmm_mu1_pdgId);
   fChain->SetBranchAddress("b5_genbmm_mu2_good", b5_genbmm_mu2_good, &b_b5_genbmm_mu2_good);
   fChain->SetBranchAddress("b5_genbmm_mu2_index", b5_genbmm_mu2_index, &b_b5_genbmm_mu2_index);
   fChain->SetBranchAddress("b5_genbmm_mu2_pdgId", b5_genbmm_mu2_pdgId, &b_b5_genbmm_mu2_pdgId);
   fChain->SetBranchAddress("b5_genbmm_pdgId", b5_genbmm_pdgId, &b_b5_genbmm_pdgId);
   fChain->SetBranchAddress("b5_genbmm_signature", b5_genbmm_signature, &b_b5_genbmm_signature);
   fChain->SetBranchAddress("b5_nd0", &b5_nd0, &b_b5_nd0);
   fChain->SetBranchAddress("b5_d0_doca", b5_d0_doca, &b_b5_d0_doca);
   fChain->SetBranchAddress("b5_d0_gen_kaon_pt", b5_d0_gen_kaon_pt, &b_b5_d0_gen_kaon_pt);
   fChain->SetBranchAddress("b5_d0_gen_mass", b5_d0_gen_mass, &b_b5_d0_gen_mass);
   fChain->SetBranchAddress("b5_d0_gen_pion_pt", b5_d0_gen_pion_pt, &b_b5_d0_gen_pion_pt);
   fChain->SetBranchAddress("b5_d0_gen_pt", b5_d0_gen_pt, &b_b5_d0_gen_pt);
   ...
   fChain->SetBranchAddress("b5_d0_gen_kaon_mpdgId", b5_d0_gen_kaon_mpdgId, &b_b5_d0_gen_kaon_mpdgId);
   fChain->SetBranchAddress("b5_d0_gen_kaon_pdgId", b5_d0_gen_kaon_pdgId, &b_b5_d0_gen_kaon_pdgId);
   fChain->SetBranchAddress("b5_d0_gen_pdgId", b5_d0_gen_pdgId, &b_b5_d0_gen_pdgId);
   fChain->SetBranchAddress("b5_d0_gen_pion_mpdgId", b5_d0_gen_pion_mpdgId, &b_b5_d0_gen_pion_mpdgId);
   fChain->SetBranchAddress("b5_d0_gen_pion_pdgId", b5_d0_gen_pion_pdgId, &b_b5_d0_gen_pion_pdgId);
   ...
   fChain->SetBranchAddress("b5_HTXS_Higgs_pt", &b5_HTXS_Higgs_pt, &b_b5_HTXS_Higgs_pt);
   fChain->SetBranchAddress("b5_HTXS_Higgs_y", &b5_HTXS_Higgs_y, &b_b5_HTXS_Higgs_y);
   fChain->SetBranchAddress("b5_HTXS_stage1_1_cat_pTjet25GeV", &b5_HTXS_stage1_1_cat_pTjet25GeV, &b_b5_HTXS_stage1_1_cat_pTjet25GeV);
   fChain->SetBranchAddress("b5_HTXS_stage1_1_cat_pTjet30GeV", &b5_HTXS_stage1_1_cat_pTjet30GeV, &b_b5_HTXS_stage1_1_cat_pTjet30GeV);
   fChain->SetBranchAddress("b5_HTXS_stage1_1_fine_cat_pTjet25GeV", &b5_HTXS_stage1_1_fine_cat_pTjet25GeV, &b_b5_HTXS_stage1_1_fine_cat_pTjet25GeV);
   fChain->SetBranchAddress("b5_HTXS_stage1_1_fine_cat_pTjet30GeV", &b5_HTXS_stage1_1_fine_cat_pTjet30GeV, &b_b5_HTXS_stage1_1_fine_cat_pTjet30GeV);
   fChain->SetBranchAddress("b5_HTXS_stage1_2_cat_pTjet25GeV", &b5_HTXS_stage1_2_cat_pTjet25GeV, &b_b5_HTXS_stage1_2_cat_pTjet25GeV);
   fChain->SetBranchAddress("b5_HTXS_stage1_2_cat_pTjet30GeV", &b5_HTXS_stage1_2_cat_pTjet30GeV, &b_b5_HTXS_stage1_2_cat_pTjet30GeV);
   fChain->SetBranchAddress("b5_HTXS_stage1_2_fine_cat_pTjet25GeV", &b5_HTXS_stage1_2_fine_cat_pTjet25GeV, &b_b5_HTXS_stage1_2_fine_cat_pTjet25GeV);
   fChain->SetBranchAddress("b5_HTXS_stage1_2_fine_cat_pTjet30GeV", &b5_HTXS_stage1_2_fine_cat_pTjet30GeV, &b_b5_HTXS_stage1_2_fine_cat_pTjet30GeV);
   fChain->SetBranchAddress("b5_HTXS_stage_0", &b5_HTXS_stage_0, &b_b5_HTXS_stage_0);
   fChain->SetBranchAddress("b5_HTXS_stage_1_pTjet25", &b5_HTXS_stage_1_pTjet25, &b_b5_HTXS_stage_1_pTjet25);
   fChain->SetBranchAddress("b5_HTXS_stage_1_pTjet30", &b5_HTXS_stage_1_pTjet30, &b_b5_HTXS_stage_1_pTjet30);
   fChain->SetBranchAddress("b5_HTXS_njets25", &b5_HTXS_njets25, &b_b5_HTXS_njets25);
   fChain->SetBranchAddress("b5_HTXS_njets30", &b5_HTXS_njets30, &b_b5_HTXS_njets30);
   fChain->SetBranchAddress("b5_nks", &b5_nks, &b_b5_nks);
   fChain->SetBranchAddress("b5_ks_doca", b5_ks_doca, &b_b5_ks_doca);
   fChain->SetBranchAddress("b5_ks_gen_mass", b5_ks_gen_mass, &b_b5_ks_gen_mass);
   fChain->SetBranchAddress("b5_ks_gen_pt", b5_ks_gen_pt, &b_b5_ks_gen_pt);
   fChain->SetBranchAddress("b5_ks_gen_trk1_pt", b5_ks_gen_trk1_pt, &b_b5_ks_gen_trk1_pt);
   fChain->SetBranchAddress("b5_ks_gen_trk2_pt", b5_ks_gen_trk2_pt, &b_b5_ks_gen_trk2_pt);
   ...
   fChain->SetBranchAddress("b5_ks_gen_pdgId", b5_ks_gen_pdgId, &b_b5_ks_gen_pdgId);
   fChain->SetBranchAddress("b5_ks_gen_trk1_mpdgId", b5_ks_gen_trk1_mpdgId, &b_b5_ks_gen_trk1_mpdgId);
   fChain->SetBranchAddress("b5_ks_gen_trk1_pdgId", b5_ks_gen_trk1_pdgId, &b_b5_ks_gen_trk1_pdgId);
   fChain->SetBranchAddress("b5_ks_gen_trk2_mpdgId", b5_ks_gen_trk2_mpdgId, &b_b5_ks_gen_trk2_mpdgId);
   fChain->SetBranchAddress("b5_ks_gen_trk2_pdgId", b5_ks_gen_trk2_pdgId, &b_b5_ks_gen_trk2_pdgId);
   ...
   fChain->SetBranchAddress("b5_lambda_gen_mass", b5_lambda_gen_mass, &b_b5_lambda_gen_mass);
   fChain->SetBranchAddress("b5_lambda_gen_pion_pt", b5_lambda_gen_pion_pt, &b_b5_lambda_gen_pion_pt);
   fChain->SetBranchAddress("b5_lambda_gen_proton_pt", b5_lambda_gen_proton_pt, &b_b5_lambda_gen_proton_pt);
   fChain->SetBranchAddress("b5_lambda_gen_pt", b5_lambda_gen_pt, &b_b5_lambda_gen_pt);
   ...
   fChain->SetBranchAddress("b5_lambda_gen_pdgId", b5_lambda_gen_pdgId, &b_b5_lambda_gen_pdgId);
   fChain->SetBranchAddress("b5_lambda_gen_pion_mpdgId", b5_lambda_gen_pion_mpdgId, &b_b5_lambda_gen_pion_mpdgId);
   fChain->SetBranchAddress("b5_lambda_gen_pion_pdgId", b5_lambda_gen_pion_pdgId, &b_b5_lambda_gen_pion_pdgId);
   fChain->SetBranchAddress("b5_lambda_gen_proton_mpdgId", b5_lambda_gen_proton_mpdgId, &b_b5_lambda_gen_proton_mpdgId);
   fChain->SetBranchAddress("b5_lambda_gen_proton_pdgId", b5_lambda_gen_proton_pdgId, &b_b5_lambda_gen_proton_pdgId);
   ...
   fChain->SetBranchAddress("b5_phi_gen_mass", b5_phi_gen_mass, &b_b5_phi_gen_mass);
   fChain->SetBranchAddress("b5_phi_gen_pt", b5_phi_gen_pt, &b_b5_phi_gen_pt);
   fChain->SetBranchAddress("b5_phi_gen_trk1_pt", b5_phi_gen_trk1_pt, &b_b5_phi_gen_trk1_pt);
   fChain->SetBranchAddress("b5_phi_gen_trk2_pt", b5_phi_gen_trk2_pt, &b_b5_phi_gen_trk2_pt);
   ...
   fChain->SetBranchAddress("b5_phi_gen_pdgId", b5_phi_gen_pdgId, &b_b5_phi_gen_pdgId);
   fChain->SetBranchAddress("b5_phi_gen_trk1_mpdgId", b5_phi_gen_trk1_mpdgId, &b_b5_phi_gen_trk1_mpdgId);
   fChain->SetBranchAddress("b5_phi_gen_trk1_pdgId", b5_phi_gen_trk1_pdgId, &b_b5_phi_gen_trk1_pdgId);
   fChain->SetBranchAddress("b5_phi_gen_trk2_mpdgId", b5_phi_gen_trk2_mpdgId, &b_b5_phi_gen_trk2_mpdgId);
   fChain->SetBranchAddress("b5_phi_gen_trk2_pdgId", b5_phi_gen_trk2_pdgId, &b_b5_phi_gen_trk2_pdgId);
   ...
   fChain->SetBranchAddress("b5_btagWeight_CSVV2", &b5_btagWeight_CSVV2, &b_b5_btagWeight_CSVV2);
   fChain->SetBranchAddress("b5_btagWeight_DeepCSVB", &b5_btagWeight_DeepCSVB, &b_b5_btagWeight_DeepCSVB);
   ...
   fChain->SetBranchAddress("b5_nGenJetAK8", &b5_nGenJetAK8, &b_b5_nGenJetAK8);
   fChain->SetBranchAddress("b5_GenJetAK8_eta", b5_GenJetAK8_eta, &b_b5_GenJetAK8_eta);
   fChain->SetBranchAddress("b5_GenJetAK8_mass", b5_GenJetAK8_mass, &b_b5_GenJetAK8_mass);
   fChain->SetBranchAddress("b5_GenJetAK8_phi", b5_GenJetAK8_phi, &b_b5_GenJetAK8_phi);
   fChain->SetBranchAddress("b5_GenJetAK8_pt", b5_GenJetAK8_pt, &b_b5_GenJetAK8_pt);
   fChain->SetBranchAddress("b5_nGenJet", &b5_nGenJet, &b_b5_nGenJet);
   fChain->SetBranchAddress("b5_GenJet_eta", b5_GenJet_eta, &b_b5_GenJet_eta);
   fChain->SetBranchAddress("b5_GenJet_mass", b5_GenJet_mass, &b_b5_GenJet_mass);
   fChain->SetBranchAddress("b5_GenJet_phi", b5_GenJet_phi, &b_b5_GenJet_phi);
   fChain->SetBranchAddress("b5_GenJet_pt", b5_GenJet_pt, &b_b5_GenJet_pt);
   fChain->SetBranchAddress("b5_nGenPart", &b5_nGenPart, &b_b5_nGenPart);
   fChain->SetBranchAddress("b5_GenPart_eta", b5_GenPart_eta, &b_b5_GenPart_eta);
   fChain->SetBranchAddress("b5_GenPart_mass", b5_GenPart_mass, &b_b5_GenPart_mass);
   fChain->SetBranchAddress("b5_GenPart_phi", b5_GenPart_phi, &b_b5_GenPart_phi);
   fChain->SetBranchAddress("b5_GenPart_pt", b5_GenPart_pt, &b_b5_GenPart_pt);
   fChain->SetBranchAddress("b5_GenPart_genPartIdxMother", b5_GenPart_genPartIdxMother, &b_b5_GenPart_genPartIdxMother);
   fChain->SetBranchAddress("b5_GenPart_pdgId", b5_GenPart_pdgId, &b_b5_GenPart_pdgId);
   fChain->SetBranchAddress("b5_GenPart_status", b5_GenPart_status, &b_b5_GenPart_status);
   fChain->SetBranchAddress("b5_GenPart_statusFlags", b5_GenPart_statusFlags, &b_b5_GenPart_statusFlags);
   fChain->SetBranchAddress("b5_nSubGenJetAK8", &b5_nSubGenJetAK8, &b_b5_nSubGenJetAK8);
   fChain->SetBranchAddress("b5_SubGenJetAK8_eta", b5_SubGenJetAK8_eta, &b_b5_SubGenJetAK8_eta);
   fChain->SetBranchAddress("b5_SubGenJetAK8_mass", b5_SubGenJetAK8_mass, &b_b5_SubGenJetAK8_mass);
   fChain->SetBranchAddress("b5_SubGenJetAK8_phi", b5_SubGenJetAK8_phi, &b_b5_SubGenJetAK8_phi);
   fChain->SetBranchAddress("b5_SubGenJetAK8_pt", b5_SubGenJetAK8_pt, &b_b5_SubGenJetAK8_pt);
   fChain->SetBranchAddress("b5_Generator_binvar", &b5_Generator_binvar, &b_b5_Generator_binvar);
   fChain->SetBranchAddress("b5_Generator_scalePDF", &b5_Generator_scalePDF, &b_b5_Generator_scalePDF);
   fChain->SetBranchAddress("b5_Generator_weight", &b5_Generator_weight, &b_b5_Generator_weight);
   fChain->SetBranchAddress("b5_Generator_x1", &b5_Generator_x1, &b_b5_Generator_x1);
   fChain->SetBranchAddress("b5_Generator_x2", &b5_Generator_x2, &b_b5_Generator_x2);
   fChain->SetBranchAddress("b5_Generator_xpdf1", &b5_Generator_xpdf1, &b_b5_Generator_xpdf1);
   fChain->SetBranchAddress("b5_Generator_xpdf2", &b5_Generator_xpdf2, &b_b5_Generator_xpdf2);
   fChain->SetBranchAddress("b5_Generator_id1", &b5_Generator_id1, &b_b5_Generator_id1);
   fChain->SetBranchAddress("b5_Generator_id2", &b5_Generator_id2, &b_b5_Generator_id2);
   fChain->SetBranchAddress("b5_GenVtx_x", &b5_GenVtx_x, &b_b5_GenVtx_x);
   fChain->SetBranchAddress("b5_GenVtx_y", &b5_GenVtx_y, &b_b5_GenVtx_y);
   fChain->SetBranchAddress("b5_GenVtx_z", &b5_GenVtx_z, &b_b5_GenVtx_z);
   fChain->SetBranchAddress("b5_nGenVisTau", &b5_nGenVisTau, &b_b5_nGenVisTau);
   fChain->SetBranchAddress("b5_GenVisTau_eta", b5_GenVisTau_eta, &b_b5_GenVisTau_eta);
   fChain->SetBranchAddress("b5_GenVisTau_mass", b5_GenVisTau_mass, &b_b5_GenVisTau_mass);
   fChain->SetBranchAddress("b5_GenVisTau_phi", b5_GenVisTau_phi, &b_b5_GenVisTau_phi);
   fChain->SetBranchAddress("b5_GenVisTau_pt", b5_GenVisTau_pt, &b_b5_GenVisTau_pt);
   fChain->SetBranchAddress("b5_GenVisTau_charge", b5_GenVisTau_charge, &b_b5_GenVisTau_charge);
   fChain->SetBranchAddress("b5_GenVisTau_genPartIdxMother", b5_GenVisTau_genPartIdxMother, &b_b5_GenVisTau_genPartIdxMother);
   fChain->SetBranchAddress("b5_GenVisTau_status", b5_GenVisTau_status, &b_b5_GenVisTau_status);
   fChain->SetBranchAddress("b5_genWeight", &b5_genWeight, &b_b5_genWeight);
   fChain->SetBranchAddress("b5_nPSWeight", &b5_nPSWeight, &b_b5_nPSWeight);
   fChain->SetBranchAddress("b5_PSWeight", b5_PSWeight, &b_b5_PSWeight);
   ...
   fChain->SetBranchAddress("b5_GenMET_phi", &b5_GenMET_phi, &b_b5_GenMET_phi);
   fChain->SetBranchAddress("b5_GenMET_pt", &b5_GenMET_pt, &b_b5_GenMET_pt);
   ...
   fChain->SetBranchAddress("b5_prescale_HLT_DoubleMu4_3_Bs", &b5_prescale_HLT_DoubleMu4_3_Bs, &b_b5_prescale_HLT_DoubleMu4_3_Bs);
   fChain->SetBranchAddress("b5_prescale_HLT_DoubleMu4_3_Jpsi", &b5_prescale_HLT_DoubleMu4_3_Jpsi, &b_b5_prescale_HLT_DoubleMu4_3_Jpsi);
   fChain->SetBranchAddress("b5_prescale_HLT_DoubleMu4_Jpsi_Displaced", &b5_prescale_HLT_DoubleMu4_Jpsi_Displaced, &b_b5_prescale_HLT_DoubleMu4_Jpsi_Displaced);
   fChain->SetBranchAddress("b5_prescale_HLT_DoubleMu4_Jpsi_NoVertexing", &b5_prescale_HLT_DoubleMu4_Jpsi_NoVertexing, &b_b5_prescale_HLT_DoubleMu4_Jpsi_NoVertexing);
   fChain->SetBranchAddress("b5_prescale_HLT_DoubleMu4_3_Jpsi_Displaced", &b5_prescale_HLT_DoubleMu4_3_Jpsi_Displaced, &b_b5_prescale_HLT_DoubleMu4_3_Jpsi_Displaced);
   fChain->SetBranchAddress("b5_Pileup_nTrueInt", &b5_Pileup_nTrueInt, &b_b5_Pileup_nTrueInt);
   fChain->SetBranchAddress("b5_Pileup_pudensity", &b5_Pileup_pudensity, &b_b5_Pileup_pudensity);
   fChain->SetBranchAddress("b5_Pileup_gpudensity", &b5_Pileup_gpudensity, &b_b5_Pileup_gpudensity);
   fChain->SetBranchAddress("b5_Pileup_nPU", &b5_Pileup_nPU, &b_b5_Pileup_nPU);
   fChain->SetBranchAddress("b5_Pileup_sumEOOT", &b5_Pileup_sumEOOT, &b_b5_Pileup_sumEOOT);
   fChain->SetBranchAddress("b5_Pileup_sumLOOT", &b5_Pileup_sumLOOT, &b_b5_Pileup_sumLOOT);
   ...
   fChain->SetBranchAddress("b5_nGenDressedLepton", &b5_nGenDressedLepton, &b_b5_nGenDressedLepton);
   fChain->SetBranchAddress("b5_GenDressedLepton_eta", &b5_GenDressedLepton_eta, &b_b5_GenDressedLepton_eta);
   fChain->SetBranchAddress("b5_GenDressedLepton_mass", &b5_GenDressedLepton_mass, &b_b5_GenDressedLepton_mass);
   fChain->SetBranchAddress("b5_GenDressedLepton_phi", &b5_GenDressedLepton_phi, &b_b5_GenDressedLepton_phi);
   fChain->SetBranchAddress("b5_GenDressedLepton_pt", &b5_GenDressedLepton_pt, &b_b5_GenDressedLepton_pt);
   fChain->SetBranchAddress("b5_GenDressedLepton_pdgId", &b5_GenDressedLepton_pdgId, &b_b5_GenDressedLepton_pdgId);
   fChain->SetBranchAddress("b5_GenDressedLepton_hasTauAnc", &b5_GenDressedLepton_hasTauAnc, &b_b5_GenDressedLepton_hasTauAnc);
   fChain->SetBranchAddress("b5_nGenIsolatedPhoton", &b5_nGenIsolatedPhoton, &b_b5_nGenIsolatedPhoton);
   fChain->SetBranchAddress("b5_GenIsolatedPhoton_eta", b5_GenIsolatedPhoton_eta, &b_b5_GenIsolatedPhoton_eta);
   fChain->SetBranchAddress("b5_GenIsolatedPhoton_mass", b5_GenIsolatedPhoton_mass, &b_b5_GenIsolatedPhoton_mass);
   fChain->SetBranchAddress("b5_GenIsolatedPhoton_phi", b5_GenIsolatedPhoton_phi, &b_b5_GenIsolatedPhoton_phi);
   fChain->SetBranchAddress("b5_GenIsolatedPhoton_pt", b5_GenIsolatedPhoton_pt, &b_b5_GenIsolatedPhoton_pt);
   ...
   fChain->SetBranchAddress("b5_genTtbarId", &b5_genTtbarId, &b_b5_genTtbarId);
   ...
   fChain->SetBranchAddress("b5_Electron_genPartIdx", b5_Electron_genPartIdx, &b_b5_Electron_genPartIdx);
   fChain->SetBranchAddress("b5_Electron_genPartFlav", b5_Electron_genPartFlav, &b_b5_Electron_genPartFlav);
   fChain->SetBranchAddress("b5_FatJet_genJetAK8Idx", b5_FatJet_genJetAK8Idx, &b_b5_FatJet_genJetAK8Idx);
   fChain->SetBranchAddress("b5_FatJet_hadronFlavour", b5_FatJet_hadronFlavour, &b_b5_FatJet_hadronFlavour);
   fChain->SetBranchAddress("b5_FatJet_nBHadrons", b5_FatJet_nBHadrons, &b_b5_FatJet_nBHadrons);
   fChain->SetBranchAddress("b5_FatJet_nCHadrons", b5_FatJet_nCHadrons, &b_b5_FatJet_nCHadrons);
   fChain->SetBranchAddress("b5_GenJetAK8_partonFlavour", b5_GenJetAK8_partonFlavour, &b_b5_GenJetAK8_partonFlavour);
   fChain->SetBranchAddress("b5_GenJetAK8_hadronFlavour", b5_GenJetAK8_hadronFlavour, &b_b5_GenJetAK8_hadronFlavour);
   fChain->SetBranchAddress("b5_GenJet_partonFlavour", b5_GenJet_partonFlavour, &b_b5_GenJet_partonFlavour);
   fChain->SetBranchAddress("b5_GenJet_hadronFlavour", b5_GenJet_hadronFlavour, &b_b5_GenJet_hadronFlavour);
   fChain->SetBranchAddress("b5_GenVtx_t0", &b5_GenVtx_t0, &b_b5_GenVtx_t0);
   fChain->SetBranchAddress("b5_Jet_genJetIdx", b5_Jet_genJetIdx, &b_b5_Jet_genJetIdx);
   fChain->SetBranchAddress("b5_Jet_hadronFlavour", b5_Jet_hadronFlavour, &b_b5_Jet_hadronFlavour);
   fChain->SetBranchAddress("b5_Jet_partonFlavour", b5_Jet_partonFlavour, &b_b5_Jet_partonFlavour);
   fChain->SetBranchAddress("b5_Muon_genPartIdx", b5_Muon_genPartIdx, &b_b5_Muon_genPartIdx);
   fChain->SetBranchAddress("b5_Muon_genPartFlav", b5_Muon_genPartFlav, &b_b5_Muon_genPartFlav);
   fChain->SetBranchAddress("b5_Photon_genPartIdx", b5_Photon_genPartIdx, &b_b5_Photon_genPartIdx);
   fChain->SetBranchAddress("b5_Photon_genPartFlav", b5_Photon_genPartFlav, &b_b5_Photon_genPartFlav);
   fChain->SetBranchAddress("b5_MET_fiducialGenPhi", &b5_MET_fiducialGenPhi, &b_b5_MET_fiducialGenPhi);
   fChain->SetBranchAddress("b5_MET_fiducialGenPt", &b5_MET_fiducialGenPt, &b_b5_MET_fiducialGenPt);
   ...
   fChain->SetBranchAddress("b5_SubJet_hadronFlavour", b5_SubJet_hadronFlavour, &b_b5_SubJet_hadronFlavour);
   fChain->SetBranchAddress("b5_SubJet_nBHadrons", b5_SubJet_nBHadrons, &b_b5_SubJet_nBHadrons);
   fChain->SetBranchAddress("b5_SubJet_nCHadrons", b5_SubJet_nCHadrons, &b_b5_SubJet_nCHadrons);
   ...
   fChain->SetBranchAddress("b5_Tau_genPartIdx", b5_Tau_genPartIdx, &b_b5_Tau_genPartIdx);
   fChain->SetBranchAddress("b5_Tau_genPartFlav", b5_Tau_genPartFlav, &b_b5_Tau_genPartFlav);
   ...
   fChain->SetBranchAddress("b5_HLT_Mu3_L1SingleMu5orSingleMu7", &b5_HLT_Mu3_L1SingleMu5orSingleMu7, &b_b5_HLT_Mu3_L1SingleMu5orSingleMu7);
   ...
   fChain->SetBranchAddress("b5_HLT_Ele28_WPTight_Gsf", &b5_HLT_Ele28_WPTight_Gsf, &b_b5_HLT_Ele28_WPTight_Gsf);
   fChain->SetBranchAddress("b5_HLT_Ele30_WPTight_Gsf", &b5_HLT_Ele30_WPTight_Gsf, &b_b5_HLT_Ele30_WPTight_Gsf);
   ...
   fChain->SetBranchAddress("b5_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_CrossL1", &b5_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_CrossL1, &b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_CrossL1);
   fChain->SetBranchAddress("b5_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_CrossL1", &b5_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_CrossL1, &b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_CrossL1);
   fChain->SetBranchAddress("b5_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_CrossL1", &b5_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_CrossL1, &b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_CrossL1);
   fChain->SetBranchAddress("b5_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1", &b5_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1, &b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1);
   fChain->SetBranchAddress("b5_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1", &b5_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1, &b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1);
   fChain->SetBranchAddress("b5_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1", &b5_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1, &b_b5_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1);
   ...
   fChain->SetBranchAddress("b5_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_CrossL1", &b5_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_CrossL1, &b_b5_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_CrossL1);
   fChain->SetBranchAddress("b5_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_CrossL1", &b5_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_CrossL1, &b_b5_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_CrossL1);
   fChain->SetBranchAddress("b5_HLT_IsoMu20_eta2p1_LooseChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1", &b5_HLT_IsoMu20_eta2p1_LooseChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1, &b_b5_HLT_IsoMu20_eta2p1_LooseChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1);
   fChain->SetBranchAddress("b5_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1", &b5_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1, &b_b5_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1);
   fChain->SetBranchAddress("b5_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1", &b5_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1, &b_b5_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1);
   fChain->SetBranchAddress("b5_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1", &b5_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1, &b_b5_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1);
   fChain->SetBranchAddress("b5_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1", &b5_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1, &b_b5_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1);
   fChain->SetBranchAddress("b5_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1", &b5_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1, &b_b5_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1);
   ...
   fChain->SetBranchAddress("b5_HLT_IsoMu27_LooseChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1", &b5_HLT_IsoMu27_LooseChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1, &b_b5_HLT_IsoMu27_LooseChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1);
   fChain->SetBranchAddress("b5_HLT_IsoMu27_MediumChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1", &b5_HLT_IsoMu27_MediumChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1, &b_b5_HLT_IsoMu27_MediumChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1);
   fChain->SetBranchAddress("b5_HLT_IsoMu27_TightChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1", &b5_HLT_IsoMu27_TightChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1, &b_b5_HLT_IsoMu27_TightChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1);
   ...
   fChain->SetBranchAddress("b5_HLT_DoubleL2Mu23NoVtx_2Cha_CosmicSeed_NoL2Matched", &b5_HLT_DoubleL2Mu23NoVtx_2Cha_CosmicSeed_NoL2Matched, &b_b5_HLT_DoubleL2Mu23NoVtx_2Cha_CosmicSeed_NoL2Matched);
   ...
   fChain->SetBranchAddress("b5_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_NoL2Matched", &b5_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_NoL2Matched, &b_b5_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_NoL2Matched);
   ...
   fChain->SetBranchAddress("b5_HLT_DoubleL2Mu23NoVtx_2Cha_NoL2Matched", &b5_HLT_DoubleL2Mu23NoVtx_2Cha_NoL2Matched, &b_b5_HLT_DoubleL2Mu23NoVtx_2Cha_NoL2Matched);
   fChain->SetBranchAddress("b5_HLT_DoubleL2Mu25NoVtx_2Cha", &b5_HLT_DoubleL2Mu25NoVtx_2Cha, &b_b5_HLT_DoubleL2Mu25NoVtx_2Cha);
   fChain->SetBranchAddress("b5_HLT_DoubleL2Mu25NoVtx_2Cha_NoL2Matched", &b5_HLT_DoubleL2Mu25NoVtx_2Cha_NoL2Matched, &b_b5_HLT_DoubleL2Mu25NoVtx_2Cha_NoL2Matched);
   ...
   fChain->SetBranchAddress("b5_HLT_Mu30_TkMu0_Psi", &b5_HLT_Mu30_TkMu0_Psi, &b_b5_HLT_Mu30_TkMu0_Psi);
   fChain->SetBranchAddress("b5_HLT_Mu30_TkMu0_Upsilon", &b5_HLT_Mu30_TkMu0_Upsilon, &b_b5_HLT_Mu30_TkMu0_Upsilon);
   ...
   fChain->SetBranchAddress("b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30", &b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30, &b_b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30);
   fChain->SetBranchAddress("b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30", &b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30, &b_b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30);
   fChain->SetBranchAddress("b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30_PFBtagDeepCSV_1p5", &b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30_PFBtagDeepCSV_1p5, &b_b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30_PFBtagDeepCSV_1p5);
   fChain->SetBranchAddress("b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30_CaloBtagDeepCSV_1p5", &b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30_CaloBtagDeepCSV_1p5, &b_b5_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30_CaloBtagDeepCSV_1p5);
   ...
   fChain->SetBranchAddress("b5_HLT_BTagMu_AK4DiJet20_Mu5_noalgo", &b5_HLT_BTagMu_AK4DiJet20_Mu5_noalgo, &b_b5_HLT_BTagMu_AK4DiJet20_Mu5_noalgo);
   fChain->SetBranchAddress("b5_HLT_BTagMu_AK4DiJet40_Mu5_noalgo", &b5_HLT_BTagMu_AK4DiJet40_Mu5_noalgo, &b_b5_HLT_BTagMu_AK4DiJet40_Mu5_noalgo);
   fChain->SetBranchAddress("b5_HLT_BTagMu_AK4DiJet70_Mu5_noalgo", &b5_HLT_BTagMu_AK4DiJet70_Mu5_noalgo, &b_b5_HLT_BTagMu_AK4DiJet70_Mu5_noalgo);
   fChain->SetBranchAddress("b5_HLT_BTagMu_AK4DiJet110_Mu5_noalgo", &b5_HLT_BTagMu_AK4DiJet110_Mu5_noalgo, &b_b5_HLT_BTagMu_AK4DiJet110_Mu5_noalgo);
   fChain->SetBranchAddress("b5_HLT_BTagMu_AK4DiJet170_Mu5_noalgo", &b5_HLT_BTagMu_AK4DiJet170_Mu5_noalgo, &b_b5_HLT_BTagMu_AK4DiJet170_Mu5_noalgo);
   fChain->SetBranchAddress("b5_HLT_BTagMu_AK4Jet300_Mu5_noalgo", &b5_HLT_BTagMu_AK4Jet300_Mu5_noalgo, &b_b5_HLT_BTagMu_AK4Jet300_Mu5_noalgo);
   fChain->SetBranchAddress("b5_HLT_BTagMu_AK8DiJet170_Mu5_noalgo", &b5_HLT_BTagMu_AK8DiJet170_Mu5_noalgo, &b_b5_HLT_BTagMu_AK8DiJet170_Mu5_noalgo);
   fChain->SetBranchAddress("b5_HLT_BTagMu_AK8Jet170_DoubleMu5_noalgo", &b5_HLT_BTagMu_AK8Jet170_DoubleMu5_noalgo, &b_b5_HLT_BTagMu_AK8Jet170_DoubleMu5_noalgo);
   fChain->SetBranchAddress("b5_HLT_BTagMu_AK8Jet300_Mu5_noalgo", &b5_HLT_BTagMu_AK8Jet300_Mu5_noalgo, &b_b5_HLT_BTagMu_AK8Jet300_Mu5_noalgo);
   ...
   fChain->SetBranchAddress("b5_HLT_Photon90_CaloIdL_PFHT700", &b5_HLT_Photon90_CaloIdL_PFHT700, &b_b5_HLT_Photon90_CaloIdL_PFHT700);
   ...
   fChain->SetBranchAddress("b5_HLT_Photon35_TwoProngs35", &b5_HLT_Photon35_TwoProngs35, &b_b5_HLT_Photon35_TwoProngs35);
   fChain->SetBranchAddress("b5_HLT_IsoMu24_TwoProngs35", &b5_HLT_IsoMu24_TwoProngs35, &b_b5_HLT_IsoMu24_TwoProngs35);
   ...
   fChain->SetBranchAddress("b5_HLT_PFHT400_SixPFJet32_DoublePFBTagDeepCSV_2p94", &b5_HLT_PFHT400_SixPFJet32_DoublePFBTagDeepCSV_2p94, &b_b5_HLT_PFHT400_SixPFJet32_DoublePFBTagDeepCSV_2p94);
   fChain->SetBranchAddress("b5_HLT_PFHT400_SixPFJet32", &b5_HLT_PFHT400_SixPFJet32, &b_b5_HLT_PFHT400_SixPFJet32);
   fChain->SetBranchAddress("b5_HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59", &b5_HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59, &b_b5_HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59);
   fChain->SetBranchAddress("b5_HLT_PFHT450_SixPFJet36", &b5_HLT_PFHT450_SixPFJet36, &b_b5_HLT_PFHT450_SixPFJet36);
   ...
   fChain->SetBranchAddress("b5_HLT_ZeroBias_Alignment", &b5_HLT_ZeroBias_Alignment, &b_b5_HLT_ZeroBias_Alignment);
   ...
   fChain->SetBranchAddress("b5_HLT_CDC_L2cosmic_5_er1p0", &b5_HLT_CDC_L2cosmic_5_er1p0, &b_b5_HLT_CDC_L2cosmic_5_er1p0);
   fChain->SetBranchAddress("b5_HLT_CDC_L2cosmic_5p5_er1p0", &b5_HLT_CDC_L2cosmic_5p5_er1p0, &b_b5_HLT_CDC_L2cosmic_5p5_er1p0);
   ...
   fChain->SetBranchAddress("b5_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg", &b5_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg, &b_b5_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg);
   fChain->SetBranchAddress("b5_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg", &b5_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg, &b_b5_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg);
   ...
   fChain->SetBranchAddress("b5_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg", &b5_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg, &b_b5_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg);
   fChain->SetBranchAddress("b5_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_eta2p1_Reg", &b5_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_eta2p1_Reg, &b_b5_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_eta2p1_Reg);
   fChain->SetBranchAddress("b5_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_eta2p1_Reg", &b5_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_eta2p1_Reg, &b_b5_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_eta2p1_Reg);
   fChain->SetBranchAddress("b5_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg", &b5_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg, &b_b5_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg);
   fChain->SetBranchAddress("b5_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg", &b5_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg, &b_b5_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg);
   fChain->SetBranchAddress("b5_HLT_VBF_DoubleLooseChargedIsoPFTauHPS20_Trk1_eta2p1", &b5_HLT_VBF_DoubleLooseChargedIsoPFTauHPS20_Trk1_eta2p1, &b_b5_HLT_VBF_DoubleLooseChargedIsoPFTauHPS20_Trk1_eta2p1);
   fChain->SetBranchAddress("b5_HLT_VBF_DoubleMediumChargedIsoPFTauHPS20_Trk1_eta2p1", &b5_HLT_VBF_DoubleMediumChargedIsoPFTauHPS20_Trk1_eta2p1, &b_b5_HLT_VBF_DoubleMediumChargedIsoPFTauHPS20_Trk1_eta2p1);
   fChain->SetBranchAddress("b5_HLT_VBF_DoubleTightChargedIsoPFTauHPS20_Trk1_eta2p1", &b5_HLT_VBF_DoubleTightChargedIsoPFTauHPS20_Trk1_eta2p1, &b_b5_HLT_VBF_DoubleTightChargedIsoPFTauHPS20_Trk1_eta2p1);
   ...
   fChain->SetBranchAddress("b5_HLT_Mu12_IP6_part0", &b5_HLT_Mu12_IP6_part0, &b_b5_HLT_Mu12_IP6_part0);
   fChain->SetBranchAddress("b5_HLT_Mu12_IP6_part1", &b5_HLT_Mu12_IP6_part1, &b_b5_HLT_Mu12_IP6_part1);
   fChain->SetBranchAddress("b5_HLT_Mu12_IP6_part2", &b5_HLT_Mu12_IP6_part2, &b_b5_HLT_Mu12_IP6_part2);
   fChain->SetBranchAddress("b5_HLT_Mu12_IP6_part3", &b5_HLT_Mu12_IP6_part3, &b_b5_HLT_Mu12_IP6_part3);
   fChain->SetBranchAddress("b5_HLT_Mu12_IP6_part4", &b5_HLT_Mu12_IP6_part4, &b_b5_HLT_Mu12_IP6_part4);
   fChain->SetBranchAddress("b5_HLT_Mu9_IP5_part0", &b5_HLT_Mu9_IP5_part0, &b_b5_HLT_Mu9_IP5_part0);
   fChain->SetBranchAddress("b5_HLT_Mu9_IP5_part1", &b5_HLT_Mu9_IP5_part1, &b_b5_HLT_Mu9_IP5_part1);
   fChain->SetBranchAddress("b5_HLT_Mu9_IP5_part2", &b5_HLT_Mu9_IP5_part2, &b_b5_HLT_Mu9_IP5_part2);
   fChain->SetBranchAddress("b5_HLT_Mu9_IP5_part3", &b5_HLT_Mu9_IP5_part3, &b_b5_HLT_Mu9_IP5_part3);
   fChain->SetBranchAddress("b5_HLT_Mu9_IP5_part4", &b5_HLT_Mu9_IP5_part4, &b_b5_HLT_Mu9_IP5_part4);
   fChain->SetBranchAddress("b5_HLT_Mu7_IP4_part0", &b5_HLT_Mu7_IP4_part0, &b_b5_HLT_Mu7_IP4_part0);
   fChain->SetBranchAddress("b5_HLT_Mu7_IP4_part1", &b5_HLT_Mu7_IP4_part1, &b_b5_HLT_Mu7_IP4_part1);
   fChain->SetBranchAddress("b5_HLT_Mu7_IP4_part2", &b5_HLT_Mu7_IP4_part2, &b_b5_HLT_Mu7_IP4_part2);
   fChain->SetBranchAddress("b5_HLT_Mu7_IP4_part3", &b5_HLT_Mu7_IP4_part3, &b_b5_HLT_Mu7_IP4_part3);
   fChain->SetBranchAddress("b5_HLT_Mu7_IP4_part4", &b5_HLT_Mu7_IP4_part4, &b_b5_HLT_Mu7_IP4_part4);
   fChain->SetBranchAddress("b5_HLT_Mu9_IP4_part0", &b5_HLT_Mu9_IP4_part0, &b_b5_HLT_Mu9_IP4_part0);
   fChain->SetBranchAddress("b5_HLT_Mu9_IP4_part1", &b5_HLT_Mu9_IP4_part1, &b_b5_HLT_Mu9_IP4_part1);
   fChain->SetBranchAddress("b5_HLT_Mu9_IP4_part2", &b5_HLT_Mu9_IP4_part2, &b_b5_HLT_Mu9_IP4_part2);
   fChain->SetBranchAddress("b5_HLT_Mu9_IP4_part3", &b5_HLT_Mu9_IP4_part3, &b_b5_HLT_Mu9_IP4_part3);
   fChain->SetBranchAddress("b5_HLT_Mu9_IP4_part4", &b5_HLT_Mu9_IP4_part4, &b_b5_HLT_Mu9_IP4_part4);
   fChain->SetBranchAddress("b5_HLT_Mu8_IP5_part0", &b5_HLT_Mu8_IP5_part0, &b_b5_HLT_Mu8_IP5_part0);
   fChain->SetBranchAddress("b5_HLT_Mu8_IP5_part1", &b5_HLT_Mu8_IP5_part1, &b_b5_HLT_Mu8_IP5_part1);
   fChain->SetBranchAddress("b5_HLT_Mu8_IP5_part2", &b5_HLT_Mu8_IP5_part2, &b_b5_HLT_Mu8_IP5_part2);
   fChain->SetBranchAddress("b5_HLT_Mu8_IP5_part3", &b5_HLT_Mu8_IP5_part3, &b_b5_HLT_Mu8_IP5_part3);
   fChain->SetBranchAddress("b5_HLT_Mu8_IP5_part4", &b5_HLT_Mu8_IP5_part4, &b_b5_HLT_Mu8_IP5_part4);
   fChain->SetBranchAddress("b5_HLT_Mu8_IP6_part0", &b5_HLT_Mu8_IP6_part0, &b_b5_HLT_Mu8_IP6_part0);
   fChain->SetBranchAddress("b5_HLT_Mu8_IP6_part1", &b5_HLT_Mu8_IP6_part1, &b_b5_HLT_Mu8_IP6_part1);
   fChain->SetBranchAddress("b5_HLT_Mu8_IP6_part2", &b5_HLT_Mu8_IP6_part2, &b_b5_HLT_Mu8_IP6_part2);
   fChain->SetBranchAddress("b5_HLT_Mu8_IP6_part3", &b5_HLT_Mu8_IP6_part3, &b_b5_HLT_Mu8_IP6_part3);
   fChain->SetBranchAddress("b5_HLT_Mu8_IP6_part4", &b5_HLT_Mu8_IP6_part4, &b_b5_HLT_Mu8_IP6_part4);
   ...
   fChain->SetBranchAddress("b5_HLT_QuadPFJet105_88_76_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1", &b5_HLT_QuadPFJet105_88_76_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1, &b_b5_HLT_QuadPFJet105_88_76_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1);
   fChain->SetBranchAddress("b5_HLT_TrkMu6NoFiltersNoVtx", &b5_HLT_TrkMu6NoFiltersNoVtx, &b_b5_HLT_TrkMu6NoFiltersNoVtx);
   fChain->SetBranchAddress("b5_HLT_TrkMu16NoFiltersNoVtx", &b5_HLT_TrkMu16NoFiltersNoVtx, &b_b5_HLT_TrkMu16NoFiltersNoVtx);
   fChain->SetBranchAddress("b5_HLT_DoubleTrkMu_16_6_NoFiltersNoVtx", &b5_HLT_DoubleTrkMu_16_6_NoFiltersNoVtx, &b_b5_HLT_DoubleTrkMu_16_6_NoFiltersNoVtx);
   fChain->SetBranchAddress("b5_HLTriggerFinalPath", &b5_HLTriggerFinalPath, &b_b5_HLTriggerFinalPath);
   fChain->SetBranchAddress("b5_L1simulation_step", &b5_L1simulation_step, &b_b5_L1simulation_step);
   ...
   fChain->SetBranchAddress("bG_gen_nBs", &bG_gen_nBs, &b_bG_gen_nBs);
   fChain->SetBranchAddress("bG_ngen_Bs_pt", &bG_ngen_Bs_pt, &b_bG_ngen_Bs_pt);
   fChain->SetBranchAddress("bG_gen_Bs_pt", bG_gen_Bs_pt, &b_bG_gen_Bs_pt);
   fChain->SetBranchAddress("bG_ngen_Bs_energy", &bG_ngen_Bs_energy, &b_bG_ngen_Bs_energy);
   fChain->SetBranchAddress("bG_gen_Bs_energy", bG_gen_Bs_energy, &b_bG_gen_Bs_energy);
   fChain->SetBranchAddress("bG_ngen_Bs_eta", &bG_ngen_Bs_eta, &b_bG_ngen_Bs_eta);
   fChain->SetBranchAddress("bG_gen_Bs_eta", bG_gen_Bs_eta, &b_bG_gen_Bs_eta);
   fChain->SetBranchAddress("bG_ngen_Bs_phi", &bG_ngen_Bs_phi, &b_bG_ngen_Bs_phi);
   fChain->SetBranchAddress("bG_gen_Bs_phi", bG_gen_Bs_phi, &b_bG_gen_Bs_phi);
   fChain->SetBranchAddress("bG_ngen_Bs_pz", &bG_ngen_Bs_pz, &b_bG_ngen_Bs_pz);
   fChain->SetBranchAddress("bG_gen_Bs_pz", bG_gen_Bs_pz, &b_bG_gen_Bs_pz);
   fChain->SetBranchAddress("bG_ngen_Bs_pdgId", &bG_ngen_Bs_pdgId, &b_bG_ngen_Bs_pdgId);
   fChain->SetBranchAddress("bG_gen_Bs_pdgId", bG_gen_Bs_pdgId, &b_bG_gen_Bs_pdgId);
   fChain->SetBranchAddress("bG_gen_nBsMuonM", &bG_gen_nBsMuonM, &b_bG_gen_nBsMuonM);
   fChain->SetBranchAddress("bG_ngen_BsMuonM_pt", &bG_ngen_BsMuonM_pt, &b_bG_ngen_BsMuonM_pt);
   fChain->SetBranchAddress("bG_gen_BsMuonM_pt", bG_gen_BsMuonM_pt, &b_bG_gen_BsMuonM_pt);
   fChain->SetBranchAddress("bG_ngen_BsMuonM_eta", &bG_ngen_BsMuonM_eta, &b_bG_ngen_BsMuonM_eta);
   fChain->SetBranchAddress("bG_gen_BsMuonM_eta", bG_gen_BsMuonM_eta, &b_bG_gen_BsMuonM_eta);
   fChain->SetBranchAddress("bG_ngen_BsMuonM_phi", &bG_ngen_BsMuonM_phi, &b_bG_ngen_BsMuonM_phi);
   fChain->SetBranchAddress("bG_gen_BsMuonM_phi", bG_gen_BsMuonM_phi, &b_bG_gen_BsMuonM_phi);
   fChain->SetBranchAddress("bG_gen_nBsMuonP", &bG_gen_nBsMuonP, &b_bG_gen_nBsMuonP);
   fChain->SetBranchAddress("bG_ngen_BsMuonP_pt", &bG_ngen_BsMuonP_pt, &b_bG_ngen_BsMuonP_pt);
   fChain->SetBranchAddress("bG_gen_BsMuonP_pt", bG_gen_BsMuonP_pt, &b_bG_gen_BsMuonP_pt);
   fChain->SetBranchAddress("bG_ngen_BsMuonP_eta", &bG_ngen_BsMuonP_eta, &b_bG_ngen_BsMuonP_eta);
   fChain->SetBranchAddress("bG_gen_BsMuonP_eta", bG_gen_BsMuonP_eta, &b_bG_gen_BsMuonP_eta);
   fChain->SetBranchAddress("bG_ngen_BsMuonP_phi", &bG_ngen_BsMuonP_phi, &b_bG_ngen_BsMuonP_phi);
   fChain->SetBranchAddress("bG_gen_BsMuonP_phi", bG_gen_BsMuonP_phi, &b_bG_gen_BsMuonP_phi);
   fChain->SetBranchAddress("bG_gen_nBsPhoton", &bG_gen_nBsPhoton, &b_bG_gen_nBsPhoton);
   fChain->SetBranchAddress("bG_ngen_BsPhoton_pt", &bG_ngen_BsPhoton_pt, &b_bG_ngen_BsPhoton_pt);
   fChain->SetBranchAddress("bG_gen_BsPhoton_pt", bG_gen_BsPhoton_pt, &b_bG_gen_BsPhoton_pt);
   fChain->SetBranchAddress("bG_ngen_BsPhoton_energy", &bG_ngen_BsPhoton_energy, &b_bG_ngen_BsPhoton_energy);
   fChain->SetBranchAddress("bG_gen_BsPhoton_energy", bG_gen_BsPhoton_energy, &b_bG_gen_BsPhoton_energy);
   fChain->SetBranchAddress("bG_ngen_BsPhoton_eta", &bG_ngen_BsPhoton_eta, &b_bG_ngen_BsPhoton_eta);
   fChain->SetBranchAddress("bG_gen_BsPhoton_eta", bG_gen_BsPhoton_eta, &b_bG_gen_BsPhoton_eta);
   fChain->SetBranchAddress("bG_ngen_BsPhoton_phi", &bG_ngen_BsPhoton_phi, &b_bG_ngen_BsPhoton_phi);
   fChain->SetBranchAddress("bG_gen_BsPhoton_phi", bG_gen_BsPhoton_phi, &b_bG_gen_BsPhoton_phi);
...
void MergedBMMXMC::Show(Long64_t entry)
{
...
Int_t MergedBMMXMC::Cut(Long64_t entry)
{
