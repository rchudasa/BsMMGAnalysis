...
// Sat Feb  5 11:53:47 2022 by ROOT version 6.22/08
// from TTree mergedTree/bmm5 and bmmg merged tree
// found on file: bmmXMerged2018data_BsToMMG_0_0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxbG_nscMinDrWithGsfElectornSC = 17;
   static constexpr Int_t kMaxbG_scMinDrWithGsfElectornSC = 1;
   static constexpr Int_t kMaxbG_nscFoundGsfMatch = 17;
   ...
   UInt_t          b5_nbkkmm;
   Float_t         b5_bkkmm_gen_kaon1_pt[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_kaon2_pt[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_l3d[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_lxy[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_mass[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_prod_x[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_prod_y[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_prod_z[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_pt[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_gen_tau[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_alpha[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_alphaBS[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_alphaBSErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_alphaErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_eta[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon1eta[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon1phi[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon1pt[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon2eta[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon2phi[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kaon2pt[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_kk_mass[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_l3d[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_lxy[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_mass[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_massErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_phi[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pt[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv2ip[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv2ipErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv2lip[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv2lipErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv2lipSig[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv_z[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pv_zErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pvip[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pvipErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pvlip[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pvlipErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_pvlipSig[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_sl3d[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_slxy[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_spv2ip[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_spvip[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_tau[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_taue[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_tauxy[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_tauxye[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_chi2dof[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_prob[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_x[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_xErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_y[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_yErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_z[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_jpsikk_vtx_zErr[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon1_dxy_bs[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon1_eta[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon1_phi[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon1_pt[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon1_sdxy_bs[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon2_dxy_bs[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon2_eta[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon2_phi[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon2_pt[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kaon2_sdxy_bs[10];   //[b5_nbkkmm]
   Float_t         b5_bkkmm_kk_mass[10];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_gen_kaon1_mpdgId[10];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_gen_kaon1_pdgId[10];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_gen_kaon2_mpdgId[10];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_gen_kaon2_pdgId[10];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_gen_pdgId[10];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_jpsikk_valid[10];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_kaon1_charge[10];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_kaon2_charge[10];   //[b5_nbkkmm]
   Int_t           b5_bkkmm_mm_index[10];   //[b5_nbkkmm]
   UInt_t          b5_nbkmm;
   Float_t         b5_bkmm_bmm_bdt[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_docatrk[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_iso[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_m1iso[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_m2iso[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_mva[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_otherVtxMaxProb[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_otherVtxMaxProb1[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_bmm_otherVtxMaxProb2[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_kaon_pt[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_l3d[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_lxy[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_mass[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_prod_x[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_prod_y[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_prod_z[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_pt[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_gen_tau[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_alpha[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_alphaBS[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_alphaBSErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_alphaErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_eta[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_kaon1eta[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_kaon1phi[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_kaon1pt[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_l3d[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_lxy[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_mass[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_massErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_phi[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pt[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv2ip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv2ipErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv2lip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv2lipErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv2lipSig[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv_z[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pv_zErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pvip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pvipErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pvlip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pvlipErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_pvlipSig[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_sl3d[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_slxy[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_spv2ip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_spvip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_tau[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_taue[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_tauxy[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_tauxye[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_chi2dof[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_prob[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_x[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_xErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_y[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_yErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_z[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_jpsimc_vtx_zErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_dxy_bs[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_eta[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_mu1_doca[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_mu2_doca[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_phi[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_pt[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_kaon_sdxy_bs[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_alpha[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_alphaBS[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_alphaBSErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_alphaErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_eta[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_kaon1eta[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_kaon1phi[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_kaon1pt[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_l3d[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_lxy[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_mass[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_massErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_phi[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pt[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv2ip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv2ipErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv2lip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv2lipErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv2lipSig[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv_z[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pv_zErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pvip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pvipErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pvlip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pvlipErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_pvlipSig[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_sl3d[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_slxy[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_spv2ip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_spvip[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_tau[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_taue[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_tauxy[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_tauxye[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_chi2dof[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_prob[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_x[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_xErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_y[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_yErr[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_z[14];   //[b5_nbkmm]
   Float_t         b5_bkmm_nomc_vtx_zErr[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_closetrk[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_closetrks1[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_closetrks2[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_closetrks3[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_nBMTrks[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_nDisTrks[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_bmm_nTrks[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_gen_kaon_mpdgId[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_gen_kaon_pdgId[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_gen_pdgId[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_jpsimc_valid[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_kaon_charge[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_mm_index[14];   //[b5_nbkmm]
   Int_t           b5_bkmm_nomc_valid[14];   //[b5_nbkmm]
   UInt_t          b5_nmm;
   Float_t         b5_mm_bdt[61];   //[b5_nmm]
   Float_t         b5_mm_doca[61];   //[b5_nmm]
   Float_t         b5_mm_docatrk[61];   //[b5_nmm]
   Float_t         b5_mm_gen_alpha_ip[61];   //[b5_nmm]
   Float_t         b5_mm_gen_alpha_p_phi[61];   //[b5_nmm]
   Float_t         b5_mm_gen_alpha_p_theta[61];   //[b5_nmm]
   Float_t         b5_mm_gen_alpha_vtx[61];   //[b5_nmm]
   Float_t         b5_mm_gen_doca[61];   //[b5_nmm]
   Float_t         b5_mm_gen_l3d[61];   //[b5_nmm]
   Float_t         b5_mm_gen_lxy[61];   //[b5_nmm]
   Float_t         b5_mm_gen_mass[61];   //[b5_nmm]
   Float_t         b5_mm_gen_mu1_pt[61];   //[b5_nmm]
   Float_t         b5_mm_gen_mu2_pt[61];   //[b5_nmm]
   Float_t         b5_mm_gen_prod_z[61];   //[b5_nmm]
   Float_t         b5_mm_gen_pt[61];   //[b5_nmm]
   Float_t         b5_mm_gen_tau[61];   //[b5_nmm]
   Float_t         b5_mm_gen_vtx_x[61];   //[b5_nmm]
   Float_t         b5_mm_gen_vtx_y[61];   //[b5_nmm]
   Float_t         b5_mm_gen_vtx_z[61];   //[b5_nmm]
   Float_t         b5_mm_iso[61];   //[b5_nmm]
   Float_t         b5_mm_kal_lxy[61];   //[b5_nmm]
   Float_t         b5_mm_kal_mass[61];   //[b5_nmm]
   Float_t         b5_mm_kal_slxy[61];   //[b5_nmm]
   Float_t         b5_mm_kal_vtx_prob[61];   //[b5_nmm]
   Float_t         b5_mm_kin_alpha[61];   //[b5_nmm]
   Float_t         b5_mm_kin_alphaBS[61];   //[b5_nmm]
   Float_t         b5_mm_kin_alphaBSErr[61];   //[b5_nmm]
   Float_t         b5_mm_kin_alphaErr[61];   //[b5_nmm]
   Float_t         b5_mm_kin_eta[61];   //[b5_nmm]
   Float_t         b5_mm_kin_l3d[61];   //[b5_nmm]
   Float_t         b5_mm_kin_lxy[61];   //[b5_nmm]
   Float_t         b5_mm_kin_mass[61];   //[b5_nmm]
   Float_t         b5_mm_kin_massErr[61];   //[b5_nmm]
   Float_t         b5_mm_kin_mu1eta[61];   //[b5_nmm]
   Float_t         b5_mm_kin_mu1phi[61];   //[b5_nmm]
   Float_t         b5_mm_kin_mu1pt[61];   //[b5_nmm]
   Float_t         b5_mm_kin_mu2eta[61];   //[b5_nmm]
   Float_t         b5_mm_kin_mu2phi[61];   //[b5_nmm]
   Float_t         b5_mm_kin_mu2pt[61];   //[b5_nmm]
   Float_t         b5_mm_kin_phi[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pt[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pv2ip[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pv2ipErr[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pv2lip[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pv2lipErr[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pv2lipSig[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pv_z[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pv_zErr[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pvip[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pvipErr[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pvlip[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pvlipErr[61];   //[b5_nmm]
   Float_t         b5_mm_kin_pvlipSig[61];   //[b5_nmm]
   Float_t         b5_mm_kin_sl3d[61];   //[b5_nmm]
   Float_t         b5_mm_kin_slxy[61];   //[b5_nmm]
   Float_t         b5_mm_kin_spv2ip[61];   //[b5_nmm]
   Float_t         b5_mm_kin_spvip[61];   //[b5_nmm]
   Float_t         b5_mm_kin_tau[61];   //[b5_nmm]
   Float_t         b5_mm_kin_taue[61];   //[b5_nmm]
   Float_t         b5_mm_kin_tauxy[61];   //[b5_nmm]
   Float_t         b5_mm_kin_tauxye[61];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_chi2dof[61];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_prob[61];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_x[61];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_xErr[61];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_y[61];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_yErr[61];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_z[61];   //[b5_nmm]
   Float_t         b5_mm_kin_vtx_zErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_alpha[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_alphaBS[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_alphaBSErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_alphaErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_eta[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_l3d[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_lxy[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_mass[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_massErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_phi[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pt[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv2ip[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv2ipErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv2lip[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv2lipErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv2lipSig[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv_z[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pv_zErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pvip[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pvipErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pvlip[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pvlipErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_pvlipSig[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_sl3d[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_slxy[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_spv2ip[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_spvip[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_tau[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_taue[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_tauxy[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_tauxye[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_chi2dof[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_prob[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_x[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_xErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_y[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_yErr[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_z[61];   //[b5_nmm]
   Float_t         b5_mm_kinpc_vtx_zErr[61];   //[b5_nmm]
   Float_t         b5_mm_m1iso[61];   //[b5_nmm]
   Float_t         b5_mm_m2iso[61];   //[b5_nmm]
   Float_t         b5_mm_mass[61];   //[b5_nmm]
   Float_t         b5_mm_mu1_eta[61];   //[b5_nmm]
   Float_t         b5_mm_mu1_phi[61];   //[b5_nmm]
   Float_t         b5_mm_mu1_pt[61];   //[b5_nmm]
   Float_t         b5_mm_mu2_eta[61];   //[b5_nmm]
   Float_t         b5_mm_mu2_phi[61];   //[b5_nmm]
   Float_t         b5_mm_mu2_pt[61];   //[b5_nmm]
   Float_t         b5_mm_mva[61];   //[b5_nmm]
   Float_t         b5_mm_otherVtxMaxProb[61];   //[b5_nmm]
   Float_t         b5_mm_otherVtxMaxProb1[61];   //[b5_nmm]
   Float_t         b5_mm_otherVtxMaxProb2[61];   //[b5_nmm]
   Int_t           b5_mm_closetrk[61];   //[b5_nmm]
   Int_t           b5_mm_closetrks1[61];   //[b5_nmm]
   Int_t           b5_mm_closetrks2[61];   //[b5_nmm]
   Int_t           b5_mm_closetrks3[61];   //[b5_nmm]
   Int_t           b5_mm_gen_cpdgId[61];   //[b5_nmm]
   Int_t           b5_mm_gen_mpdgId[61];   //[b5_nmm]
   Int_t           b5_mm_gen_mu1_mpdgId[61];   //[b5_nmm]
   Int_t           b5_mm_gen_mu1_pdgId[61];   //[b5_nmm]
   Int_t           b5_mm_gen_mu2_mpdgId[61];   //[b5_nmm]
   Int_t           b5_mm_gen_mu2_pdgId[61];   //[b5_nmm]
   Int_t           b5_mm_gen_pdgId[61];   //[b5_nmm]
   Int_t           b5_mm_kal_valid[61];   //[b5_nmm]
   Int_t           b5_mm_kin_valid[61];   //[b5_nmm]
   Int_t           b5_mm_kinpc_valid[61];   //[b5_nmm]
   Int_t           b5_mm_mu1_index[61];   //[b5_nmm]
   Int_t           b5_mm_mu1_pdgId[61];   //[b5_nmm]
   Int_t           b5_mm_mu2_index[61];   //[b5_nmm]
   Int_t           b5_mm_mu2_pdgId[61];   //[b5_nmm]
   Int_t           b5_mm_nBMTrks[61];   //[b5_nmm]
   Int_t           b5_mm_nDisTrks[61];   //[b5_nmm]
   Int_t           b5_mm_nTrks[61];   //[b5_nmm]
   ...
   UInt_t          b5_nlambda;
   Float_t         b5_lambda_doca[3];   //[b5_nlambda]
   Float_t         b5_lambda_gen_mass[3];   //[b5_nlambda]
   Float_t         b5_lambda_gen_pion_pt[3];   //[b5_nlambda]
   Float_t         b5_lambda_gen_proton_pt[3];   //[b5_nlambda]
   Float_t         b5_lambda_gen_pt[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_cosAlphaXY[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_eta[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_lxy[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_mass[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_massErr[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_phi[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_pt[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_sipBS[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_sipPV[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_slxy[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_vtx_chi2dof[3];   //[b5_nlambda]
   Float_t         b5_lambda_kin_vtx_prob[3];   //[b5_nlambda]
   Float_t         b5_lambda_mass[3];   //[b5_nlambda]
   Float_t         b5_lambda_pion_eta[3];   //[b5_nlambda]
   Float_t         b5_lambda_pion_phi[3];   //[b5_nlambda]
   Float_t         b5_lambda_pion_pt[3];   //[b5_nlambda]
   Float_t         b5_lambda_pion_sip[3];   //[b5_nlambda]
   Float_t         b5_lambda_proton_eta[3];   //[b5_nlambda]
   Float_t         b5_lambda_proton_phi[3];   //[b5_nlambda]
   Float_t         b5_lambda_proton_pt[3];   //[b5_nlambda]
   Float_t         b5_lambda_proton_sip[3];   //[b5_nlambda]
   Int_t           b5_lambda_gen_pdgId[3];   //[b5_nlambda]
   Int_t           b5_lambda_gen_pion_mpdgId[3];   //[b5_nlambda]
   Int_t           b5_lambda_gen_pion_pdgId[3];   //[b5_nlambda]
   Int_t           b5_lambda_gen_proton_mpdgId[3];   //[b5_nlambda]
   Int_t           b5_lambda_gen_proton_pdgId[3];   //[b5_nlambda]
   Int_t           b5_lambda_kin_valid[3];   //[b5_nlambda]
   Int_t           b5_lambda_pion_mu_index[3];   //[b5_nlambda]
   Int_t           b5_lambda_proton_mu_index[3];   //[b5_nlambda]
   UInt_t          b5_nphi;
   Float_t         b5_phi_doca[4];   //[b5_nphi]
   Float_t         b5_phi_ds_cosAlphaXY[4];   //[b5_nphi]
   Float_t         b5_phi_ds_eta[4];   //[b5_nphi]
   Float_t         b5_phi_ds_lxy[4];   //[b5_nphi]
   Float_t         b5_phi_ds_mass[4];   //[b5_nphi]
   Float_t         b5_phi_ds_massErr[4];   //[b5_nphi]
   Float_t         b5_phi_ds_phi[4];   //[b5_nphi]
   Float_t         b5_phi_ds_pion_eta[4];   //[b5_nphi]
   Float_t         b5_phi_ds_pion_mu_index[4];   //[b5_nphi]
   Float_t         b5_phi_ds_pion_phi[4];   //[b5_nphi]
   Float_t         b5_phi_ds_pion_pt[4];   //[b5_nphi]
   Float_t         b5_phi_ds_pt[4];   //[b5_nphi]
   Float_t         b5_phi_ds_sipBS[4];   //[b5_nphi]
   Float_t         b5_phi_ds_sipPV[4];   //[b5_nphi]
   Float_t         b5_phi_ds_slxy[4];   //[b5_nphi]
   Float_t         b5_phi_ds_vtx_chi2dof[4];   //[b5_nphi]
   Float_t         b5_phi_ds_vtx_prob[4];   //[b5_nphi]
   Float_t         b5_phi_gen_mass[4];   //[b5_nphi]
   Float_t         b5_phi_gen_pt[4];   //[b5_nphi]
   Float_t         b5_phi_gen_trk1_pt[4];   //[b5_nphi]
   Float_t         b5_phi_gen_trk2_pt[4];   //[b5_nphi]
   Float_t         b5_phi_kin_cosAlphaXY[4];   //[b5_nphi]
   Float_t         b5_phi_kin_eta[4];   //[b5_nphi]
   Float_t         b5_phi_kin_lxy[4];   //[b5_nphi]
   Float_t         b5_phi_kin_mass[4];   //[b5_nphi]
   Float_t         b5_phi_kin_massErr[4];   //[b5_nphi]
   Float_t         b5_phi_kin_phi[4];   //[b5_nphi]
   Float_t         b5_phi_kin_pt[4];   //[b5_nphi]
   Float_t         b5_phi_kin_sipBS[4];   //[b5_nphi]
   Float_t         b5_phi_kin_sipPV[4];   //[b5_nphi]
   Float_t         b5_phi_kin_slxy[4];   //[b5_nphi]
   Float_t         b5_phi_kin_vtx_chi2dof[4];   //[b5_nphi]
   Float_t         b5_phi_kin_vtx_prob[4];   //[b5_nphi]
   Float_t         b5_phi_mass[4];   //[b5_nphi]
   Float_t         b5_phi_trk1_eta[4];   //[b5_nphi]
   Float_t         b5_phi_trk1_phi[4];   //[b5_nphi]
   Float_t         b5_phi_trk1_pt[4];   //[b5_nphi]
   Float_t         b5_phi_trk1_sip[4];   //[b5_nphi]
   Float_t         b5_phi_trk2_eta[4];   //[b5_nphi]
   Float_t         b5_phi_trk2_phi[4];   //[b5_nphi]
   Float_t         b5_phi_trk2_pt[4];   //[b5_nphi]
   Float_t         b5_phi_trk2_sip[4];   //[b5_nphi]
   Int_t           b5_phi_gen_pdgId[4];   //[b5_nphi]
   Int_t           b5_phi_gen_trk1_mpdgId[4];   //[b5_nphi]
   Int_t           b5_phi_gen_trk1_pdgId[4];   //[b5_nphi]
   Int_t           b5_phi_gen_trk2_mpdgId[4];   //[b5_nphi]
   Int_t           b5_phi_gen_trk2_pdgId[4];   //[b5_nphi]
   Int_t           b5_phi_kin_valid[4];   //[b5_nphi]
   Int_t           b5_phi_trk1_mu_index[4];   //[b5_nphi]
   Int_t           b5_phi_trk2_mu_index[4];   //[b5_nphi]
   ...
   Float_t         b5_CorrT1METJet_area[19];   //[b5_nCorrT1METJet]
   Float_t         b5_CorrT1METJet_eta[19];   //[b5_nCorrT1METJet]
   Float_t         b5_CorrT1METJet_muonSubtrFactor[19];   //[b5_nCorrT1METJet]
   Float_t         b5_CorrT1METJet_phi[19];   //[b5_nCorrT1METJet]
   Float_t         b5_CorrT1METJet_rawPt[19];   //[b5_nCorrT1METJet]
   ...
   Float_t         b5_GenJetAK8_eta[3];   //[b5_nGenJetAK8]
   Float_t         b5_GenJetAK8_mass[3];   //[b5_nGenJetAK8]
   Float_t         b5_GenJetAK8_phi[3];   //[b5_nGenJetAK8]
   Float_t         b5_GenJetAK8_pt[3];   //[b5_nGenJetAK8]
   UInt_t          b5_nGenJet;
   Float_t         b5_GenJet_eta[15];   //[b5_nGenJet]
   Float_t         b5_GenJet_mass[15];   //[b5_nGenJet]
   Float_t         b5_GenJet_phi[15];   //[b5_nGenJet]
   Float_t         b5_GenJet_pt[15];   //[b5_nGenJet]
   UInt_t          b5_nGenPart;
   ...
   Float_t         b5_SubGenJetAK8_eta[6];   //[b5_nSubGenJetAK8]
   Float_t         b5_SubGenJetAK8_mass[6];   //[b5_nSubGenJetAK8]
   Float_t         b5_SubGenJetAK8_phi[6];   //[b5_nSubGenJetAK8]
   Float_t         b5_SubGenJetAK8_pt[6];   //[b5_nSubGenJetAK8]
   ...
   UInt_t          b5_nJet;
   Float_t         b5_Jet_area[17];   //[b5_nJet]
   Float_t         b5_Jet_btagCMVA[17];   //[b5_nJet]
   Float_t         b5_Jet_btagCSVV2[17];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepB[17];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepC[17];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepCvB[17];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepCvL[17];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepFlavB[17];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepFlavC[17];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepFlavCvB[17];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepFlavCvL[17];   //[b5_nJet]
   Float_t         b5_Jet_btagDeepFlavQG[17];   //[b5_nJet]
   Float_t         b5_Jet_chEmEF[17];   //[b5_nJet]
   Float_t         b5_Jet_chFPV0EF[17];   //[b5_nJet]
   Float_t         b5_Jet_chFPV1EF[17];   //[b5_nJet]
   Float_t         b5_Jet_chFPV2EF[17];   //[b5_nJet]
   Float_t         b5_Jet_chFPV3EF[17];   //[b5_nJet]
   Float_t         b5_Jet_chHEF[17];   //[b5_nJet]
   Float_t         b5_Jet_eta[17];   //[b5_nJet]
   Float_t         b5_Jet_hfsigmaEtaEta[17];   //[b5_nJet]
   Float_t         b5_Jet_hfsigmaPhiPhi[17];   //[b5_nJet]
   Float_t         b5_Jet_mass[17];   //[b5_nJet]
   Float_t         b5_Jet_muEF[17];   //[b5_nJet]
   Float_t         b5_Jet_muonSubtrFactor[17];   //[b5_nJet]
   Float_t         b5_Jet_neEmEF[17];   //[b5_nJet]
   Float_t         b5_Jet_neHEF[17];   //[b5_nJet]
   Float_t         b5_Jet_phi[17];   //[b5_nJet]
   Float_t         b5_Jet_pt[17];   //[b5_nJet]
   Float_t         b5_Jet_puIdDisc[17];   //[b5_nJet]
   Float_t         b5_Jet_qgl[17];   //[b5_nJet]
   Float_t         b5_Jet_rawFactor[17];   //[b5_nJet]
   Float_t         b5_Jet_bRegCorr[17];   //[b5_nJet]
   Float_t         b5_Jet_bRegRes[17];   //[b5_nJet]
   Float_t         b5_Jet_cRegCorr[17];   //[b5_nJet]
   Float_t         b5_Jet_cRegRes[17];   //[b5_nJet]
   Int_t           b5_Jet_electronIdx1[17];   //[b5_nJet]
   Int_t           b5_Jet_electronIdx2[17];   //[b5_nJet]
   Int_t           b5_Jet_hfadjacentEtaStripsSize[17];   //[b5_nJet]
   Int_t           b5_Jet_hfcentralEtaStripSize[17];   //[b5_nJet]
   Int_t           b5_Jet_jetId[17];   //[b5_nJet]
   Int_t           b5_Jet_muonIdx1[17];   //[b5_nJet]
   Int_t           b5_Jet_muonIdx2[17];   //[b5_nJet]
   Int_t           b5_Jet_nConstituents[17];   //[b5_nJet]
   Int_t           b5_Jet_nElectrons[17];   //[b5_nJet]
   Int_t           b5_Jet_nMuons[17];   //[b5_nJet]
   Int_t           b5_Jet_puId[17];   //[b5_nJet]
   ...
   UInt_t          b5_nPhoton;
   Float_t         b5_Photon_eCorr[5];   //[b5_nPhoton]
   Float_t         b5_Photon_energyErr[5];   //[b5_nPhoton]
   Float_t         b5_Photon_eta[5];   //[b5_nPhoton]
   Float_t         b5_Photon_hoe[5];   //[b5_nPhoton]
   Float_t         b5_Photon_mass[5];   //[b5_nPhoton]
   Float_t         b5_Photon_mvaID[5];   //[b5_nPhoton]
   Float_t         b5_Photon_mvaID_Fall17V1p1[5];   //[b5_nPhoton]
   Float_t         b5_Photon_pfRelIso03_all[5];   //[b5_nPhoton]
   Float_t         b5_Photon_pfRelIso03_chg[5];   //[b5_nPhoton]
   Float_t         b5_Photon_phi[5];   //[b5_nPhoton]
   Float_t         b5_Photon_pt[5];   //[b5_nPhoton]
   Float_t         b5_Photon_r9[5];   //[b5_nPhoton]
   Float_t         b5_Photon_sieie[5];   //[b5_nPhoton]
   Int_t           b5_Photon_charge[5];   //[b5_nPhoton]
   Int_t           b5_Photon_cutBased[5];   //[b5_nPhoton]
   Int_t           b5_Photon_cutBased_Fall17V1Bitmap[5];   //[b5_nPhoton]
   Int_t           b5_Photon_electronIdx[5];   //[b5_nPhoton]
   Int_t           b5_Photon_jetIdx[5];   //[b5_nPhoton]
   Int_t           b5_Photon_pdgId[5];   //[b5_nPhoton]
   Int_t           b5_Photon_vidNestedWPBitmap[5];   //[b5_nPhoton]
   Bool_t          b5_Photon_electronVeto[5];   //[b5_nPhoton]
   Bool_t          b5_Photon_isScEtaEB[5];   //[b5_nPhoton]
   Bool_t          b5_Photon_isScEtaEE[5];   //[b5_nPhoton]
   Bool_t          b5_Photon_mvaID_WP80[5];   //[b5_nPhoton]
   Bool_t          b5_Photon_mvaID_WP90[5];   //[b5_nPhoton]
   Bool_t          b5_Photon_pixelSeed[5];   //[b5_nPhoton]
   UChar_t         b5_Photon_seedGain[5];   //[b5_nPhoton]
   ...
   UInt_t          b5_nTrigObj;
   Float_t         b5_TrigObj_pt[16];   //[b5_nTrigObj]
   Float_t         b5_TrigObj_eta[16];   //[b5_nTrigObj]
   Float_t         b5_TrigObj_phi[16];   //[b5_nTrigObj]
   Float_t         b5_TrigObj_l1pt[16];   //[b5_nTrigObj]
   Float_t         b5_TrigObj_l1pt_2[16];   //[b5_nTrigObj]
   Float_t         b5_TrigObj_l2pt[16];   //[b5_nTrigObj]
   Int_t           b5_TrigObj_id[16];   //[b5_nTrigObj]
   Int_t           b5_TrigObj_l1iso[16];   //[b5_nTrigObj]
   Int_t           b5_TrigObj_l1charge[16];   //[b5_nTrigObj]
   Int_t           b5_TrigObj_filterBits[16];   //[b5_nTrigObj]
   Int_t           b5_genTtbarId;
   UInt_t          b5_nOtherPV;
   ...
   UInt_t          b5_nSV;
   Float_t         b5_SV_dlen[7];   //[b5_nSV]
   Float_t         b5_SV_dlenSig[7];   //[b5_nSV]
   Float_t         b5_SV_dxy[7];   //[b5_nSV]
   Float_t         b5_SV_dxySig[7];   //[b5_nSV]
   Float_t         b5_SV_pAngle[7];   //[b5_nSV]
   ...
   Int_t           b5_GenJetAK8_partonFlavour[3];   //[b5_nGenJetAK8]
   UChar_t         b5_GenJetAK8_hadronFlavour[3];   //[b5_nGenJetAK8]
   Int_t           b5_GenJet_partonFlavour[15];   //[b5_nGenJet]
   UChar_t         b5_GenJet_hadronFlavour[15];   //[b5_nGenJet]
   Float_t         b5_GenVtx_t0;
   Int_t           b5_Jet_genJetIdx[17];   //[b5_nJet]
   Int_t           b5_Jet_hadronFlavour[17];   //[b5_nJet]
   Int_t           b5_Jet_partonFlavour[17];   //[b5_nJet]
   Int_t           b5_Muon_genPartIdx[6];   //[b5_nMuon]
   UChar_t         b5_Muon_genPartFlav[6];   //[b5_nMuon]
   Int_t           b5_Photon_genPartIdx[5];   //[b5_nPhoton]
   UChar_t         b5_Photon_genPartFlav[5];   //[b5_nPhoton]
   Float_t         b5_MET_fiducialGenPhi;
   Float_t         b5_MET_fiducialGenPt;
   UChar_t         b5_Electron_cleanmask[5];   //[b5_nElectron]
   UChar_t         b5_Jet_cleanmask[17];   //[b5_nJet]
   UChar_t         b5_Muon_cleanmask[6];   //[b5_nMuon]
   UChar_t         b5_Photon_cleanmask[5];   //[b5_nPhoton]
   ...
   Float_t         b5_SV_chi2[7];   //[b5_nSV]
   Float_t         b5_SV_eta[7];   //[b5_nSV]
   Float_t         b5_SV_mass[7];   //[b5_nSV]
   Float_t         b5_SV_ndof[7];   //[b5_nSV]
   Float_t         b5_SV_phi[7];   //[b5_nSV]
   Float_t         b5_SV_pt[7];   //[b5_nSV]
   Float_t         b5_SV_x[7];   //[b5_nSV]
   Float_t         b5_SV_y[7];   //[b5_nSV]
   Float_t         b5_SV_z[7];   //[b5_nSV]
   UChar_t         b5_SV_ntracks[7];   //[b5_nSV]
   ...
   Double_t        bG_gen_Bs_pt[3];   //[bG_ngen_Bs_pt]
   UInt_t          bG_ngen_Bs_energy;
   Double_t        bG_gen_Bs_energy[3];   //[bG_ngen_Bs_energy]
   UInt_t          bG_ngen_Bs_eta;
   Double_t        bG_gen_Bs_eta[3];   //[bG_ngen_Bs_eta]
   UInt_t          bG_ngen_Bs_phi;
   Double_t        bG_gen_Bs_phi[3];   //[bG_ngen_Bs_phi]
   UInt_t          bG_ngen_Bs_pz;
   Double_t        bG_gen_Bs_pz[3];   //[bG_ngen_Bs_pz]
   UInt_t          bG_ngen_Bs_pdgId;
   Double_t        bG_gen_Bs_pdgId[3];   //[bG_ngen_Bs_pdgId]
   ...
   Double_t        bG_gen_BsPhoton_pt[4];   //[bG_ngen_BsPhoton_pt]
   UInt_t          bG_ngen_BsPhoton_energy;
   Double_t        bG_gen_BsPhoton_energy[4];   //[bG_ngen_BsPhoton_energy]
   UInt_t          bG_ngen_BsPhoton_eta;
   Double_t        bG_gen_BsPhoton_eta[4];   //[bG_ngen_BsPhoton_eta]
   UInt_t          bG_ngen_BsPhoton_phi;
   Double_t        bG_gen_BsPhoton_phi[4];   //[bG_ngen_BsPhoton_phi]
   Int_t           bG_nSC;
   UInt_t          bG_nscE;
   Float_t         bG_scE[17];   //[bG_nscE]
   UInt_t          bG_nscEt;
   Float_t         bG_scEt[17];   //[bG_nscEt]
   UInt_t          bG_nscRawE;
   Float_t         bG_scRawE[17];   //[bG_nscRawE]
   UInt_t          bG_nscEta;
   Float_t         bG_scEta[17];   //[bG_nscEta]
   UInt_t          bG_nscPhi;
   Float_t         bG_scPhi[17];   //[bG_nscPhi]
   UInt_t          bG_nscX;
   Float_t         bG_scX[17];   //[bG_nscX]
   UInt_t          bG_nscY;
   Float_t         bG_scY[17];   //[bG_nscY]
   UInt_t          bG_nscZ;
   Float_t         bG_scZ[17];   //[bG_nscZ]
   UInt_t          bG_nscEtaWidth;
   Float_t         bG_scEtaWidth[17];   //[bG_nscEtaWidth]
   UInt_t          bG_nscPhiWidth;
   Float_t         bG_scPhiWidth[17];   //[bG_nscPhiWidth]
   UInt_t          bG_nscRawEt;
   Float_t         bG_scRawEt[17];   //[bG_nscRawEt]
   ...
   UInt_t          bG_nscE5x5;
   Float_t         bG_scE5x5[17];   //[bG_nscE5x5]
   UInt_t          bG_nscE2x2Ratio;
   Float_t         bG_scE2x2Ratio[17];   //[bG_nscE2x2Ratio]
   UInt_t          bG_nscE3x3Ratio;
   Float_t         bG_scE3x3Ratio[17];   //[bG_nscE3x3Ratio]
   UInt_t          bG_nscEMaxRatio;
   Float_t         bG_scEMaxRatio[17];   //[bG_nscEMaxRatio]
   UInt_t          bG_nscE2ndRatio;
   Float_t         bG_scE2ndRatio[17];   //[bG_nscE2ndRatio]
   UInt_t          bG_nscETopRatio;
   Float_t         bG_scETopRatio[17];   //[bG_nscETopRatio]
   UInt_t          bG_nscERightRatio;
   Float_t         bG_scERightRatio[17];   //[bG_nscERightRatio]
   UInt_t          bG_nscEBottomRatio;
   Float_t         bG_scEBottomRatio[17];   //[bG_nscEBottomRatio]
   UInt_t          bG_nscELeftRatio;
   Float_t         bG_scELeftRatio[17];   //[bG_nscELeftRatio]
   UInt_t          bG_nscE2x5MaxRatio;
   Float_t         bG_scE2x5MaxRatio[17];   //[bG_nscE2x5MaxRatio]
   UInt_t          bG_nscE2x5TopRatio;
   Float_t         bG_scE2x5TopRatio[17];   //[bG_nscE2x5TopRatio]
   UInt_t          bG_nscE2x5RightRatio;
   Float_t         bG_scE2x5RightRatio[17];   //[bG_nscE2x5RightRatio]
   UInt_t          bG_nscE2x5BottomRatio;
   Float_t         bG_scE2x5BottomRatio[17];   //[bG_nscE2x5BottomRatio]
   UInt_t          bG_nscE2x5LeftRatio;
   Float_t         bG_scE2x5LeftRatio[17];   //[bG_nscE2x5LeftRatio]
   UInt_t          bG_nscSwissCross;
   Float_t         bG_scSwissCross[17];   //[bG_nscSwissCross]
   UInt_t          bG_nscR9;
   Float_t         bG_scR9[17];   //[bG_nscR9]
   UInt_t          bG_nscSigmaIetaIeta;
   Float_t         bG_scSigmaIetaIeta[17];   //[bG_nscSigmaIetaIeta]
   UInt_t          bG_nscSigmaIetaIphi;
   Float_t         bG_scSigmaIetaIphi[17];   //[bG_nscSigmaIetaIphi]
   UInt_t          bG_nscSigmaIphiIphi;
   Float_t         bG_scSigmaIphiIphi[17];   //[bG_nscSigmaIphiIphi]
   UInt_t          bG_nscFull5x5_e5x5;
   Float_t         bG_scFull5x5_e5x5[17];   //[bG_nscFull5x5_e5x5]
   UInt_t          bG_nscFull5x5_e2x2Ratio;
   Float_t         bG_scFull5x5_e2x2Ratio[17];   //[bG_nscFull5x5_e2x2Ratio]
   UInt_t          bG_nscFull5x5_e3x3Ratio;
   Float_t         bG_scFull5x5_e3x3Ratio[17];   //[bG_nscFull5x5_e3x3Ratio]
   UInt_t          bG_nscFull5x5_eMaxRatio;
   Float_t         bG_scFull5x5_eMaxRatio[17];   //[bG_nscFull5x5_eMaxRatio]
   UInt_t          bG_nscFull5x5_e2ndRatio;
   Float_t         bG_scFull5x5_e2ndRatio[17];   //[bG_nscFull5x5_e2ndRatio]
   UInt_t          bG_nscFull5x5_eTopRatio;
   Float_t         bG_scFull5x5_eTopRatio[17];   //[bG_nscFull5x5_eTopRatio]
   UInt_t          bG_nscFull5x5_eRightRatio;
   Float_t         bG_scFull5x5_eRightRatio[17];   //[bG_nscFull5x5_eRightRatio]
   UInt_t          bG_nscFull5x5_eBottomRatio;
   Float_t         bG_scFull5x5_eBottomRatio[17];   //[bG_nscFull5x5_eBottomRatio]
   UInt_t          bG_nscFull5x5_eLeftRatio;
   Float_t         bG_scFull5x5_eLeftRatio[17];   //[bG_nscFull5x5_eLeftRatio]
   UInt_t          bG_nscFull5x5_e2x5MaxRatio;
   Float_t         bG_scFull5x5_e2x5MaxRatio[17];   //[bG_nscFull5x5_e2x5MaxRatio]
   UInt_t          bG_nscFull5x5_e2x5TopRatio;
   Float_t         bG_scFull5x5_e2x5TopRatio[17];   //[bG_nscFull5x5_e2x5TopRatio]
   UInt_t          bG_nscFull5x5_e2x5RightRatio;
   Float_t         bG_scFull5x5_e2x5RightRatio[17];   //[bG_nscFull5x5_e2x5RightRatio]
   UInt_t          bG_nscFull5x5_e2x5BottomRatio;
   Float_t         bG_scFull5x5_e2x5BottomRatio[17];   //[bG_nscFull5x5_e2x5BottomRatio]
   UInt_t          bG_nscFull5x5_e2x5LeftRatio;
   Float_t         bG_scFull5x5_e2x5LeftRatio[17];   //[bG_nscFull5x5_e2x5LeftRatio]
   UInt_t          bG_nscFull5x5_swissCross;
   Float_t         bG_scFull5x5_swissCross[17];   //[bG_nscFull5x5_swissCross]
   UInt_t          bG_nscFull5x5_r9;
   Float_t         bG_scFull5x5_r9[17];   //[bG_nscFull5x5_r9]
   UInt_t          bG_nscFull5x5_sigmaIetaIeta;
   Float_t         bG_scFull5x5_sigmaIetaIeta[17];   //[bG_nscFull5x5_sigmaIetaIeta]
   UInt_t          bG_nscFull5x5_sigmaIetaIphi;
   Float_t         bG_scFull5x5_sigmaIetaIphi[17];   //[bG_nscFull5x5_sigmaIetaIphi]
   UInt_t          bG_nscFull5x5_sigmaIphiIphi;
   Float_t         bG_scFull5x5_sigmaIphiIphi[17];   //[bG_nscFull5x5_sigmaIphiIphi]
   UInt_t          bG_nscNHcalRecHitInDIEta5IPhi5;
   Float_t         bG_scNHcalRecHitInDIEta5IPhi5[17];   //[bG_nscNHcalRecHitInDIEta5IPhi5]
   UInt_t          bG_nscEFromHcalRecHitInDIEta5IPhi5;
   Float_t         bG_scEFromHcalRecHitInDIEta5IPhi5[17];   //[bG_nscEFromHcalRecHitInDIEta5IPhi5]
   UInt_t          bG_nscNHcalRecHitInDIEta2IPhi2;
   Float_t         bG_scNHcalRecHitInDIEta2IPhi2[17];   //[bG_nscNHcalRecHitInDIEta2IPhi2]
   UInt_t          bG_nscEFromHcalRecHitInDIEta2IPhi2;
   Float_t         bG_scEFromHcalRecHitInDIEta2IPhi2[17];   //[bG_nscEFromHcalRecHitInDIEta2IPhi2]
   UInt_t          bG_nscPFChIso1;
   Float_t         bG_scPFChIso1[17];   //[bG_nscPFChIso1]
   UInt_t          bG_nscPFChIso2;
   Float_t         bG_scPFChIso2[17];   //[bG_nscPFChIso2]
   UInt_t          bG_nscPFChIso3;
   Float_t         bG_scPFChIso3[17];   //[bG_nscPFChIso3]
   UInt_t          bG_nscPFChIso4;
   Float_t         bG_scPFChIso4[17];   //[bG_nscPFChIso4]
   UInt_t          bG_nscPFChIso5;
   Float_t         bG_scPFChIso5[17];   //[bG_nscPFChIso5]
   UInt_t          bG_nscPFPhoIso1;
   Float_t         bG_scPFPhoIso1[17];   //[bG_nscPFPhoIso1]
   UInt_t          bG_nscPFPhoIso2;
   Float_t         bG_scPFPhoIso2[17];   //[bG_nscPFPhoIso2]
   UInt_t          bG_nscPFPhoIso3;
   Float_t         bG_scPFPhoIso3[17];   //[bG_nscPFPhoIso3]
   UInt_t          bG_nscPFPhoIso4;
   Float_t         bG_scPFPhoIso4[17];   //[bG_nscPFPhoIso4]
   UInt_t          bG_nscPFPhoIso5;
   Float_t         bG_scPFPhoIso5[17];   //[bG_nscPFPhoIso5]
   UInt_t          bG_nscPFNeuIso1;
   Float_t         bG_scPFNeuIso1[17];   //[bG_nscPFNeuIso1]
   UInt_t          bG_nscPFNeuIso2;
   Float_t         bG_scPFNeuIso2[17];   //[bG_nscPFNeuIso2]
   UInt_t          bG_nscPFNeuIso3;
   Float_t         bG_scPFNeuIso3[17];   //[bG_nscPFNeuIso3]
   UInt_t          bG_nscPFNeuIso4;
   Float_t         bG_scPFNeuIso4[17];   //[bG_nscPFNeuIso4]
   UInt_t          bG_nscPFNeuIso5;
   Float_t         bG_scPFNeuIso5[17];   //[bG_nscPFNeuIso5]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("bmmXMerged2018data_BsToMMG_0_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("bmmXMerged2018data_BsToMMG_0_0.root");
      }
