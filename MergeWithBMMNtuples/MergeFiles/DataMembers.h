//      DATAMEMBERS   
	...
	Bool_t  bG_primaryVertex_isFake[MAX_ARRAY_SIZE] ;
	...
	Float_t  bG_hcalRechitIEta[MAX_ARRAY_SIZE] ;
	Float_t  bG_hcalRechitIPhi[MAX_ARRAY_SIZE] ;
	Float_t  bG_hcalRechitEnergy[MAX_ARRAY_SIZE] ;
//      END DATA MEMBERS   
