#define __GENERICTREEMAKERCXX__ 
...
void genericTreeBranchSelector::FillTheArraysFromVectors()
{
	...
	for( UInt_t i=0; i< UInt_t ( bG.nSC) ; i++ ) { 
		...
		bG_superCluster_e5x5[i] = bG.superCluster_e5x5->at(i);
		bG_superCluster_e2x2Ratio[i] = bG.superCluster_e2x2Ratio->at(i);
		bG_superCluster_e3x3Ratio[i] = bG.superCluster_e3x3Ratio->at(i);
		bG_superCluster_eMaxRatio[i] = bG.superCluster_eMaxRatio->at(i);
		bG_superCluster_e2ndRatio[i] = bG.superCluster_e2ndRatio->at(i);
		bG_superCluster_eTopRatio[i] = bG.superCluster_eTopRatio->at(i);
		bG_superCluster_eRightRatio[i] = bG.superCluster_eRightRatio->at(i);
		bG_superCluster_eBottomRatio[i] = bG.superCluster_eBottomRatio->at(i);
		bG_superCluster_eLeftRatio[i] = bG.superCluster_eLeftRatio->at(i);
		bG_superCluster_e2x5MaxRatio[i] = bG.superCluster_e2x5MaxRatio->at(i);
		bG_superCluster_e2x5TopRatio[i] = bG.superCluster_e2x5TopRatio->at(i);
		bG_superCluster_e2x5RightRatio[i] = bG.superCluster_e2x5RightRatio->at(i);
		bG_superCluster_e2x5BottomRatio[i] = bG.superCluster_e2x5BottomRatio->at(i);
		bG_superCluster_e2x5LeftRatio[i] = bG.superCluster_e2x5LeftRatio->at(i);
		bG_superCluster_swissCross[i] = bG.superCluster_swissCross->at(i);
		bG_superCluster_r9[i] = bG.superCluster_r9->at(i);
		bG_superCluster_sigmaIetaIeta[i] = bG.superCluster_sigmaIetaIeta->at(i);
		bG_superCluster_sigmaIetaIphi[i] = bG.superCluster_sigmaIetaIphi->at(i);
		bG_superCluster_sigmaIphiIphi[i] = bG.superCluster_sigmaIphiIphi->at(i);
		bG_superCluster_full5x5_e5x5[i] = bG.superCluster_full5x5_e5x5->at(i);
		bG_superCluster_full5x5_e2x2Ratio[i] = bG.superCluster_full5x5_e2x2Ratio->at(i);
		bG_superCluster_full5x5_e3x3Ratio[i] = bG.superCluster_full5x5_e3x3Ratio->at(i);
		bG_superCluster_full5x5_eMaxRatio[i] = bG.superCluster_full5x5_eMaxRatio->at(i);
		bG_superCluster_full5x5_e2ndRatio[i] = bG.superCluster_full5x5_e2ndRatio->at(i);
		bG_superCluster_full5x5_eTopRatio[i] = bG.superCluster_full5x5_eTopRatio->at(i);
		bG_superCluster_full5x5_eRightRatio[i] = bG.superCluster_full5x5_eRightRatio->at(i);
		bG_superCluster_full5x5_eBottomRatio[i] = bG.superCluster_full5x5_eBottomRatio->at(i);
		bG_superCluster_full5x5_eLeftRatio[i] = bG.superCluster_full5x5_eLeftRatio->at(i);
		bG_superCluster_full5x5_e2x5MaxRatio[i] = bG.superCluster_full5x5_e2x5MaxRatio->at(i);
		bG_superCluster_full5x5_e2x5TopRatio[i] = bG.superCluster_full5x5_e2x5TopRatio->at(i);
		bG_superCluster_full5x5_e2x5RightRatio[i] = bG.superCluster_full5x5_e2x5RightRatio->at(i);
		bG_superCluster_full5x5_e2x5BottomRatio[i] = bG.superCluster_full5x5_e2x5BottomRatio->at(i);
		bG_superCluster_full5x5_e2x5LeftRatio[i] = bG.superCluster_full5x5_e2x5LeftRatio->at(i);
		bG_superCluster_full5x5_swissCross[i] = bG.superCluster_full5x5_swissCross->at(i);
		bG_superCluster_full5x5_r9[i] = bG.superCluster_full5x5_r9->at(i);
		bG_superCluster_full5x5_sigmaIetaIeta[i] = bG.superCluster_full5x5_sigmaIetaIeta->at(i);
		bG_superCluster_full5x5_sigmaIetaIphi[i] = bG.superCluster_full5x5_sigmaIetaIphi->at(i);
		bG_superCluster_full5x5_sigmaIphiIphi[i] = bG.superCluster_full5x5_sigmaIphiIphi->at(i);
...
void genericTreeBranchSelector::setCompiledTreeBranches() 
{
	...
	_compiledTree->Branch("bG_beamspot_x",&	( bG.beamspot_x ));
	_compiledTree->Branch("bG_beamspot_y",&	( bG.beamspot_y ));
	_compiledTree->Branch("bG_beamspot_z",&	( bG.beamspot_z ));
	_compiledTree->Branch("bG_beamspot_x_error",&	( bG.beamspot_x_error ));
	_compiledTree->Branch("bG_beamspot_y_error",&	( bG.beamspot_y_error ));
	_compiledTree->Branch("bG_beamspot_z_error",&	( bG.beamspot_z_error ));
	_compiledTree->Branch("bG_beamspot_covXX",&	( bG.beamspot_covXX ));
	_compiledTree->Branch("bG_beamspot_covXY",&	( bG.beamspot_covXY ));
	_compiledTree->Branch("bG_beamspot_covXZ",&	( bG.beamspot_covXZ ));
	_compiledTree->Branch("bG_beamspot_covYY",&	( bG.beamspot_covYY ));
	_compiledTree->Branch("bG_beamspot_covYZ",&	( bG.beamspot_covYZ ));
	_compiledTree->Branch("bG_beamspot_covZZ",&	( bG.beamspot_covZZ ));
	_compiledTree->Branch("bG_beamspot_dxdz",&	( bG.beamspot_dxdz ));
	_compiledTree->Branch("bG_beamspot_dydz",&	( bG.beamspot_dydz ));
	_compiledTree->Branch("bG_beamspot_sigmaZ",&	( bG.beamspot_sigmaZ ));
	_compiledTree->Branch("bG_beamspot_dxdz_error",&	( bG.beamspot_dxdz_error ));
	_compiledTree->Branch("bG_beamspot_dydz_error",&	( bG.beamspot_dydz_error ));
	_compiledTree->Branch("bG_beamspot_sigmaZError",&	( bG.beamspot_sigmaZError ));
	_compiledTree->Branch("bG_beamspot_beamWidthX",&	( bG.beamspot_beamWidthX ));
	_compiledTree->Branch("bG_beamspot_beamWidthY",&	( bG.beamspot_beamWidthY ));
	_compiledTree->Branch("bG_beamspot_beamWidthX_error",&	( bG.beamspot_beamWidthX_error ));
	_compiledTree->Branch("bG_beamspot_beamWidthY_error",&	( bG.beamspot_beamWidthY_error ));
	...
	_compiledTree->Branch("bG_superCluster_e5x5",	( bG_superCluster_e5x5 ),"bG_superCluster_e5x5[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_e2x2Ratio",	( bG_superCluster_e2x2Ratio ),"bG_superCluster_e2x2Ratio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_e3x3Ratio",	( bG_superCluster_e3x3Ratio ),"bG_superCluster_e3x3Ratio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_eMaxRatio",	( bG_superCluster_eMaxRatio ),"bG_superCluster_eMaxRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_e2ndRatio",	( bG_superCluster_e2ndRatio ),"bG_superCluster_e2ndRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_eTopRatio",	( bG_superCluster_eTopRatio ),"bG_superCluster_eTopRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_eRightRatio",	( bG_superCluster_eRightRatio ),"bG_superCluster_eRightRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_eBottomRatio",	( bG_superCluster_eBottomRatio ),"bG_superCluster_eBottomRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_eLeftRatio",	( bG_superCluster_eLeftRatio ),"bG_superCluster_eLeftRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_e2x5MaxRatio",	( bG_superCluster_e2x5MaxRatio ),"bG_superCluster_e2x5MaxRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_e2x5TopRatio",	( bG_superCluster_e2x5TopRatio ),"bG_superCluster_e2x5TopRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_e2x5RightRatio",	( bG_superCluster_e2x5RightRatio ),"bG_superCluster_e2x5RightRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_e2x5BottomRatio",	( bG_superCluster_e2x5BottomRatio ),"bG_superCluster_e2x5BottomRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_e2x5LeftRatio",	( bG_superCluster_e2x5LeftRatio ),"bG_superCluster_e2x5LeftRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_swissCross",	( bG_superCluster_swissCross ),"bG_superCluster_swissCross[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_r9",	( bG_superCluster_r9 ),"bG_superCluster_r9[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_sigmaIetaIeta",	( bG_superCluster_sigmaIetaIeta ),"bG_superCluster_sigmaIetaIeta[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_sigmaIetaIphi",	( bG_superCluster_sigmaIetaIphi ),"bG_superCluster_sigmaIetaIphi[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_sigmaIphiIphi",	( bG_superCluster_sigmaIphiIphi ),"bG_superCluster_sigmaIphiIphi[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_e5x5",	( bG_superCluster_full5x5_e5x5 ),"bG_superCluster_full5x5_e5x5[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_e2x2Ratio",	( bG_superCluster_full5x5_e2x2Ratio ),"bG_superCluster_full5x5_e2x2Ratio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_e3x3Ratio",	( bG_superCluster_full5x5_e3x3Ratio ),"bG_superCluster_full5x5_e3x3Ratio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_eMaxRatio",	( bG_superCluster_full5x5_eMaxRatio ),"bG_superCluster_full5x5_eMaxRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_e2ndRatio",	( bG_superCluster_full5x5_e2ndRatio ),"bG_superCluster_full5x5_e2ndRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_eTopRatio",	( bG_superCluster_full5x5_eTopRatio ),"bG_superCluster_full5x5_eTopRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_eRightRatio",	( bG_superCluster_full5x5_eRightRatio ),"bG_superCluster_full5x5_eRightRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_eBottomRatio",	( bG_superCluster_full5x5_eBottomRatio ),"bG_superCluster_full5x5_eBottomRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_eLeftRatio",	( bG_superCluster_full5x5_eLeftRatio ),"bG_superCluster_full5x5_eLeftRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_e2x5MaxRatio",	( bG_superCluster_full5x5_e2x5MaxRatio ),"bG_superCluster_full5x5_e2x5MaxRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_e2x5TopRatio",	( bG_superCluster_full5x5_e2x5TopRatio ),"bG_superCluster_full5x5_e2x5TopRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_e2x5RightRatio",	( bG_superCluster_full5x5_e2x5RightRatio ),"bG_superCluster_full5x5_e2x5RightRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_e2x5BottomRatio",	( bG_superCluster_full5x5_e2x5BottomRatio ),"bG_superCluster_full5x5_e2x5BottomRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_e2x5LeftRatio",	( bG_superCluster_full5x5_e2x5LeftRatio ),"bG_superCluster_full5x5_e2x5LeftRatio[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_swissCross",	( bG_superCluster_full5x5_swissCross ),"bG_superCluster_full5x5_swissCross[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_r9",	( bG_superCluster_full5x5_r9 ),"bG_superCluster_full5x5_r9[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_sigmaIetaIeta",	( bG_superCluster_full5x5_sigmaIetaIeta ),"bG_superCluster_full5x5_sigmaIetaIeta[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_sigmaIetaIphi",	( bG_superCluster_full5x5_sigmaIetaIphi ),"bG_superCluster_full5x5_sigmaIetaIphi[bG_nSC]/F");
	_compiledTree->Branch("bG_superCluster_full5x5_sigmaIphiIphi",	( bG_superCluster_full5x5_sigmaIphiIphi ),"bG_superCluster_full5x5_sigmaIphiIphi[bG_nSC]/F");
