#ifndef HLTDoubletDRwithEgammaObject_h
#define HLTDoubletDRwithEgammaObject_h
...
class HLTDoubletDRwithEgammaObject : public HLTFilter {
...
public:
  explicit HLTDoubletDRwithEgammaObject(const edm::ParameterSet&);
  ~HLTDoubletDRwithEgammaObject() override;
...
#endif  //HLTDoubletDRwithEgammaObject_h
