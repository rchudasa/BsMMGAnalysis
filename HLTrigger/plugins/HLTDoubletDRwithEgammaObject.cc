...
#include "HLTDoubletDRwithEgammaObject.h"
...
HLTDoubletDRwithEgammaObject<T1, T2>::HLTDoubletDRwithEgammaObject(const edm::ParameterSet& iConfig)
    : HLTFilter(iConfig),
...
template <>
HLTDoubletDRwithEgammaObject<reco::RecoEcalCandidate, reco::RecoEcalCandidate>::HLTDoubletDRwithEgammaObject(const edm::ParameterSet& iConfig)
    : HLTFilter(iConfig),
      originTag1_(iConfig.template getParameter<std::vector<edm::InputTag>>("originTag1")),
      originTag2_(iConfig.template getParameter<std::vector<edm::InputTag>>("originTag2")),
      inputTag1_(iConfig.template getParameter<edm::InputTag>("inputTag1")),
...
template <>
HLTDoubletDRwithEgammaObject<reco::RecoChargedCandidate, reco::RecoEcalCandidate>::HLTDoubletDRwithEgammaObject(const edm::ParameterSet& iConfig)
    : HLTFilter(iConfig),
      originTag1_(iConfig.template getParameter<std::vector<edm::InputTag>>("originTag1")),
      originTag2_(iConfig.template getParameter<std::vector<edm::InputTag>>("originTag2")),
      inputTag1_(iConfig.template getParameter<edm::InputTag>("inputTag1")),
...
template <>
HLTDoubletDRwithEgammaObject<reco::RecoEcalCandidate, reco::RecoChargedCandidate>::HLTDoubletDRwithEgammaObject(const edm::ParameterSet& iConfig)
    : HLTFilter(iConfig),
      originTag1_(iConfig.template getParameter<std::vector<edm::InputTag>>("originTag1")),
      originTag2_(iConfig.template getParameter<std::vector<edm::InputTag>>("originTag2")),
      inputTag1_(iConfig.template getParameter<edm::InputTag>("inputTag1")),
...
template <>
HLTDoubletDRwithEgammaObject<reco::RecoChargedCandidate, reco::RecoChargedCandidate>::HLTDoubletDRwithEgammaObject(const edm::ParameterSet& iConfig)
    : HLTFilter(iConfig),
      originTag1_(iConfig.template getParameter<std::vector<edm::InputTag>>("originTag1")),
      originTag2_(iConfig.template getParameter<std::vector<edm::InputTag>>("originTag2")),
      inputTag1_(iConfig.template getParameter<edm::InputTag>("inputTag1")),
...
template <>
HLTDoubletDRwithEgammaObject<l1t::TkMuon, l1t::TkMuon>::HLTDoubletDRwithEgammaObject(const edm::ParameterSet& iConfig)
    : HLTFilter(iConfig),
      originTag1_(iConfig.template getParameter<std::vector<edm::InputTag>>("originTag1")),
      originTag2_(iConfig.template getParameter<std::vector<edm::InputTag>>("originTag2")),
      inputTag1_(iConfig.template getParameter<edm::InputTag>("inputTag1")),
...
template <typename T1, typename T2>
HLTDoubletDRwithEgammaObject<T1, T2>::~HLTDoubletDRwithEgammaObject() {}

template <typename T1, typename T2>
void HLTDoubletDRwithEgammaObject<T1, T2>::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.add<int>("MinN", 1);
  descriptions.add(defaultModuleLabel<HLTDoubletDRwithEgammaObject<T1, T2>>(), desc);
}

template <>
void HLTDoubletDRwithEgammaObject<reco::RecoEcalCandidate, reco::RecoEcalCandidate>::fillDescriptions(
  ...
  desc.add<bool>("checkSC", false);
  desc.add<int>("MinN", 1);
  descriptions.add(defaultModuleLabel<HLTDoubletDRwithEgammaObject<reco::RecoEcalCandidate, reco::RecoEcalCandidate>>(), desc);
}

template <>
void HLTDoubletDRwithEgammaObject<reco::RecoChargedCandidate, reco::RecoEcalCandidate>::fillDescriptions(
    edm::ConfigurationDescriptions& descriptions) {
  edm::ParameterSetDescription desc;
  makeHLTFilterDescription(desc);
  std::vector<edm::InputTag> originTag1(1, edm::InputTag("hltOriginal1"));
  ...
  desc.add<bool>("checkSC", false);
  desc.add<int>("MinN", 1);
  descriptions.add(defaultModuleLabel<HLTDoubletDRwithEgammaObject<reco::RecoChargedCandidate, reco::RecoEcalCandidate>>(), desc);
}

template <>
void HLTDoubletDRwithEgammaObject<reco::RecoEcalCandidate, reco::RecoChargedCandidate>::fillDescriptions(
    edm::ConfigurationDescriptions& descriptions) {
  edm::ParameterSetDescription desc;
  makeHLTFilterDescription(desc);
  std::vector<edm::InputTag> originTag1(1, edm::InputTag("hltOriginal1"));
  ...
  desc.add<bool>("checkSC", false);
  desc.add<int>("MinN", 1);
  descriptions.add(defaultModuleLabel<HLTDoubletDRwithEgammaObject<reco::RecoEcalCandidate, reco::RecoChargedCandidate>>(), desc);
}

template <>
void HLTDoubletDRwithEgammaObject<reco::RecoChargedCandidate, reco::RecoChargedCandidate>::fillDescriptions(
    edm::ConfigurationDescriptions& descriptions) {
  edm::ParameterSetDescription desc;
  makeHLTFilterDescription(desc);
  std::vector<edm::InputTag> originTag1(1, edm::InputTag("hltOriginal1"));
  ...
  desc.add<bool>("checkSC", false);
  desc.add<int>("MinN", 1);
  descriptions.add(defaultModuleLabel<HLTDoubletDRwithEgammaObject<reco::RecoChargedCandidate, reco::RecoChargedCandidate>>(), desc);
}

template <typename T1, typename T2>
bool
//HLTDoubletDRwithEgammaObject<T1, T2>::getCollections(edm::Event& iEvent, std::vector<T1Ref>& coll1, std::vector<T2Ref>& coll2) const {
HLTDoubletDRwithEgammaObject<T1, T2>::getCollections(edm::Event& iEvent,
...
template <typename T1, typename T2>
bool HLTDoubletDRwithEgammaObject<T1, T2>::computeDZ(edm::Event& iEvent, T1Ref& r1, T2Ref& r2) const {
...
template <>
bool HLTDoubletDRwithEgammaObject<reco::RecoEcalCandidate, reco::RecoChargedCandidate>::computeDZ(edm::Event& iEvent,
                                                                                  T1Ref& r1,
                                                                                  T2Ref& r2) const {
  ...
  if (!electronHandle_.isValid())
    edm::LogError("HLTDoubletDRwithEgammaObject") << "HLTDoubletDRwithEgammaObject: Electron Handle not valid.";
...
template <>
bool HLTDoubletDRwithEgammaObject<reco::RecoChargedCandidate, reco::RecoEcalCandidate>::computeDZ(edm::Event& iEvent,
                                                                                  T1Ref& r1,
                                                                                  T2Ref& r2) const {
  //edm::Handle<reco::ElectronCollection> electronHandle_;
  //iEvent.getByToken(electronToken_, electronHandle_);
...
template <>
bool HLTDoubletDRwithEgammaObject<reco::RecoEcalCandidate, reco::RecoEcalCandidate>::computeDZ(edm::Event& iEvent,
                                                                               T1Ref& r1,
                                                                               T2Ref& r2) const {
  edm::Handle<reco::ElectronCollection> electronHandle_;
  iEvent.getByToken(electronToken_, electronHandle_);
...
template <>
bool HLTDoubletDRwithEgammaObject<reco::RecoChargedCandidate, reco::RecoChargedCandidate>::computeDZ(edm::Event& iEvent,
                                                                                     T1Ref& r1,
                                                                                     T2Ref& r2) const {
  const reco::RecoChargedCandidate& candidate1(*r1);
  const reco::RecoChargedCandidate& candidate2(*r2);
...
template <>
bool HLTDoubletDRwithEgammaObject<l1t::TkMuon, l1t::TkMuon>::computeDZ(edm::Event& iEvent,
                                                       l1t::TkMuonRef& r1,
...
template <>
bool HLTDoubletDRwithEgammaObject<l1t::HPSPFTau, l1t::HPSPFTau>::computeDZ(edm::Event& iEvent,
                                                           l1t::HPSPFTauRef& r1,
...
template <typename T1, typename T2>
bool HLTDoubletDRwithEgammaObject<T1, T2>::hltFilter(edm::Event& iEvent,
...
template <>
bool HLTDoubletDRwithEgammaObject<l1t::TkMuon, l1t::TkMuon>::hltFilter(edm::Event& iEvent,
                                                       const edm::EventSetup& iSetup,
                                                       trigger::TriggerFilterObjectWithRefs& filterproduct) const {
  // All HLT filters must create and fill an HLT filter object,
  // recording any reconstructed physics objects satisfying (or not)
...
/// They are LeafCandidates instead
template <>
bool HLTDoubletDRwithEgammaObject<l1t::PFTau, l1t::PFTau>::hltFilter(edm::Event& iEvent,
                                                     const edm::EventSetup& iSetup,
                                                     trigger::TriggerFilterObjectWithRefs& filterproduct) const {
  // All HLT filters must create and fill an HLT filter object,
  // recording any reconstructed physics objects satisfying (or not)
...
/// They are LeafCandidates instead
template <>
bool HLTDoubletDRwithEgammaObject<l1t::HPSPFTau, l1t::HPSPFTau>::hltFilter(edm::Event& iEvent,
                                                           const edm::EventSetup& iSetup,
                                                           trigger::TriggerFilterObjectWithRefs& filterproduct) const {
  // All HLT filters must create and fill an HLT filter object,
  // recording any reconstructed physics objects satisfying (or not)
...
typedef HLTDoubletDRwithEgammaObject<reco::RecoChargedCandidate, reco::RecoEcalCandidate> HLT2MuonEgammaDr;

DEFINE_FWK_MODULE(HLT2MuonEgammaDr);
