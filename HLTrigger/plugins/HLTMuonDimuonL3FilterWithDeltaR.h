#ifndef HLTMuonDimuonL3FilterWithDeltaR_h
#define HLTMuonDimuonL3FilterWithDeltaR_h

/** \class HLTMuonDimuonL3FilterWithDeltaR
 *
 *
...
class HLTMuonDimuonL3FilterWithDeltaR : public HLTFilter {
public:
  explicit HLTMuonDimuonL3FilterWithDeltaR(const edm::ParameterSet&);
  ~HLTMuonDimuonL3FilterWithDeltaR() override;
...
private:
  ...
  double min_DeltaRMuMu_;            // minimum deltaR(mu1,mu2) of pair
  double max_DeltaRMuMu_;            // maximum deltaR(mu1,mu2) of pair
